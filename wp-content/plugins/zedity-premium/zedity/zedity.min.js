...
(function($){if(!Zedity)throw new Error(Zedity.t('%s needs %s.','Zedity.Box.Document','Zedity'));if(!Zedity.Box)throw new Error(Zedity.t('%s needs %s.','Zedity.Box.Document','Zedity.Box'));Zedity.Box.Document=function(options){this.type='Document';this._defaults=Zedity.Box.Document._defaults;Zedity.Box.prototype.constructor.call(this,options);this._can.remove('background','rotation','flip','corners');if(this.$this.find('object,iframe').length==0){if(this.$this.find('.zedity-empty').length==0){this.$this.append('<div class="zedity-empty"><p>'+Zedity.t('Click %s to insert a document.','<span class="zedity-button"><span class="zicon zicon-document zicon-size-s"></span></span>')+'</p></div>')}}else if(this.$this.find('.zedity-boxoverlay').length==0){this.$this.append('<div class="zedity-boxoverlay"/>')}};Zedity.Box.Document.prototype=Object.create(Zedity.Box.prototype);Zedity.Box.Document.prototype.constructor=Zedity.Box.Document;$.extend(Zedity.Box.Document.prototype,{createPropBar:function(options){Zedity.Box.prototype.createPropBar.call(this);this.editor.menu.add({tabs:{editbox:{groups:{documentbox:{title:Zedity.t('Document'),order:-1000,class:'zedity-group-box',features:{insert:{type:'button',icon:'document',label:Zedity.t('Insert'),title:Zedity.t('Insert document'),onclick:function(e,ed){var box=ed.boxes.selected();if(!box)return;box.insert()}},read:{type:'toggle',order:0,state:[{label:Zedity.t('Read'),icon:'view',title:Zedity.t('Read document')},{label:Zedity.t('Close'),icon:'view',title:Zedity.t('Close document')}],onclick:function(e,ed,before){var box=ed.boxes.selected();if(!box)return false;switch(before){case 0:box.start();break;case 1:box.stop();break}},enable:function(ed,box){return box&&box.$this.find('object,iframe').length>0},refresh:function(ed,box){if(!box)return;this.$button.trigger('toggle',box.$this.hasClass('zedity-playing')?1:0)}}},show:function(ed,box){return box&&box.type=='Document'}}}}}},'documentbox');return this},_sizeLimits:function(){var sl=Zedity.Box.prototype._sizeLimits.call(this);var service=this.getService();if(!service)return sl;return{minWidth:service.sizeLimits.minWidth||sl.minWidth,maxWidth:service.sizeLimits.maxWidth||sl.maxWidth,minHeight:service.sizeLimits.minHeight||sl.minHeight,maxHeight:service.sizeLimits.maxHeight||sl.maxHeight}},_save:function(callback){Zedity.Box.prototype._save.call(this);this.$this.find('.zedity-boxoverlay').remove();if(typeof(callback)=='function')callback.call(this);return this},content:function(content){if(content!=null){if(typeof content=='string'||content instanceof String){content=$.trim(content);var embed=Zedity.core.embed.parse(content,'document');if(!embed.code){if(/^https?:\/\/./.test(content)&&Zedity.core.embed.getServices('document').indexOf('google_viewer')>-1){return Zedity.core._call(this,'content','https://docs.google.com/viewer?url='+encodeURIComponent(content))}else{this.editor._error({message:Zedity.t('Please provide a valid link/embed code for any of the supported document embed services or a direct link to a document.')});return Zedity.Box.prototype.content.call(this)}}content=(embed.iframe||embed.flash)+'<div class="zedity-boxoverlay"/>';this.$this.attr('data-service',embed.service)}else{this.editor._error({message:Zedity.t('Could not interpret the content as document.')});return Zedity.Box.prototype.content.call(this)}}content=Zedity.Box.prototype.content.call(this,content);var $o=$('<div/>').html(content).find('object,iframe');content=$o.attr('src')||$o.attr('data')||'';if(content.indexOf('//docs.google.com/viewer?url=')>-1){content=decodeURIComponent(/docs.google.com\/viewer\?url=(.*?)(?:&|$)/.exec(content)[1])}this._resize();this.editor.boxes.refreshSelected();return content},select:function(){if(this.$this.hasClass('zedity-editing')||this.$this.hasClass('zedity-playing'))return this;Zedity.Box.prototype.select.call(this);return this},rotation:function(setting){if(setting!=null){this.editor._error({message:Zedity.t('%s can\'t be rotated.','Document box')})}return 0},background:function(setting){if(setting!=null){this.editor._error({message:Zedity.t('%s doesn\'t support background property.','Document box')})}return{type:'solid',alpha:1,colors:['transparent']}},corners:function(setting){if(setting!=null){this.editor._error({message:Zedity.t('%s doesn\'t support rounded corners.','Document box')})}return{'border-top-left-radius':0,'border-top-right-radius':0,'border-bottom-left-radius':0,'border-bottom-right-radius':0}},flip:function(setting){if(setting!=null){this.editor._error({message:Zedity.t('%s doesn\'t support flipping.','Document box')})}return'none'},start:function(){Zedity.Box.prototype.start.call(this);var $obj=this.$this.find('object,iframe');if($obj.lenght==0)return this;if(this.$this.data('ui-draggable'))this.$this.draggable('option','disabled',true);if(this.$this.data('ui-resizable'))this.$this.resizable('option','disabled',true);this.$this.removeClass('ui-state-disabled');this.$this.addClass('zedity-playing').find('.zedity-boxoverlay').hide();return this},stop:function(){Zedity.Box.prototype.stop.call(this);var $obj=this.$this.find('object,iframe');if($obj.lenght==0)return this;if(this.$this.data('ui-draggable'))this.$this.draggable('option','disabled',false);if(this.$this.data('ui-resizable'))this.$this.resizable('option','disabled',false);this.$this.removeClass('zedity-playing').find('.zedity-boxoverlay').show();return this},insert:function(){Zedity.Box.prototype.insert.call(this);$('.zedity-dialog-document').data('box',this).dialog('open');return this},getService:function(){var service=this.$this.attr('data-service')||this.$this.find('object,iframe').attr('data-service');return Zedity.core.embed.services[service]},duplicate:function(){var newbox=Zedity.Box.prototype.duplicate.call(this);var $obj=newbox.$this.find('object,iframe');var service=newbox.getService();if(service){$obj.attr('id',Zedity.core.genId(service.service))}return newbox},init:function(){Zedity.Box.prototype.init.call(this);if($('.zedity-dialog-document').length==0){var $dialog=$('<div class="zedity-dialog-document">'+'<div class="tabs">'+'<ul>'+'<li><a href="#tab-document-embed">'+Zedity.t('Embed')+'</a></li>'+'</ul>'+'<div id="tab-document-embed">'+Zedity.t('Insert document embed code or url:')+'<br/>'+'<textarea id="zedity-txtDocumentEmbed" rows="4"></textarea>'+'<p>'+Zedity.t('Supported services:')+'<br/><span id="zedity-lblDocumentServices"></span></p>'+'<p>'+Zedity.t('Supported documents:')+'<br/>'+Zedity.t('PDF documents, Microsoft Office documents, Apple Pages, Adobe Photoshop and Illustrator, and more.')+'</p>'+'</div>'+'</div>'+'</div>');$dialog.find('.tabs').tabs({activate:function(event,ui){$(this).find('.ui-tabs-panel:visible').find('input[type=text],textare,select').filter(':visible').filter(':first').focus()}});this.editor.$container.append($dialog);$dialog.dialog({title:Zedity.t('Insert document'),dialogClass:'zedity-dialog',autoOpen:false,modal:true,resizable:false,position:{my:'center',at:'center',of:window.top},open:function(){var $this=$(this);var box=$this.data('box');var disabled=[];var services=Zedity.core.embed.getServices('document',true);$('#zedity-lblDocumentServices').html(services.join(', '));$this.find('input[type=text],textarea').val('');$this.find('.tabs').tabs('option',{active:0,disabled:disabled});$('#zedity-txtDocumentEmbed').val(box.content()).focus()},close:function(){$(this).data('box',null)},buttons:[{text:Zedity.t('OK'),class:'zedity-button-ok',click:function(){var box=$(this).data('box');$(this).dialog('close');if(box){var content=$('#zedity-txtDocumentEmbed').val();box.content(content)}}},{text:Zedity.t('Cancel'),class:'zedity-button-cancel',click:function(){$(this).dialog('close')}}]})}return this}});Zedity.Box.Document.type='Document';Zedity.Box.Document.sizeLimits={minWidth:200,minHeight:200,maxWidth:null,maxHeight:null};Zedity.Box.Document._defaults={width:200,height:200};Zedity.Box.register({type:Zedity.Box.Document.type,section:'media-embed',order:200});Zedity.core.embed.add('slideshare',{url:'http://www.slideshare.net/',type:'document',regex:[new RegExp('slideshare\\.net/.*?/.*?'),new RegExp('slideshare\\.net/slideshow/embed_code/(.*?)(\\?|/|&|"|\'|$)')],parser:function(code,embed){if(!code[1]){try{var data=$.ajax({type:'GET',url:'//www.slideshare.net/api/oembed/2?format=json&url='+embed,dataType:'json',async:false});data=JSON.parse(data.responseText);code=this.regex[0].exec(data.html)}catch(e){code=undefined}if(!code)return{}}return{code:code[1],iframe:'//www.slideshare.net/slideshow/embed_code/'+code[1]+'?rel=0'}},sizeLimits:{minWidth:200,minHeight:200}});Zedity.core.embed.add('scribd',{url:'http://www.scribd.com/',type:'document',regex:[new RegExp('scribd\\.com/(?:doc|embeds)/(.*?)(\\?|/|&|"|\'|$)')],parser:function(code){return{code:code[1],iframe:'//www.scribd.com/embeds/'+code[1]+'/content?start_page=1&amp;view_mode=scroll&amp;show_recommendations=false'}},sizeLimits:{minWidth:360,minHeight:320}});Zedity.core.embed.add('google_drive',{url:'https://drive.google.com/',type:'document',regex:[new RegExp('drive\\.google\\.com/file/d/(.*?)(&|/|$)'),new RegExp('docs\\.google\\.com/spreadsheet/ccc\\?key=(.*?)(&|/|$)'),new RegExp('docs\\.google\\.com/(?:presentation|document|drawings)/d/(.*?)(&|/|$)')],parser:function(code){return{code:code[1],iframe:'//drive.google.com/file/d/'+code[1]+'/preview'}},sizeLimits:{minWidth:200,minHeight:200}});Zedity.core.embed.add('google_viewer',{url:'https://docs.google.com/viewer',type:'document',regex:[new RegExp('docs\\.google\\.com/(?:viewer|gview)\\?.*?url=(.*?)(&|$)')],parser:function(code){return{code:code[1],iframe:'//docs.google.com/viewer?url='+code[1]+'&amp;embedded=true'}},sizeLimits:{minWidth:200,minHeight:200}})})(jQuery);
(function($){if(!Zedity)throw new Error(Zedity.t('%s needs %s.','Zedity.Box.Draw','Zedity'));if(!Zedity.Box)throw new Error(Zedity.t('%s needs %s.','Zedity.Box.Draw','Zedity.Box'));Zedity.Box.Draw=function(options){this.type='Draw';this._defaults=Zedity.Box.Draw._defaults;Zedity.Box.prototype.constructor.call(this,options);if(this.$this.find('svg').length==0){this.$this.append('<svg xmlns="'+Zedity.core.svg.NS+'" class="zedity-content" style="width:100%;height:100%;overflow:hidden"/>');if(this.$this.find('.zedity-empty').length==0){this.$this.append('<div class="zedity-empty"><p>'+Zedity.t('Click %s to draw.','<span class="zedity-button"><span class="zicon zicon-draw zicon-size-s"></span></span>')+'</p></div>')}}this._data.svgUndo=[this.$this.find('svg').html()]};Zedity.Box.Draw.prototype=Object.create(Zedity.Box.prototype);Zedity.Box.Draw.prototype.constructor=Zedity.Box.Draw;$.extend(Zedity.Box.Draw.prototype,{createPropBar:function(options){Zedity.Box.prototype.createPropBar.call(this);this.editor.menu.add({tabs:{editbox:{groups:{drawbox:{title:Zedity.t('Draw'),order:-1000,class:'zedity-group-box',features:{insert:{type:'button',icon:'draw',label:Zedity.t('Draw'),title:Zedity.t('Draw'),onclick:function(e,ed){var box=ed.boxes.selected();if(!box)return;box.insert()}}},show:function(ed,box){return box&&box.type=='Draw'}}}},drawbox:{icon:'draw',title:Zedity.t('Draw'),order:2000,groups:{edit:{title:Zedity.t('Editing'),order:0,class:'zedity-group-box',features:{done:{type:'button',icon:'ok',order:0,label:Zedity.t('Done'),title:Zedity.t('Done editing'),onclick:function(e,ed){var box=ed.boxes.selected();if(!box)return;box.stop()}},sep:{type:'separator',order:10},undo:{type:'button',icon:'undo',size:'xs',order:20,label:Zedity.t('Undo'),title:Zedity.t('Undo modifications'),onclick:function(e,ed){Zedity.core.svg.undo()}},redo:{type:'button',icon:'redo',size:'xs',order:30,label:Zedity.t('Redo'),title:Zedity.t('Redo modifications'),onclick:function(e,ed){Zedity.core.svg.redo()}},clear:{type:'button',icon:'delete',order:40,label:Zedity.t('Clear all'),title:Zedity.t('Clear all'),onclick:function(e,ed){Zedity.core.svg.$el.html('');Zedity.core.svg.saveUndo()}}}},style:{title:Zedity.t('Style'),order:50,features:{color:{type:'extpanel',label:Zedity.t('Color'),icon:'empty zicon-colorpicker',title:Zedity.t('Select stroke color'),class:'zedity-svgstroke-colorpicker-button',order:0,build:function($panel,ed){this.$button.find('.zicon').width(30);$panel.append('<div class="zedity-svgstroke-colorpicker"/>');var $cp=$panel.find('.zedity-svgstroke-colorpicker');$cp.colorPicker({colors:['#ffffff','#f2f2f2','#d8d8d8','#bdbdbd','#a4a4a4','#6e6e6e','#424242','#2e2e2e','#000000','#fbefef','#f8e0e0','#f5a9a9','#f78181','#fe2e2e','#df0101','#b40404','#8a0808','#3b0b0b','#fbf5ef','#f8ece0','#f5d0a9','#faac58','#ff8000','#df7401','#b45f04','#8a4b08','#3b240b','#fbfbef','#f5f6ce','#f2f5a9','#f4fa58','#ffff00','#d7df01','#aeb404','#868a08','#393b0b','#f5fbef','#e3f6ce','#d0f5a9','#acfa58','#80ff00','#74df00','#5fb404','#4b8a08','#38610b','#effbef','#cef6ce','#a9f5a9','#58fa58','#00ff00','#01df01','#04b404','#088a08','#0b3b0b','#effbfb','#cef6f5','#a9f5f2','#58faf4','#00ffff','#01dfd7','#04b4ae','#088a85','#0b3b39','#eff5fb','#cee3f6','#81bef7','#2e9afe','#0080ff','#045fb4','#084b8a','#08388a','#0b243b','#efeffb','#cecef6','#5858fa','#2e2efe','#0000ff','#0404b4','#08088a','#0b0b61','#0b0b3b','#f5effb','#e3cef6','#be81f7','#ac58fa','#9a2efe','#5f04b4','#4b088a','#380b61','#240b3b','#fbeffb','#f6cef5','#f781f3','#fe2ef7','#ff00ff','#df01d7','#b404ae','#610b5e','#3b0b39','#fbeff5','#f6cee3','#f5a9d0','#fa58ac','#ff0080','#df0174','#b4045f','#610b38','#3b0b24'],defaultcolor:'#000000',fills:false,alpha:false,buttons:true,maxcols:9,onchange:function(e,color){var box=ed.boxes.selected();if(!box)return false;Zedity.core.svg._curColor=color;box.editor.menu.$this.find('.zedity-svgstroke-colorpicker-button .zicon').css('background',color)}})},refresh:function(ed,box){var $cp=this.$button.extpanel('instance').panel.find('.zedity-svgstroke-colorpicker');$cp.colorPicker('selectcolor',Zedity.core.svg._curColor);this.$button.find('.zicon').css('background',Zedity.core.svg._curColor)}},width:{type:'smallpanel',size:'xs,',order:10,build:function($panel,ed){$panel.append('<table>'+'<tr><td>'+Zedity.t('Width')+':</td>'+'<td><input class="zedity-txtSvgStrokeWidth" type="number" maxlength="4" min="1" max="20"></tr>'+'</table>');var $sw=$panel.find('.zedity-txtSvgStrokeWidth').css('width',50);$sw.attr('title',Zedity.t('Set stroke width'));$sw.on('change',function(){Zedity.core.svg._curWidth=$sw.val()})},refresh:function(ed){this.$panel.find('.zedity-txtSvgStrokeWidth').val(Zedity.core.svg._curWidth)}},fill:{type:'extpanel',size:'xs',label:Zedity.t('Fill'),icon:'empty zicon-colorpicker',title:Zedity.t('Select fill color'),class:'zedity-svgfill-colorpicker-button',order:20,build:function($panel,ed){this.$button.find('.zicon').width(30);$panel.append('<div class="zedity-svgfill-colorpicker"/>');var $cp=$panel.find('.zedity-svgfill-colorpicker');$cp.colorPicker({colors:['transparent','#ffffff','#f2f2f2','#d8d8d8','#bdbdbd','#a4a4a4','#6e6e6e','#424242','#000000','#fbefef','#f8e0e0','#f5a9a9','#f78181','#fe2e2e','#df0101','#b40404','#8a0808','#3b0b0b','#fbf5ef','#f8ece0','#f5d0a9','#faac58','#ff8000','#df7401','#b45f04','#8a4b08','#3b240b','#fbfbef','#f5f6ce','#f2f5a9','#f4fa58','#ffff00','#d7df01','#aeb404','#868a08','#393b0b','#f5fbef','#e3f6ce','#d0f5a9','#acfa58','#80ff00','#74df00','#5fb404','#4b8a08','#38610b','#effbef','#cef6ce','#a9f5a9','#58fa58','#00ff00','#01df01','#04b404','#088a08','#0b3b0b','#effbfb','#cef6f5','#a9f5f2','#58faf4','#00ffff','#01dfd7','#04b4ae','#088a85','#0b3b39','#eff5fb','#cee3f6','#81bef7','#2e9afe','#0080ff','#045fb4','#084b8a','#08388a','#0b243b','#efeffb','#cecef6','#5858fa','#2e2efe','#0000ff','#0404b4','#08088a','#0b0b61','#0b0b3b','#f5effb','#e3cef6','#be81f7','#ac58fa','#9a2efe','#5f04b4','#4b088a','#380b61','#240b3b','#fbeffb','#f6cef5','#f781f3','#fe2ef7','#ff00ff','#df01d7','#b404ae','#610b5e','#3b0b39','#fbeff5','#f6cee3','#f5a9d0','#fa58ac','#ff0080','#df0174','#b4045f','#610b38','#3b0b24'],defaultcolor:'transparent',fills:false,alpha:false,buttons:true,maxcols:9,onchange:function(e,color){var box=ed.boxes.selected();if(!box)return false;Zedity.core.svg._curFill=color;box.editor.menu.$this.find('.zedity-svgfill-colorpicker-button .zicon').css('background',color)}})},enable:function(){return Zedity.core.svg.TOOLS_SUPPORT_FILL.indexOf(Zedity.core.svg._tool)>-1},refresh:function(ed,box){var $cp=this.$button.extpanel('instance').panel.find('.zedity-svgfill-colorpicker');$cp.colorPicker('selectcolor',Zedity.core.svg._curFill);this.$button.find('.zicon').css('background',Zedity.core.svg._curFill)}}},enable:function(){return Zedity.core.svg._tool!==Zedity.core.svg.TOOL_ERASER}},tools:{title:Zedity.t('Tools'),order:100,features:{draw:{type:'button',icon:'freehand',order:0,label:Zedity.t('Draw'),title:Zedity.t('Freehand drawing'),onclick:function(e,ed){Zedity.core.svg.tool(Zedity.core.svg.TOOL_DRAW);ed.menu.refresh('drawbox')},refresh:function(feat){this.$button.toggleClass('zedity-pressed',Zedity.core.svg._tool==Zedity.core.svg.TOOL_DRAW)}},shapes:{type:'menu',icon:'shapes',size:'n',order:5,label:Zedity.t('Shapes'),title:Zedity.t('Draw shapes'),items:[{icon:'line',label:Zedity.t('Line'),value:Zedity.core.svg.TOOL_LINE},{icon:'rectangle',label:Zedity.t('Rectangle'),value:Zedity.core.svg.TOOL_RECTANGLE},{icon:'circle',label:Zedity.t('Circle'),value:Zedity.core.svg.TOOL_CIRCLE},{label:'--'},{icon:'arrow',label:Zedity.t('Arrow'),value:Zedity.core.svg.TOOL_ARROW},{icon:'polygon',label:Zedity.t('Polygon'),value:Zedity.core.svg.TOOL_POLYGON},{icon:'star',label:Zedity.t('Star'),value:Zedity.core.svg.TOOL_STAR}],onclick:function(val,e,ed){Zedity.core.svg.tool(parseInt(val,10));switch(Zedity.core.svg._tool){case Zedity.core.svg.TOOL_POLYGON:Zedity.core.dialog({title:Zedity.t('Draw polygon'),question:Zedity.t('Number of faces')+' '+Zedity.t('(min: %s, max: %s)',3,20),default:Zedity.core.svg._data.faces,acceptedChars:'1234567890',ok:function(answer){Zedity.core.svg._data.faces=Math.max(Math.min(answer,20),3)}});break;case Zedity.core.svg.TOOL_STAR:Zedity.core.dialog({title:Zedity.t('Draw star'),question:Zedity.t('Number of star spikes')+' '+Zedity.t('(min: %s, max: %s)',4,20),default:Zedity.core.svg._data.spikes,acceptedChars:'1234567890',ok:function(answer){Zedity.core.svg._data.spikes=Math.max(Math.min(answer,20),4)}});break}ed.menu.refresh('drawbox')},refresh:function(){var $icon=this.$button.find('.zicon');if(Zedity.core.svg.TOOLS_SHAPES.indexOf(Zedity.core.svg._tool)>-1){this.$button.addClass('zedity-pressed');var $o=this.$menu.find('[value='+Zedity.core.svg._tool+']');$icon.attr('class','zicon zicon-size-n zicon-'+$o.attr('data-icon'));Zedity.core._later(this,function(){this.$button.find('.ui-selectmenu-text').html($o.html())},10)}else{this.$button.removeClass('zedity-pressed');$icon.attr('class','zicon zicon-size-n zicon-shapes');this.$button.find('.ui-selectmenu-text').text(Zedity.t('Shapes'))}}},sep:{type:'separator',order:10},eraser:{type:'button',icon:'eraser',order:20,label:Zedity.t('Eraser'),title:Zedity.t('Erase objects'),onclick:function(e,ed){Zedity.core.svg.tool(Zedity.core.svg.TOOL_ERASER);ed.menu.refresh('drawbox')},enable:function(){return Zedity.core.svg.$el&&'getIntersectionList'in Zedity.core.svg.$el[0]},refresh:function(feat){this.$button.toggleClass('zedity-pressed',Zedity.core.svg._tool==Zedity.core.svg.TOOL_ERASER)}}}}},show:function(ed,box){return box&&box.type=='Draw'&&box.$this.hasClass('zedity-editing')}}}},'drawbox');return this},_save:function(callback){Zedity.Box.prototype._save.call(this);this.$this.find('.zedity-boxoverlay').remove();if(typeof(callback)=='function')callback.call(this);return this},select:function(){if(this.$this.hasClass('zedity-editing')||this.$this.hasClass('zedity-playing'))return this;Zedity.Box.prototype.select.call(this);return this},start:function(){var err='';if(this.rotation()!=0)err=Zedity.t('rotated');if(this.flip()!='none')err=Zedity.t('flipped');if(err){Zedity.core.dialog({title:Zedity.t('Draw'),message:Zedity.t('It is not possible to draw on a %s box.',err)});return this}Zedity.Box.prototype.start.call(this);var $obj=this.$this.find('svg');if($obj.lenght==0)return this;Zedity.core.svg.attach($obj,this);if(this.$this.data('ui-draggable'))this.$this.draggable('option','disabled',true);if(this.$this.data('ui-resizable'))this.$this.resizable('option','disabled',true);if(this.$this.data('ui-rotatable'))this.$this.rotatable('option','disabled',true);this.$this.removeClass('ui-state-disabled');this.$this.find('.zedity-empty').remove();this.$this.addClass('zedity-editing').find('.zedity-boxoverlay').hide();var tabs=[];for(var i=this.editor.menu._tabs.length-1;i>=0;--i){if(this.editor.menu._tabs[i].name!='drawbox'){tabs.push(this.editor.menu._tabIdx(this.editor.menu._tabs[i].name))}}this.editor.menu.$this.tabs('option','disabled',tabs);this.editor.menu.openTab('drawbox',true);return this},stop:function(){Zedity.Box.prototype.stop.call(this);this._data.stopping=true;var $obj=this.$this.find('svg');if($obj.lenght==0)return this;Zedity.core.svg.detach();if(this.$this.data('ui-draggable'))this.$this.draggable('option','disabled',false);if(this.$this.data('ui-resizable'))this.$this.resizable('option','disabled',false);if(this.$this.data('ui-rotatable'))this.$this.rotatable('option','disabled',false);if(this.$this.hasClass('zedity-editing')){this.$this.removeClass('zedity-editing');this.editor.menu.$this.tabs('option','disabled',[]);this.editor.menu.openTab('editbox');this.editor._changed()}this._data.stopping=false;return this},insert:function(){Zedity.Box.prototype.insert.call(this);this.start();return this},init:function(){Zedity.Box.prototype.init.call(this)}});Zedity.Box.Draw.type='Draw';Zedity.Box.Draw.sizeLimits={minWidth:100,minHeight:50,maxWidth:null,maxHeight:null};Zedity.Box.Draw._defaults={width:300,height:200,maxUndo:10};Zedity.Box.register({type:Zedity.Box.Draw.type,section:'advanced',order:50})})(jQuery);(function($){Zedity.core.svg={NS:'http://www.w3.org/2000/svg',$el:null,$wrapper:null,box:null,_selected:null,_tool:1,_data:{faces:4,spikes:5},_draw:false,_curColor:'#000000',_curWidth:3,_curFill:'transparent',TOOL_ERASER:-1,TOOL_DRAW:1,TOOL_LINE:2,TOOL_RECTANGLE:3,TOOL_CIRCLE:4,TOOL_ARROW:5,TOOL_POLYGON:6,TOOL_STAR:7,get TOOLS_SUPPORT_FILL(){return[this.TOOL_RECTANGLE,this.TOOL_CIRCLE,this.TOOL_POLYGON,this.TOOL_STAR]},get TOOLS_SHAPES(){return[this.TOOL_LINE,this.TOOL_RECTANGLE,this.TOOL_CIRCLE,this.TOOL_ARROW,this.TOOL_POLYGON,this.TOOL_STAR]},S_START:1,S_DRAW:2,S_END:3,attach:function(el,box){var self=this;function getNormalizedCoords(e){var o=Zedity.core.supports.touch()&&/chrome/i.test(navigator.userAgent)?self.$el[0].getBoundingClientRect():self.$el.offset();if(e.originalEvent.touches&&e.originalEvent.touches[0]){var x=Math.round(e.originalEvent.touches[0].pageX-o.left);var y=Math.round(e.originalEvent.touches[0].pageY-o.top)}else{x=Math.round(e.pageX-o.left);y=Math.round(e.pageY-o.top)}return{x:x,y:y}};this.$el=$(el);this.$wrapper=this.$el.parent();this.box=box;this._draw=false;if(!Zedity.core.supports.touch()){this.box.editor.$this.on('mousedown.zeditysvg dragstart.zeditysvg',function(e){self._draw=true});$(document).on('mouseup.zeditysvg dragend.zeditysvg',function(e){self._draw=false})}this.box.editor.$this.on('mousemove.zeditysvg mouseup.zeditysvg touchmove.zeditysvg touchend.zeditysvg',function(e){var c=getNormalizedCoords(e);if(e.type=='mouseup'||e.type=='touchend'){self._draw=false;e.which=0}else if(e.type=='touchmove'){self._draw=true;e.which=1}switch(parseInt(self._tool,10)){case self.TOOL_DRAW:self.toolDraw(c.x,c.y,e.which);break;case self.TOOL_ERASER:self.toolEraser(c.x,c.y,e.which);break;case self.TOOL_LINE:self.toolLine(c.x,c.y,e.which);break;case self.TOOL_RECTANGLE:self.toolRectangle(c.x,c.y,e.which);break;case self.TOOL_CIRCLE:self.toolCircle(c.x,c.y,e.which);break;case self.TOOL_ARROW:self.toolArrow(c.x,c.y,e.which);break;case self.TOOL_POLYGON:self.toolPolygon(c.x,c.y,e.which);break;case self.TOOL_STAR:self.toolStar(c.x,c.y,e.which);break}});this.$el.on('mousemove.zeditysvg touchmove.zeditysvg',function(e){if(self._tool==self.TOOL_ERASER){if(self._draw){var c=getNormalizedCoords(e);var rpos=self.$el[0].createSVGRect();rpos.x=c.x;rpos.y=c.y;rpos.width=rpos.height=5;var list=self.$el[0].getIntersectionList(rpos,null);if(list.length>0){$(list).remove();self.saveUndo()}}}})},detach:function(){if(!this.$el)return;this.box.editor.$this.off('mousemove.zeditysvg mouseup.zeditysvg touchmove.zeditysvg touchend.zeditysvg');if(!Zedity.core.supports.touch()){$(document).off('mouseup.zeditysvg');this.box.editor.$this.off('mousedown.zeditysvg')}this.$el.off('mousemove.zeditysvg touchmove.zeditysvg');this.$el=null},saveUndo:function(){this.box._data.svgUndoIdx=(this.box._data.svgUndoIdx||0);this.box._data.svgUndo=this.box._data.svgUndo.slice(0,this.box._data.svgUndoIdx+1);this.box._data.svgUndo.push((new XMLSerializer()).serializeToString(this.$el[0]));this.box._data.svgUndo=this.box._data.svgUndo.slice(-this.box._options.maxUndo);this.box._data.svgUndoIdx=this.box._data.svgUndo.length-1},undo:function(){this.box._data.svgUndoIdx=Math.max(--this.box._data.svgUndoIdx,0);this.$wrapper.html(this.box._data.svgUndo[this.box._data.svgUndoIdx]);this.attach(this.$wrapper.find('svg'),this.box)},redo:function(){this.box._data.svgUndoIdx=Math.min(++this.box._data.svgUndoIdx,this.box._data.svgUndo.length-1,this.box._options.maxUndo-1);this.$wrapper.html(this.box._data.svgUndo[this.box._data.svgUndoIdx]);this.attach(this.$wrapper.find('svg'),this.box)},createElement:function(name,append){var el=document.createElementNS(this.NS,name);if(append)this.$el.append(el);return el},state:function(b){if(!Zedity.core.supports.touch()){b=this._draw?1:0}if(!this._selected&&b==1){return this.S_START}else if(this._selected&&b==1){return this.S_DRAW}else if(this._selected&&b==0){return this.S_END}},tool:function(tool){this._tool=tool;this.$el.parent().toggleClass('eraser',this._tool==this.TOOL_ERASER);return this._tool},toolDraw:function(x,y,b){switch(this.state(b)){case this.S_START:this._selected=this.createElement('path',true);this._selected.setAttributeNS(null,'fill','none');this._selected.setAttributeNS(null,'stroke-linecap','round');this._selected.setAttributeNS(null,'stroke-linejoin','round');this._selected.setAttributeNS(null,'stroke-width',this._curWidth);this._selected.setAttributeNS(null,'stroke',this._curColor);this._data.d='M'+x+','+y;this._selected.setAttributeNS(null,'d',this._data.d);break;case this.S_DRAW:this._data.d+='L'+x+','+y;this._selected.setAttributeNS(null,'d',this._data.d);break;case this.S_END:this._selected=null;this.saveUndo();break}},toolEraser:function(x,y,b){switch(this.state(b)){case this.S_START:this._selected=1;break;case this.S_DRAW:break;case this.S_END:this._selected=null;break}},toolLine:function(x,y,b){switch(this.state(b)){case this.S_START:this._selected=this.createElement('line',true);this._selected.setAttributeNS(null,'stroke-width',this._curWidth);this._selected.setAttributeNS(null,'stroke',this._curColor);this._selected.setAttributeNS(null,'x1',x);this._selected.setAttributeNS(null,'y1',y);this._selected.setAttributeNS(null,'x2',x);this._selected.setAttributeNS(null,'y2',y);break;case this.S_DRAW:this._selected.setAttributeNS(null,'x2',x);this._selected.setAttributeNS(null,'y2',y);break;case this.S_END:this._selected=null;this.saveUndo();break}},toolRectangle:function(x,y,b){switch(this.state(b)){case this.S_START:this._selected=this.createElement('rect',true);this._selected.setAttributeNS(null,'fill',this._curFill);this._selected.setAttributeNS(null,'stroke-width',this._curWidth);this._selected.setAttributeNS(null,'stroke',this._curColor);this._selected.setAttributeNS(null,'x',x);this._selected.setAttributeNS(null,'y',y);this._selected.setAttributeNS(null,'width',0);this._selected.setAttributeNS(null,'height',0);this._data.ox=x;this._data.oy=y;break;case this.S_DRAW:var w=x-this._data.ox,h=y-this._data.oy;this._selected.setAttributeNS(null,'x',this._data.ox+(w>0?0:w));this._selected.setAttributeNS(null,'y',this._data.oy+(h>0?0:h));this._selected.setAttributeNS(null,'width',Math.abs(w));this._selected.setAttributeNS(null,'height',Math.abs(h));break;case this.S_END:this._selected=null;this.saveUndo();break}},toolCircle:function(x,y,b){switch(this.state(b)){case this.S_START:this._selected=this.createElement('circle',true);this._selected.setAttributeNS(null,'fill',this._curFill);this._selected.setAttributeNS(null,'stroke-width',this._curWidth);this._selected.setAttributeNS(null,'stroke',this._curColor);this._selected.setAttributeNS(null,'cx',x);this._selected.setAttributeNS(null,'cy',y);this._selected.setAttributeNS(null,'r',0);this._data.cx=x;this._data.cy=y;break;case this.S_DRAW:this._selected.setAttributeNS(null,'r',Math.round(Math.sqrt(Math.pow(x-this._data.cx,2)+Math.pow(y-this._data.cy,2))));break;case this.S_END:this._selected=null;this.saveUndo();break}},toolArrow:function(x,y,b){switch(this.state(b)){case this.S_START:this._selected=this.createElement('polyline',true);this._selected.setAttributeNS(null,'stroke-width',this._curWidth);this._selected.setAttributeNS(null,'stroke',this._curColor);this._selected.setAttributeNS(null,'stroke-linecap','round');this._selected.setAttributeNS(null,'stroke-linejoin','round');this._selected.setAttributeNS(null,'fill','none');this._selected.setAttributeNS(null,'points',x+','+y);this._data.cx=x;this._data.cy=y;break;case this.S_DRAW:var res='';var slopex=x-this._data.cx,slopey=y-this._data.cy;var r=Math.sqrt(slopex*slopex+slopey*slopey);var sa=this.normAngle(Math.atan2(slopey,slopex)*this._180divPI);var tx=Math.round(Math.min(r/3,25)),ty=0;var a=-this.normAngle(sa-45)*this._PIdiv180;var sin=Math.sin(a),cos=Math.cos(a);res+=Math.round((tx*cos+ty*sin)+this._data.cx)+','+Math.round((ty*cos-tx*sin)+this._data.cy)+' '+this._data.cx+','+this._data.cy+' ';a=-this.normAngle(sa+45)*this._PIdiv180;sin=Math.sin(a),cos=Math.cos(a);res+=Math.round((tx*cos+ty*sin)+this._data.cx)+','+Math.round((ty*cos-tx*sin)+this._data.cy)+' '+this._data.cx+','+this._data.cy+' ';res+=x+','+y;this._selected.setAttributeNS(null,'points',res);break;case this.S_END:this._selected=null;this.saveUndo();break}},toolPolygon:function(x,y,b){switch(this.state(b)){case this.S_START:this._selected=this.createElement('polygon',true);this._selected.setAttributeNS(null,'fill',this._curFill);this._selected.setAttributeNS(null,'stroke-width',this._curWidth);this._selected.setAttributeNS(null,'stroke',this._curColor);this._selected.setAttributeNS(null,'stroke-linecap','round');this._selected.setAttributeNS(null,'stroke-linejoin','round');this._data.cx=x;this._data.cy=y;this._selected.setAttributeNS(null,'points',x+','+y);break;case this.S_DRAW:var slopex=x-this._data.cx,slopey=y-this._data.cy;var r=Math.sqrt(slopex*slopex+slopey*slopey);var res='';var sa=this.normAngle(Math.atan2(slopey,slopex)*this._180divPI);for(var i=0;i<this._data.faces;++i){var tx=r,ty=0;var a=-this.normAngle(sa+(360/this._data.faces*i))*this._PIdiv180;var sin=Math.sin(a),cos=Math.cos(a);res+=Math.round((tx*cos+ty*sin)+this._data.cx)+','+Math.round((ty*cos-tx*sin)+this._data.cy)+' '}this._selected.setAttributeNS(null,'points',res);break;case this.S_END:this._selected=null;this.saveUndo();break}},toolStar:function(x,y,b){switch(this.state(b)){case this.S_START:this._selected=this.createElement('polygon',true);this._selected.setAttributeNS(null,'fill',this._curFill);this._selected.setAttributeNS(null,'stroke-width',this._curWidth);this._selected.setAttributeNS(null,'stroke',this._curColor);this._selected.setAttributeNS(null,'stroke-linecap','round');this._selected.setAttributeNS(null,'stroke-linejoin','round');this._data.cx=x;this._data.cy=y;this._selected.setAttributeNS(null,'points',x+','+y);break;case this.S_DRAW:var slopex=x-this._data.cx,slopey=y-this._data.cy;var r=Math.sqrt(slopex*slopex+slopey*slopey);var res='';var sa=this.normAngle(Math.atan2(slopey,slopex)*this._180divPI);for(var i=0;i<this._data.spikes*2;++i){var tx=(i%2==0?r:r/2),ty=0;var a=-this.normAngle(sa+(360/(this._data.spikes*2)*i))*this._PIdiv180;var sin=Math.sin(a),cos=Math.cos(a);res+=Math.round((tx*cos+ty*sin)+this._data.cx)+','+Math.round((ty*cos-tx*sin)+this._data.cy)+' '}this._selected.setAttributeNS(null,'points',res);break;case this.S_END:this._selected=null;this.saveUndo();break}},_PIdiv180:Math.PI/180,_180divPI:180/Math.PI,normAngle:function(a){a=a%360;if(a<0)a+=360;return a}}})(jQuery);
(function($){if(!Zedity)throw new Error(Zedity.t('%s needs %s.','Zedity.Box.Html','Zedity'));if(!Zedity.Box)throw new Error(Zedity.t('%s needs %s.','Zedity.Box.Html','Zedity.Box'));Zedity.Box.Html=function(options){this.type='Html';this._defaults=Zedity.Box.Html._defaults;Zedity.Box.prototype.constructor.call(this,options);this._can.remove('background','corners','flip');if(this.$this.find('.zedity-content').length==0){this.$this.append('<div class="zedity-content" style="width:100%;height:100%;overflow:auto"></div>');if(this.$this.find('.zedity-empty').length==0){this.$this.append('<div class="zedity-empty"><p>'+Zedity.t('Click %s to insert HTML.','<span class="zedity-button"><span class="zicon zicon-html zicon-size-s"></span></span>')+'</p></div>')}}else if(this.$this.find('.zedity-boxoverlay').length==0&&this.$this.find('.zedity-empty').length==0){this.$this.append('<div class="zedity-boxoverlay"/>')}this._data.content=this.$this.find('.zedity-content').html()};Zedity.Box.Html.prototype=Object.create(Zedity.Box.prototype);Zedity.Box.Html.prototype.constructor=Zedity.Box.Html;$.extend(Zedity.Box.Html.prototype,{createPropBar:function(options){Zedity.Box.prototype.createPropBar.call(this);this.editor.menu.add({tabs:{editbox:{groups:{htmlbox:{title:Zedity.t('Html'),order:-1000,class:'zedity-group-box',features:{insert:{type:'button',icon:'html',label:Zedity.t('Insert'),title:Zedity.t('Insert HTML'),onclick:function(e,ed){var box=ed.boxes.selected();if(!box)return;box.insert()}},view:{type:'toggle',order:0,state:[{label:Zedity.t('View'),icon:'view',title:Zedity.t('View box content')},{label:Zedity.t('Close'),icon:'view',title:Zedity.t('Close')}],onclick:function(e,ed,before){var box=ed.boxes.selected();if(!box)return false;switch(before){case 0:box.start();break;case 1:box.stop();break}},enable:function(ed,box){return box&&box.$this.children('.zedity-content').contents().length>0},refresh:function(ed,box){if(!box)return;this.$button.trigger('toggle',box.$this.hasClass('zedity-playing')?1:0)}}},show:function(ed,box){return box&&box.type=='Html'}}}}}},'htmlbox');if($('.zedity-dialog-html').length==0){var $dialog=$('<div class="zedity-dialog-html">'+Zedity.t('Insert HTML code:')+'<br/>'+'<textarea id="zedity-txtInsertHtml" rows="10" style="height:86%"></textarea>'+'<div style="margin-top:10px"><span>'+Zedity.t('Safe mode:')+' </span>'+'<select id="zedity-ddSSM" style="width:150px">'+'<option value="1" checked="checked">'+Zedity.t('Automatic')+'</option>'+'<option value="2">'+Zedity.t('Enabled')+'</option>'+'<option value="3">'+Zedity.t('Disabled')+'</option>'+'</select>'+'<span class="zedity-tooltip" style="margin-left:15px">?</span>'+'</div>'+'</div>');this.editor.$container.append($dialog);$dialog.dialog({title:Zedity.t('Insert HTML'),dialogClass:'zedity-dialog',autoOpen:false,modal:true,resizable:true,position:{my:'center',at:'center',of:window.top},minWidth:360,minHeight:270,create:function(){$dialog.find('.zedity-tooltip').attr('title',Zedity.t('If you insert Javascript or CSS code and you get unexpected effects (e.g. content overflow, etc.) you need to enable safe mode.')+'<br/>'+Zedity.t('The (default) automatic setting enables safe mode only if Javascript is detected.')+'<br/>'+Zedity.t('Some scripts (for example social network services) need to access the page, so the "Safe mode" must be disabled in these cases.')).tooltip()},open:function(){var box=$dialog.data('box');$('#zedity-txtInsertHtml').val(box.content());$('#zedity-ddSSM').val(box.$this.attr('data-ssm')||1)},close:function(){$(this).data('box',null)},buttons:[{text:Zedity.t('OK'),class:'zedity-button-ok',click:function(){var box=$dialog.data('box');$dialog.dialog('close');if(box){var content=$('#zedity-txtInsertHtml').val();var safemode=$('#zedity-ddSSM').val();var safe=(safemode==1?(content.indexOf('<script')>-1):(safemode==2));box.content(content,safe);box.$this.attr('data-ssm',safemode)}}},{text:Zedity.t('Cancel'),class:'zedity-button-cancel',click:function(){$dialog.dialog('close')}}]})}return this},_save:function(callback){Zedity.Box.prototype._save.call(this);this.$this.find('.zedity-boxoverlay').remove();if(this.$this.find('.zedity-enc-iframe').length==0&&this._data.content){var id='[[['+Zedity.core.genId('zsp_htmlbox')+']]]';Zedity.core.patterns.add(id,this._data.content);this.$this.children('.zedity-content').html(id)}if(typeof(callback)=='function')callback.call(this);return this},_resize:function(){Zedity.Box.prototype._resize.call(this);return this},content:function(content,safemode){if(content!=null){var $temp=$('<div/>').html(content);if($temp.find('.zedity-editor,.zedity-box,.zedity-content').length>0){this.editor._error({message:Zedity.t('Inserting a %s content into an HTML box is not supported at the moment.','Zedity')})}else{this._data.content=content;var $content=this.$this.children('.zedity-content');if(safemode){$content.html('<iframe class="zedity-enc-iframe" src="data:text/html,'+encodeURIComponent(content)+'" style="width:100%;height:100%;border:0"/>');$content.css({display:'',overflow:'',width:'100%',height:'100%'})}else{$content.html(content);if($content.contents().length>0&&/<[^>]+>/.test(content)){setTimeout($.proxy(function(){Zedity.core._call(this,'resizeToContent')},this),2000)}}this.$this.find('.zedity-empty').remove();if(this.$this.find('.zedity-boxoverlay').length==0){this.$this.append('<div class="zedity-boxoverlay"/>')}this._resize().reposition();this.editor.boxes.refreshSelected();this.editor._changed()}}else{content=this._data.content}return content},select:function(){if(this.$this.hasClass('zedity-editing')||this.$this.hasClass('zedity-playing'))return this;Zedity.Box.prototype.select.call(this);return this},flip:function(setting){if(setting!=null){this.editor._error({message:Zedity.t('%s doesn\'t support flipping.','Html box')})}return'none'},start:function(){Zedity.Box.prototype.start.call(this);if(this.$this.children('.zedity-content').contents().lenght==0)return this;if(this.$this.data('ui-draggable'))this.$this.draggable('option','disabled',true);if(this.$this.data('ui-resizable'))this.$this.resizable('option','disabled',true);if(this.$this.data('ui-rotatable'))this.$this.rotatable('option','disabled',true);this.$this.removeClass('ui-state-disabled');this.$this.addClass('zedity-playing').find('.zedity-boxoverlay').hide();return this},stop:function(){Zedity.Box.prototype.stop.call(this);if(this.$this.children('.zedity-content').contents().lenght==0)return this;if(this.$this.data('ui-draggable'))this.$this.draggable('option','disabled',false);if(this.$this.data('ui-resizable'))this.$this.resizable('option','disabled',false);if(this.$this.data('ui-rotatable'))this.$this.rotatable('option','disabled',false);this.$this.removeClass('zedity-playing').find('.zedity-boxoverlay').show();return this},insert:function(){Zedity.Box.prototype.insert.call(this);$('.zedity-dialog-html').data('box',this).dialog('open');return this},init:function(){Zedity.Box.prototype.init.call(this);return this}});Zedity.Box.Html.type='Html';Zedity.Box.Html.sizeLimits={minWidth:16,minHeight:16,maxWidth:null,maxHeight:null};Zedity.Box.Html._defaults={width:150,height:150};Zedity.Box.register({type:Zedity.Box.Html.type,section:'advanced',order:100})})(jQuery);
(function($){Zedity.utils=Zedity.utils||{};Zedity.utils.fileTypes={types:{jpeg:{type:'jpeg',mime:'image/jpeg',extensions:'jpeg jpg jpe',signature:'/9j',canResize:true},png:{type:'png',mime:'image/png',extensions:'png',signature:'iVBORw0KGgo',canResize:true},gif:{type:'gif',mime:'image/gif',extensions:'gif',signature:'R0lG',canResize:false}},_notfound:{type:'',mime:''},parse:function(data,accept){accept=accept||Object.keys(this.types);try{var imgheader=/base64,(.{40})/.exec(data)[1]}catch(e){return this._notfound}for(var i=accept.length-1;i>=0;--i){var filetype=this.types[accept[i]];if(imgheader.substr(0,filetype.signature.length)==filetype.signature){return filetype}}return this._notfound},fromExtension:function(filename,accept){accept=accept||Object.keys(this.types);var ext=filename.split('.').pop();for(var i=accept.length-1;i>=0;--i){if(this.types[accept[i]].extensions.indexOf(ext)>-1){return this.types[accept[i]]}}return this._notfound}}})(jQuery);(function($){if(!Zedity)throw new Error(Zedity.t('%s needs %s.','Zedity.Box.Image','Zedity'));if(!Zedity.Box)throw new Error(Zedity.t('%s needs %s.','Zedity.Box.Image','Zedity.Box'));Zedity.Box.Image=function(options){this.type='Image';this._defaults=Zedity.Box.Image._defaults;Zedity.Box.prototype.constructor.call(this,options);this._can.push('layout');if(!this.$this.find('img').length){this.$this.append($('<div/>',{class:'zedity-content',css:{position:'relative',width:'100%',height:'100%',overflow:'hidden'},html:$('<img/>',{src:this._options.src,css:{position:'absolute',margin:0}})})).append('<div class="zedity-empty"><p>'+Zedity.t('Click %s to insert image.','<span class="zedity-button"><span class="zicon zicon-image zicon-size-s"></span></span>')+'</p></div>');Zedity.core._call(this,'layout',this._options.layout);if(this._options.proportionalResize)this.$this.attr('data-aspectratio',1)}else if(!this.$this.find('div.zedity-content').length){this.$this.find('img').removeClass('zedity-content').wrap($('<div/>',{class:'zedity-content',css:{position:'relative',width:'100%',height:'100%',overflow:'hidden'}}))}this.$this.find('style.imgData').detach().appendTo('head');Zedity.core._call(this,'content',this.content(),null,true)};Zedity.Box.Image.prototype=Object.create(Zedity.Box.prototype);Zedity.Box.Image.prototype.constructor=Zedity.Box.Image;$.extend(Zedity.Box.Image.prototype,{createPropBar:function(options){Zedity.Box.prototype.createPropBar.call(this);this.editor.menu.add({tabs:{editbox:{groups:{imagebox:{title:Zedity.t('Image'),order:-1000,class:'zedity-group-box',features:{insert:{type:'button',icon:'image',label:Zedity.t('Insert'),title:Zedity.t('Insert image'),order:0,onclick:function(e,ed){var box=ed.boxes.selected();if(!box)return;box.insert()}},layout:{type:'menu',icon:'imagelayout',label:Zedity.t('Layout'),title:Zedity.t('Select image layout'),order:100,items:[{label:Zedity.t('Center & fill'),value:'centerfill'},{label:Zedity.t('Fit'),value:'fit'},{label:Zedity.t('Center'),value:'center'},{label:Zedity.t('Stretch'),value:'stretch'}],onclick:function(val,e,ed){var box=ed.boxes.selected();if(!box)return;box.layout(val)},enable:function(ed,box){return(box&&box.$this.children('.zedity-empty').length==0)}},config:{type:'extpanel',icon:'config2',label:Zedity.t('Options'),title:Zedity.t('Image options'),size:'xs',order:200,build:function($panel,ed){$panel.append('<div class="zedity-image-quality-feat" style="border-bottom:1px solid silver;padding-bottom:10px;margin-bottom: 10px">'+'<span>'+Zedity.t('Image quality')+'&nbsp;</span>'+'<select class="zedity-image-quality">'+'<option value="2">'+Zedity.t('Original')+'</option>'+'<option value="0.92">'+Zedity.t('High')+'</option>'+'<option value="0.88">'+Zedity.t('Normal')+'</option>'+'<option value="0.75">'+Zedity.t('Low')+'</option>'+'</select>'+'</div>'+'<span class="zedity-button zedity-imagepropresize">'+'<span class="zicon zicon-size-xs zicon-resize"></span> '+Zedity.t('Proportional resize')+'</span><br/>'+'<span class="zedity-button zedity-imageoriginalsize">'+'<span class="zicon zicon-size-xs zicon-image"></span> '+Zedity.t('Set box to image original size')+'</span>');$panel.find('.zedity-image-quality').selectmenu({width:'auto',appendTo:$panel,change:function(e,ui){var box=ed.boxes.selected();if(!box)return;box._options.quality=parseFloat(ui.item.value)}});$panel.find('.zedity-imagepropresize').on('click.zedity',function(){var box=ed.boxes.selected();if(!box)return;var val=!box.proportionalResize();val=box.proportionalResize(val);$(this).toggleClass('zedity-pressed',val)});$panel.find('.zedity-imageoriginalsize').on('click.zedity',function(){var box=ed.boxes.selected();if(box)box.resizeToContent()})},refresh:function(ed,box){if(!box)return;this.$extpanel.find('.zedity-image-quality').val(box._options.quality).selectmenu('refresh');this.$extpanel.find('.zedity-imagepropresize').toggleClass('zedity-pressed',box.proportionalResize())},enable:function(ed,box){return(box&&box.$this.children('.zedity-empty').length==0)}}},show:function(ed,box){return box&&box.type=='Image'}}}}}},'imagebox');if($('.zedity-dialog-image').length==0){var $dialog=$('<div class="zedity-dialog-image">'+'<div class="tabs">'+'<ul>'+'<li><a href="#tab-image-disk">'+Zedity.t('Disk')+'</a></li>'+'<li><a href="#tab-image-link">'+Zedity.t('Link')+'</a></li>'+'</ul>'+'<div id="tab-image-disk">'+Zedity.t('Supported image file types:')+'<br/><span id="zedity-lblSupportedImages"></span><br/><br/>'+Zedity.t('Select image file from disk (max size %s):','<span id="zedity-lblMaxSize"></span>')+'<br/><br/>'+'<button class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only zedity-fileupload"><span class="ui-button-text">'+Zedity.t('Browse...')+'</span></button>'+'<p id="zedity-lblImageDisk" class="selected-file"></p>'+'<p class="zedity-image-quality">'+Zedity.t('Image quality:')+' '+'<select id="zedity-ddImageQuality" style="width:150px;">'+'<option value="2">'+Zedity.t('Original')+'</option>'+'<option value="0.92">'+Zedity.t('High')+'</option>'+'<option value="0.88" selected="selected">'+Zedity.t('Normal')+'</option>'+'<option value="0.75">'+Zedity.t('Low')+'</option>'+'</select>'+'</p>'+'</div>'+'<div id="tab-image-link">'+Zedity.t('Insert image URL link:')+'<br/>'+'<textarea id="zedity-txtImageLink" rows="4"></textarea>'+'</div>'+'</div>'+'<p class="zedity-image-description">'+Zedity.t('Image description:')+'<br/>'+'<input id="zedity-txtImageDescription" type="text" value=""><br/><br/>'+'</p>'+'</div>');$dialog.find('.tabs').tabs({activate:function(event,ui){$(this).find('.ui-tabs-panel:visible').find('input[type=text],textarea,select,button').filter(':visible').filter(':first').focus()}});this.editor.$container.append($dialog);$dialog.dialog({title:Zedity.t('Insert image'),dialogClass:'zedity-dialog',autoOpen:false,modal:true,resizable:false,position:{my:'center',at:'center',of:window.top},open:function(){var $this=$(this);var box=$this.data('box');var disabled=[];if(!box._options.allowLink)disabled.push(1);$this.find('input[type=text],textarea').val('');$this.find('#zedity-ddImageQuality').val(0.88);$this.find('#zedity-lblMaxSize').text(Zedity.utils.beautifySize(box._options.maxSize));$this.find('.tabs').tabs('option',{active:0,disabled:disabled});$this.find('#zedity-lblSupportedImages').text(Object.keys(Zedity.utils.fileTypes.types).join(', '));var content=box.content();if(content&&/^http/.test(content)){$this.find('.tabs').tabs('selected','tab-image-link');$this.find('#zedity-txtImageLink').val(content)}$this.find('#zedity-txtImageDescription').val(box.$this.find('img').attr('alt')||'')},close:function(){var $this=$(this);$('#zedity-lblImageDisk').text('');$this.find('.zedity-fileupload').upload('clear')},buttons:[{text:Zedity.t('OK'),class:'zedity-button-ok',click:function(){var $this=$(this);var box=$this.data('box');if(box){var $inputDescription=$('#zedity-txtImageDescription');if(box._options.descriptionMandatory&&$inputDescription.val().length<4){if($inputDescription.val().length==0){box.editor._error({message:Zedity.t('Please insert image description.')})}else if($inputDescription.val().length<4){box.editor._error({message:Zedity.t('Image description is too short.')})}$inputDescription.focus();return}box._data.filterOriginal=null;switch($this.find('.tabs').tabs('selected')){case'tab-image-disk':var $fu=$this.find('.zedity-fileupload');if($fu.upload('getfilename')==''){box.editor._error({message:Zedity.t('No file selected.')});return}box._options.quality=parseFloat($this.find('#zedity-ddImageQuality').val());if(box._options.quality==1)box._options.quality=2;$fu.upload('submit');break;case'tab-image-link':var content=$('#zedity-txtImageLink').val();if(content==''){box.editor._error({message:Zedity.t('Please insert a link.')});return}box.content(content);break}box.description($inputDescription.val())}$(this).dialog('close')}},{text:Zedity.t('Cancel'),class:'zedity-button-cancel',click:function(){$(this).dialog('close')}}]})}$('.zedity-dialog-image .zedity-fileupload').upload({autosubmit:false,acceptmime:$.map(this._options.accept,function(key){return Zedity.utils.fileTypes.types[key].mime}).join(','),extensions:$.map(this._options.accept,function(key){return Zedity.utils.fileTypes.types[key].extensions}).join(' '),action:this._options.action,maxsize:this._options.maxSize,onselect:$.proxy(function(event,file){var fn=$(file).val();fn=fn.split(/[\\\/]/).pop();$('#zedity-lblImageDisk').html('Selected file:<br/><b>'+fn+'</b>');$('#zedity-txtImageDescription').focus()},this),onsubmit:function(file){var $this=$(this);var data=$this.data('upload');var box=$this.parents('.zedity-dialog-image').data('box');box._loading();data.$input.trigger('mouseout.upload');if(!Zedity.core.supports.fileapi()){box.editor._data.imageupload=box;return true}Zedity.utils.resizeImage(file.files[0],{maxwidth:box._sizeLimits().maxWidth,maxheight:box._sizeLimits().maxHeight,aspectratio:true,quality:box._options.quality,accept:box._options.accept,onerror:function(error){box.editor._error(error)},onresizeend:function(size,data,type){box.content(data,size);box._data.fileType=type}});return false},oncomplete:function(event,response){var box=$(this).parents('.zedity-dialog-image').data('box');if(!box)return;if(response.status=='OK'){if(box.editor._data.imageupload){box.editor._data.imageupload.content(response.data);delete box.editor._data.imageupload}else{box.editor._error({message:Zedity.t('An unexpected error occurred. Please try again.')})}}else{box.editor._error({message:Zedity.t('There was an error during server image resize.')})}},onerror:function(error){var box=$(this).parents('.zedity-dialog-image').data('box');if(!box)return;box.editor._error(error)}});return this},_loading:function(set){if(set===false){this.$this.find('.zedity-loading').remove()}else{this.$this.find('.zedity-empty').remove();this.$this.append('<div class="zedity-loading"><p>'+Zedity.t('Loading...')+'</p></div>')}return this},_checkSize:function(){this.$this.removeClass('zedity-warn-size-up zedity-warn-size-down');if(this._data.size){var $img=this.$this.find('img');var w=$img.width(),h=$img.height();if(this._data.size.width<w||this._data.size.height<h){this.$this.addClass('zedity-warn-size-down')}else if(this._data.size.width>w||this._data.size.height>h){this.$this.addClass('zedity-warn-size-up')}}return this},setOriginalSize:function(){return this.resizeToContent()},content:function(content,size,dontresize,onload){function resizeBox(){this.editor._changed();if(dontresize){Zedity.core._call(this,'layout',this.layout());return}var old=this.proportionalResize();Zedity.core._call(this,'proportionalResize',true);if(!old)Zedity.core._call(this,'proportionalResize',false)};function getSize(content){var img=new Image();img.onload=$.proxy(function(){this._data.size={width:img.width,height:img.height};img=null;resizeBox.call(this);onload.call(this)},this);img.src=content};if(content==null){content=this.$this.find('img').css('background-image');if(/data:image\//.test(content)){content=/(url\("?)(data:.*?)("?\))/i.exec(content)[2]}else if(/^url\(/.test(content)){content=/(url\("?)(.*?)("?\))/i.exec(content)[2]}else{content=this.$this.find('img').attr('src')}if(content==this._options.src)content=null}else{onload=onload||function(){};if(/^http/.test(content)){this._loading();this.$this.removeNumberedClass('imgDataS');this.$this.find('img').css({'background-image':'','background-size':'','background-position':''}).attr('src',content);this._loading(false);this._data.fileType=Zedity.utils.fileTypes.fromExtension(content);getSize.call(this,content)}else if(/^data:/.test(content)){this._loading();this.$this.find('img').css({'background-image':'','background-size':'100% 100%','background-position':'left top'}).attr('src',this._options.src);var idx=$('style.imgData').getEmptyNumberedClass('imgDataS');var $imgData=$('<style class="imgData imgDataS'+idx+'" type="text/css"></style>');$imgData.appendTo('head');$imgData.html('#'+this.editor.id+' .imgDataS'+idx+' img{background-image:url("'+content+'")}');this.$this.removeNumberedClass('imgDataS').addClass('imgDataS'+idx);this._addReference();if(this.layout()=='stretch'&&this.$this.find('img')[0].style.backgroundSize=='100%')this.layout('stretch');this._loading(false);if(size){this._data.size=size;resizeBox.call(this)}else{getSize.call(this,content)}}else{this.editor._error({message:Zedity.t('Could not interpret the content as image.')})}}return content},resizeToContent:function(){this.$this.css({width:this._data.size.width,height:this._data.size.height});Zedity.core._call(this,'layout',this.layout());this.reposition()._resize();this.editor.boxes.refreshSelected();this.editor._changed();return this},extractText:function(){this._data.$clone=this.$this.clone();this._data.$clone.find('style').remove();return Zedity.Box.prototype.extractText.call(this)},description:function(description){if(description!=null){this.$this.find('img').attr('alt',description)}else{description=this.$this.find('img').attr('alt')}return description},select:function(){Zedity.Box.prototype.select.call(this);if(this.$this.is(':data(ui-resizable)')){this.$this.resizable('option','aspectRatio',this.proportionalResize())}if(this.$this.data('ui-resizable')){this.$this.resizable('option','resize',$.proxy(function(){Zedity.core._call(this,'layout',this.layout())},this))}return this},_getQualityName:function(){if(this._options.quality<0.8){return'low'}else if(this._options.quality<0.9){return'normal'}else if(this._options.quality<=1){return'high'}else{return'original'}},start:function(){Zedity.Box.prototype.start.call(this);return this},stop:function(){Zedity.Box.prototype.stop.call(this);return this},insert:function(){Zedity.Box.prototype.insert.call(this);$('.zedity-dialog-image').data('box',this).dialog('open');return this},duplicate:function(){Zedity.Box.prototype.duplicate.call(this);if(this.layout()=='stretch'&&this.$this.find('img')[0].style.backgroundSize=='100%')this.layout('stretch');this.editor.boxes.selected()._addReference();return this},init:function(){Zedity.Box.prototype.init.call(this);if(this.$this.hasNumberedClass('imgDataS')){this._addReference();var nc=this.$this.getNumberedClass('imgDataS');var style=this.editor.$this.children('style.'+nc);if(style){style.detach().appendTo('head')}}return this},layout:function(layout){if(layout){this.$this.attr('data-layout',layout);if(!this._data.size)return layout;var wratio,hratio,ratio,width,height;var $c=this.$this.find('.zedity-content');switch(layout){case'fit':wratio=$c.width()/this._data.size.width;hratio=$c.height()/this._data.size.height;ratio=Math.min(wratio,hratio);width=Math.round(this._data.size.width*ratio);height=Math.round(this._data.size.height*ratio);break;case'centerfill':wratio=$c.width()/this._data.size.width;hratio=$c.height()/this._data.size.height;ratio=Math.max(wratio,hratio);width=Math.round(this._data.size.width*ratio);height=Math.round(this._data.size.height*ratio);break;case'stretch':width=$c.width();height=$c.height();break;case'center':width=this._data.size.width;height=this._data.size.height;break}this.$this.find('img').css({left:Math.round(($c.width()-width)/2),top:Math.round(($c.height()-height)/2),width:width,height:height});this._checkSize();this.editor._changed()}else{layout=this.$this.attr('data-layout')||''}return layout},proportionalResize:function(value){if(this.asBackground())return false;if(this.$this.find('.zedity-empty').length>0)return false;if(value===true){this.$this.attr('data-aspectratio',1);if(!this._data.size){Zedity.core._call(this,'content',Zedity.core._call(this,'content'));setTimeout($.proxy(function(){Zedity.core._call(this,'proportionalResize',true)},this),0);return true}var wratio=this.$this.width()/this._data.size.width;var hratio=this.$this.height()/this._data.size.height;var ratio=(wratio<hratio)?wratio:hratio;var width=Math.round(this._data.size.width*ratio);var height=Math.round(this._data.size.height*ratio);this.$this.css({width:width,height:height});if(this.$this.is(':data(ui-resizable)')){this.$this.resizable('option','aspectRatio',value)}Zedity.core._call(this,'layout',this.layout());this.editor.boxes.refreshSelected();this.editor._changed()}else if(value===false){this.$this.removeAttr('data-aspectratio');Zedity.core._call(this,'layout',this.layout());this.editor.boxes.refreshSelected();this.editor._changed()}return this.$this.attr('data-aspectratio')==1},asBackground:function(setting){var res=Zedity.Box.prototype.asBackground.call(this,setting);Zedity.core._call(this,'layout',this.layout());return res},_removeUnreferencedData:function(){var list=Zedity.core.gc.getNonReferenced('imageGc');for(var i=list.length-1;i>=0;--i){$('style.'+list[i]).remove()}Zedity.core.gc.deleteReference(list);return this},_addReference:function(){if(this.$this.hasNumberedClass('imgDataS')){var nc=this.$this.getNumberedClass('imgDataS');Zedity.core.gc.addReference(nc,'imageGc');Zedity.core.gc.addReference(nc,'imageGc-'+this.id)}return this},_save:function(callback,options){this._removeUnreferencedData();var nc=this.$this.getNumberedClass('imgDataS');if(nc){var style=$('head style.'+nc);if(style.length>0){if(!options.finalize){style.detach().appendTo(this.$this);if(typeof(callback)=='function')callback.call(this);return this}if(['center','tile'].indexOf(this.layout())>-1){style.detach().appendTo(this.$this);if(typeof(callback)=='function')callback.call(this)}else{var box=this;var bsize={w:0,h:0};this.editor.$this.children('.zedity-box-Image.'+nc).each(function(idx,elem){bsize.w=Math.max(bsize.w,$(elem).width());bsize.h=Math.max(bsize.h,$(elem).height())});Zedity.utils.resizeImage(style.html(),{maxwidth:bsize.w,maxheight:bsize.h,aspectratio:true,quality:this._options.quality,accept:this._options.accept,onerror:function(error){box.editor._error(error)},onresizeend:function(size,data,type){Zedity.core._call(box,'content',data,size,true);box._data.fileType=type;var newnc=box.$this.getNumberedClass('imgDataS');box.editor.$this.children('.zedity-box-Image.'+nc).removeClass(nc).addClass(newnc);box._addReference();$('head style.'+newnc).detach().appendTo(box.$this);style.remove();Zedity.Box.prototype._save.call(box);if(typeof(callback)=='function')callback.call(this)}})}}else{Zedity.Box.prototype._save.call(this);if(typeof(callback)=='function')callback.call(this)}}else{Zedity.Box.prototype._save.call(this);if(typeof(callback)=='function')callback.call(this)}return this},destroy:function(){Zedity.Box.prototype.destroy.call(this);var ref=Zedity.core.gc.getReferenced('imageGc-'+this.id);for(var i=ref.length-1;i>=0;--i){Zedity.core.gc.removeReference(ref[i],'imageGc')}Zedity.core.gc.flushData('imageGc-'+this.id);this._removeUnreferencedData();return this}});Zedity.Box.Image.type='Image';Zedity.Box.Image.sizeLimits={minWidth:16,minHeight:16,maxWidth:null,maxHeight:null};Zedity.Box.Image._defaults={src:'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7',width:250,height:200,layout:'centerfill',proportionalResize:true,quality:0.88,accept:Object.keys(Zedity.utils.fileTypes.types),maxSize:1000000,descriptionMandatory:true,allowLink:true};Zedity.Box.register({type:Zedity.Box.Image.type,requires:['canvas'],section:'basic',order:100});Zedity.core.gc.flushData('imageGc');Zedity.core.store.delprefix('imageGc-')})(jQuery);(function($){$.fn.upload=function(method){var methods={init:function(options){var settings={autosubmit:true,name:'file',acceptmime:'',extensions:undefined,maxsize:undefined,action:'/fake.php',enctype:'multipart/form-data',onsubmit:function(file){},oncomplete:function(event,response){},onselect:function(event,file){},onerror:function(error){}};$.extend(settings,options);if(typeof(settings.extensions)=='string')settings.extensions=settings.extensions.split(' ');return this.each(function(idx,elem){var $upload=$(this);if($upload.data('upload'))return;var id=Zedity.core.genId('upload');var $iframe=$('<iframe/>',{id:id,name:id,src:'javascript:false;',css:{display:'none'}});var $form=$('<form/>',{method:'post',enctype:settings.enctype,action:settings.action,target:id});var $input=$('<input/>',{name:settings.name,type:'file',accept:settings.acceptmime,css:{position:'absolute',right:-4,margin:0,padding:0,'font-size':'480px',opacity:0}}).on('change.upload',function(event){if(typeof(settings.onselect)=='function')settings.onselect.call($upload[0],event,$input[0]);if(settings.autosubmit)$upload.upload('submit')}).appendTo($form);$upload.data('upload',{$input:$input,$form:$form,$iframe:$iframe,extensions:settings.extensions,maxsize:settings.maxsize,onsubmit:settings.onsubmit,oncomplete:settings.oncomplete,onerror:settings.onerror});var $container=$('<div>',{css:{position:'absolute',zIndex:10000,padding:0,overflow:'hidden'}}).append($form).append($iframe);$upload.add($container).on('mouseenter.upload',function(){$container.css({left:$upload.offset().left,top:$upload.offset().top,width:$upload.outerWidth(),height:$upload.outerHeight()});$input.css({cursor:$upload.css('cursor')}).attr('title',$upload.attr('title'));$upload.addClass('zedity-hover')}).on('mouseleave.upload',function(){$upload.removeClass('zedity-hover')});$upload.on('focus.upload',function(){$upload.blur();var tabbables=$(":tabbable:visible");var index=tabbables.index($upload);tabbables.eq(index+1).focus()}).on('click.upload',function(){$input.show().focus().click().hide();return false});$('body').append($container)})},validate:function(){var data=$(this).data('upload');if(data.extensions){var ext=data.$input.val().split('.').pop().toLowerCase();if(data.extensions.indexOf(ext)<0){data.onerror.call(this,{message:Zedity.t('File extension not valid.')});data.$input.val('');return false}}if(data.maxsize&&Zedity.core.supports.fileapi()){if(data.$input[0].files[0].size>data.maxsize){data.onerror.call(this,{message:Zedity.t('File too big (max size: %s).',Zedity.utils.beautifySize(data.maxsize))});data.$input.val('');return false}}return true},getfilename:function(){var data=$(this).data('upload');if(data.$input){return data.$input.val()}return''},clear:function(){var data=$(this).data('upload');data.$input.val('')},submit:function(){var $this=$(this);var data=$this.data('upload');if(!$this.upload('validate'))return false;if(typeof(data.onsubmit)=='function')var ret=data.onsubmit.call(this,data.$input[0]);if(ret===false){data.$input.val('');return false}data.$iframe.off('load.upload').on('load.upload',function(event){data.$input.val('');var response=$(this).contents().find('body').html();try{response=JSON.parse(response)}catch(e){response={status:'ERROR',message:Zedity.t('Error in reading the response from the server')}}if(typeof(data.oncomplete)=='function')data.oncomplete.call($this[0],event,response)});data.$form.submit()}};if(methods[method]){return methods[method].apply(this,Array.prototype.slice.call(arguments,1))}else if(typeof method==='object'||!method){return methods.init.apply(this,arguments)}else{throw new Error(Zedity.t('Method %s does not exist on %s.',method,'jQuery.upload'))}};(function(){var oldSetOption=$.ui.resizable.prototype._setOption;$.ui.resizable.prototype._setOption=function(key,value){oldSetOption.apply(this,arguments);if(key==='aspectRatio')this._aspectRatio=!!value}})();Zedity.utils.resizeImage=function(input,options){if(!input)throw new Error(Zedity.t('Input not defined'));if(input instanceof jQuery)input=input[0];var MAX_FILE_SIZE=10000000;options=$.extend({maxwidth:1024,maxheight:1024,aspectratio:true,quality:0.88,accept:Object.keys(Zedity.utils.fileTypes.types),onerror:null,onresizeend:null},options);if(typeof(options.onerror)!='function')options.onerror=function(event){};if(typeof(options.onresizeend)!='function')options.onresizeend=function(size,data,type){};options.aspectratio=!!options.aspectratio;function resize(){options.origwidth=options.origwidth||options.image.width;options.origheight=options.origheight||options.image.height;options.maxwidth=options.maxwidth||options.image.width;options.maxheight=options.maxheight||options.image.height;var origImgSize=options.image.src.length;options.ftype=options.ftype||Zedity.utils.fileTypes.parse(options.image.src.substr(0,100),options.accept);var needResize=false;var width=options.maxwidth;var height=options.maxheight;if(!options.ftype.canResize){options.onerror({type:'WARNING',message:Zedity.t('Image file type cannot be resized.')});options.onresizeend({width:width,height:height},options.image.src,options.ftype);return}if(options.quality>1){options.onresizeend({width:width,height:height},options.image.src,options.ftype);return}var $canvas=$('<canvas/>');var canvas=$canvas[0];var context=canvas.getContext('2d');var userQualFactor=1;var wratio=(options.maxwidth/options.origwidth)*userQualFactor;var hratio=(options.maxheight/options.origheight)*userQualFactor;if(!options.aspectratio){width=wratio>1?options.origwidth:options.maxwidth;height=hratio>1?options.origheight:options.maxheight}else{if(wratio>1||hratio>1){wratio=hratio=1}else{if(wratio>hratio)hratio=wratio;else wratio=hratio}width=Math.round(options.origwidth*wratio);height=Math.round(options.origheight*hratio)}canvas.width=width;canvas.height=height;context.drawImage(options.image,0,0,canvas.width,canvas.height);var tmp;try{tmp=canvas.toDataURL(options.ftype.mime,options.quality)}catch(e){tmp=canvas.toDataURL('image/jpeg')}if((0.95*origImgSize)>tmp.length){options.onresizeend({width:width,height:height},tmp,options.ftype)}else{width=options.origwidth;height=options.origheight;options.onresizeend({width:width,height:height},options.image.src,options.ftype)}context=null;canvas=null;$canvas=null};function loadFile(){var fr=new FileReader();options.image=new Image();options.image.src='';fr.onload=function(event){if(event.total>MAX_FILE_SIZE){event.target.abort();return}options.ftype=Zedity.utils.fileTypes.parse(event.target.result.substr(0,100),options.accept);if(options.ftype.type=='other'||options.ftype.type==''){options.onerror($.extend(event,{error:Zedity.t('File is not a supported image.')}));return}options.image.onload=function(event){if(options.image.width==0||options.image.height==0){options.onerror($.extend(event,{error:Zedity.t('File is not recognized as valid image.')}));options.image=null;return}var w=options.image.width;var h=options.image.height;options.origwidth=options.image.width;options.origheight=options.image.height;resize()};options.image.src=event.target.result.replace(/^(data:)(.*?)(base64)/,'$1'+options.ftype.mime+';$3')};fr.onerror=function(event){switch(event.target.error.code){case event.target.error.ABORT_ERR:$.extend(event,{error:Zedity.t('File is too big.')});break;case event.target.error.NOT_FOUND_ERR:case event.target.error.NOT_READABLE_ERR:default:$.extend(event,{error:Zedity.t('Error during loading of the image.')});break};options.onerror(event)};fr.readAsDataURL(input)};function loadData(){options.image=new Image();options.image.src='';options.image.onload=function(){resize()};setTimeout(function(){options.image.src=input},0)};if(typeof input=='string'||input instanceof String){var rx=/(data:.*?)["\)$]/i;input=rx.exec(input)[1];loadData()}else if(input instanceof File){loadFile()}else if(input.nodeName=='IMG'){options.image=input;resize()}};Zedity.utils.beautifySize=function(size){if(size==0)return'0 Bytes';var sizes=['Bytes','KB','MB','GB'];var i=Math.min(Math.floor(Math.log(size)/Math.log(1000)),sizes.length-1);return+(size/Math.pow(1000,i)).toFixed(2)+' '+sizes[i]}})(jQuery);(function($){$.fn.hasNumberedClass=function(c){var classes=this.attr('class');var list=classes?classes.split(/\s+/):[];for(var i=0;i<list.length;i++){if(list[i].indexOf(c)!=-1)return true}return false};$.fn.getEmptyNumberedClass=function(c){var list=this.getNumberedClassList(c);var i=0;do{i++}while(list.indexOf(c+i)!=-1);return i};$.fn.getNumberedClass=function(c){var classes=this.attr('class');var list=classes?classes.split(/\s+/):[];for(var i=0,len=list.length;i<len;i++){if(list[i].indexOf(c)!=-1)return list[i]}return''};$.fn.getNumberedClassList=function(c,unique){var cl=[];this.each(function(idx,elem){var nc=$(elem).getNumberedClass(c);if(nc!=''&&(!unique||cl.indexOf(nc)==-1)){cl.push(nc)}});return cl};$.fn.removeNumberedClass=function(c){var numclass;return this.each(function(idx,elem){numclass=$(elem).getNumberedClass(c);if(numclass){$(elem).removeClass(numclass)}})}})(jQuery);(function($){var old_prototype=Zedity.Box.Image.prototype;var old_constructor=Zedity.Box.Image;var old_props={};for(var i in Zedity.Box.Image)if(Zedity.Box.Image.hasOwnProperty(i))old_props[i]=Zedity.Box.Image[i];Zedity.Box.Image=function(){old_constructor.apply(this,arguments);this._can.push('filter')};Zedity.Box.Image.prototype=old_prototype;for(var i in old_props)if(old_props.hasOwnProperty(i))Zedity.Box.Image[i]=old_props[i];var old_createPropBar=Zedity.Box.Image.prototype.createPropBar;Zedity.Box.Image.prototype.createPropBar=function(options){old_createPropBar.call(this);this.editor.menu.add({tabs:{editbox:{groups:{imagebox:{features:{filters:{type:'extpanel',icon:'filter',label:Zedity.t('Filters'),title:Zedity.t('Apply image filters'),order:300,build:function($panel,ed){$panel.append('<select class="zedity-image-filters">'+'<option disabled selected class="ui-helper-hidden"></option>'+'<option value="adjust">'+Zedity.t('Adjust colors')+'</option>'+'<option value="threshold">'+Zedity.t('Black & white')+'</option>'+'<option value="blur">'+Zedity.t('Blur')+'</option>'+'<option value="brightness">'+Zedity.t('Brightness')+'</option>'+'<option value="contrast">'+Zedity.t('Contrast')+'</option>'+'<option value="emboss">'+Zedity.t('Emboss')+'</option>'+'<option value="grayscale">'+Zedity.t('Grayscale')+'</option>'+'<option value="invert">'+Zedity.t('Invert')+'</option>'+'<option value="pixelize">'+Zedity.t('Mosaic')+'</option>'+'<option value="motionblur">'+Zedity.t('Motion blur')+'</option>'+'<option value="noise">'+Zedity.t('Noise')+'</option>'+'<option value="paint">'+Zedity.t('Paint')+'</option>'+'<option value="posterize">'+Zedity.t('Posterize')+'</option>'+'<option value="sobel">'+Zedity.t('Psychedelia')+'</option>'+'<option value="sepia">'+Zedity.t('Sepia')+'</option>'+'<option value="sharpen">'+Zedity.t('Sharpen')+'</option>'+'<option value="vignette">'+Zedity.t('Vignette')+'</option>'+'</select>'+'<span class="zedity-button zedity-imagefilter-apply"><span class="zicon zicon-size-xs zicon-ok"></span></span>'+'<span class="zedity-button zedity-imagefilter-reset"><span class="zicon zicon-size-xs zicon-undo"></span></span>'+'<span class="zedity-button zedity-imagefilter-resetall"><span class="zicon zicon-size-xs zicon-delete"></span></span>'+'<div class="zedity-imagefilter-args" style="margin-top:15px;padding-top:10px;border-top:1px solid lightgray;"></div>');$panel.find('.zedity-image-filters').selectmenu({width:140,appendTo:$panel,change:function(e,ui){var box=ed.boxes.selected();if(box)box._data.filterPrevious=box.content();var filter=ui.item.value;var $ia=$panel.find('.zedity-imagefilter-args').empty();$.each(Zedity.core.imageFilters.args[filter],function(idx,val){$ia.append('<span class="zedity-filter-arg-label">'+val.name+':</span>'+'<div class="zedity-filter-arg zedity-filter-arg-'+idx+'"></div>');$ia.find('.zedity-filter-arg-'+idx).sliderSnap({min:val.min,max:val.max,step:val.step}).sliderSnap('value',val.default)})}}).trigger('selectmenuchange');$panel.find('.zedity-imagefilter-apply').attr('title',Zedity.t('Apply filter')).on('click.zedity',function(){var box=ed.boxes.selected();if(!box)return;var filter=$panel.find('.zedity-image-filters').val();var values=[];$panel.find('.zedity-imagefilter-args .zedity-filter-arg').each(function(idx,elem){values.push($(elem).sliderSnap('value'))});box.filter(filter,values)});$panel.find('.zedity-imagefilter-reset').attr('title',Zedity.t('Reset filter')).on('click.zedity',function(){var box=ed.boxes.selected();if(!box)return;var filter=$panel.find('.zedity-image-filters').val();$.each(Zedity.core.imageFilters.args[filter],function(idx,val){$panel.find('.zedity-imagefilter-args .zedity-filter-arg-'+idx).sliderSnap('value',val.default)});box.content(box._data.filterPrevious,null,true)});$panel.find('.zedity-imagefilter-resetall').attr('title',Zedity.t('Remove all filters')).on('click.zedity',function(){var box=ed.boxes.selected();if(!box)return;var filter=$panel.find('.zedity-image-filters').val();$.each(Zedity.core.imageFilters.args[filter],function(idx,val){$panel.find('.zedity-imagefilter-args .zedity-filter-arg-'+idx).sliderSnap('value',val.default)});box.content(box._data.filterOriginal,null,true);box._data.filterPrevious=box._data.filterOriginal})},enable:function(ed,box){return(box&&box.$this.children('.zedity-empty').length==0)}}}}}}}},'imageboxcommercial')};$.extend(Zedity.Box.Image.prototype,{filter:function(filter,args){if(!filter)return this;if(filter=='reset'){this._data.filterOriginal=this.content();return this}if(filter=='restore'){this._data.filterOriginal=this._data.filterOriginal||this.content();this.content(this._data.filterOriginal,null,true);return this}var image=new Image();image.onload=$.proxy(function(){var data=Zedity.core.imageFilters.filter(image,filter,this._data.fileType?this._data.fileType.mime:'image/jpeg',this._options.quality,args);if(typeof data=='string'){this.content(data,null,true)}else{var err=Zedity.t('Error applying filter "%s".',filter);switch(data){case-1:err=Zedity.t('Filter "%s" not defined.',filter);break;case-2:err=Zedity.t('Could not read image data. Filters cannot be applied on images hosted on a different domain.');break}this.editor._error({message:err})}},this);var content=this._data.filterPrevious||this.content();if(content&&content!='none'){if(!this._data.filterOriginal)this._data.filterOriginal=content;image.src=content}return this}});Zedity.core.imageFilters.add('table',function(px,table,alpha){var d=px.data;for(var i=0,len=d.length;i<len;i+=4){d[i]=table[d[i]];d[i+1]=table[d[i+1]];d[i+2]=table[d[i+2]];if(alpha)d[i+3]=table[d[i+3]]}return px});Zedity.core.imageFilters.add('convolute',function(px,matrix,opaque){var side=Math.round(Math.sqrt(matrix.length));var halfSide=Math.floor(side/2);var d=px.data;var out=this._ctx.createImageData(px.width,px.height);var od=out.data;var alphaFac=opaque?1:0;for(var y=0;y<px.height;y++){for(var x=0;x<px.width;x++){var sy=y;var sx=x;var dstOff=(y*px.width+x)*4;var r=0,g=0,b=0,a=0;for(var cy=0;cy<side;cy++){for(var cx=0;cx<side;cx++){var scy=sy+cy-halfSide;var scx=sx+cx-halfSide;if(scy>=0&&scy<px.height&&scx>=0&&scx<px.width){var srcOff=(scy*px.width+scx)*4;var wt=matrix[cy*side+cx];r+=d[srcOff]*wt;g+=d[srcOff+1]*wt;b+=d[srcOff+2]*wt;a+=d[srcOff+3]*wt}}}od[dstOff]=r;od[dstOff+1]=g;od[dstOff+2]=b;od[dstOff+3]=a+alphaFac*(255-a)}}return out});Zedity.core.imageFilters.add('grayscale',function(px,percent){percent=percent||100;percent/=100;var d=px.data;for(var i=0,len=d.length;i<len;i+=4){var a=(0.2126*d[i]+0.7152*d[i+1]+0.0722*d[i+2])*percent;d[i]=d[i]+(a-d[i]*percent);d[i+1]=d[i+1]+(a-d[i+1]*percent);d[i+2]=d[i+2]+(a-d[i+2]*percent)}return px},[{name:Zedity.t('Percent'),default:100,min:1,max:100,step:1}]);Zedity.core.imageFilters.add('invert',function(px){var table=[];for(var i=0;i<=255;++i){table[i]=255-i}return this.filters['table'].call(this,px,table)});Zedity.core.imageFilters.add('brightness',function(px,adjustment){adjustment=Zedity.utils.normalize(adjustment!=null?adjustment:0,-100,100,-255,255);var table=[];for(var i=0;i<=255;++i){table[i]=i+adjustment}return this.filters['table'].call(this,px,table)},[{name:Zedity.t('Adjustment'),default:0,min:-100,max:100,step:1}]);Zedity.core.imageFilters.add('contrast',function(px,adjustment){adjustment=Zedity.utils.normalize(adjustment!=null?adjustment:0,-100,100,-255,255);var factor=(259*(adjustment+255))/(255*(259-adjustment));var table=[];for(var i=0;i<=255;++i){table[i]=Math.floor(factor*(i-128)+128)}return this.filters['table'].call(this,px,table)},[{name:Zedity.t('Adjustment'),default:0,min:-100,max:100,step:1}]);Zedity.core.imageFilters.add('threshold',function(px,threshold){threshold=threshold!=null?threshold:128;var d=px.data;for(var i=0,len=d.length;i<len;i+=4){d[i]=d[i+1]=d[i+2]=(0.2126*d[i]+0.7152*d[i+1]+0.0722*d[i+2]>=threshold)?255:0}return px},[{name:Zedity.t('Threshold'),default:128,min:0,max:255,step:1}]);Zedity.core.imageFilters.add('posterize',function(px,adjustment){adjustment=adjustment||15;var step=Math.floor(255/adjustment);var table=[];for(var i=0;i<=255;++i){table[i]=i+(Math.floor(i/step)*step)}return this.filters['table'].call(this,px,table)},[{name:Zedity.t('Adjustment'),default:15,min:1,max:255,step:1}]);Zedity.core.imageFilters.add('adjust',function(px,pr,pg,pb){pr=Zedity.utils.normalize(pr!=null?pr:0,-100,100,-255,255);pg=Zedity.utils.normalize(pg!=null?pg:0,-100,100,-255,255);pb=Zedity.utils.normalize(pb!=null?pb:0,-100,100,-255,255);var d=px.data;for(var i=0,len=d.length;i<len;i+=4){d[i]+=pr;d[i+1]+=pg;d[i+2]+=pb}return px},[{name:Zedity.t('Red'),default:0,min:-100,max:100,step:1},{name:Zedity.t('Green'),default:0,min:-100,max:100,step:1},{name:Zedity.t('Blue'),default:0,min:-100,max:100,step:1}]);Zedity.core.imageFilters.add('sepia',function(px){var d=px.data;for(var i=0,len=d.length;i<len;i+=4){var r=d[i];var g=d[i+1];var b=d[i+2];d[i]=(r*0.393)+(g*0.769)+(b*0.189);d[i+1]=(r*0.349)+(g*0.686)+(b*0.168);d[i+2]=(r*0.272)+(g*0.534)+(b*0.131)}return px});Zedity.core.imageFilters.add('vignette',function(px,amount){amount=amount||0.3;var radius=Math.sqrt(Math.pow(px.width/2,2)+Math.pow(px.height/2,2));this._ctx.globalCompositeOperation='source-over';var gradient=this._ctx.createRadialGradient(px.width/2,px.height/2,0,px.width/2,px.height/2,radius);gradient.addColorStop(0,'rgba(0,0,0,0)');gradient.addColorStop(0.5,'rgba(0,0,0,0)');gradient.addColorStop(1,'rgba(0,0,0,'+amount+')');this._ctx.fillStyle=gradient;this._ctx.fillRect(0,0,px.width,px.height);gradient=this._ctx.createRadialGradient(px.width/2,px.height/2,0,px.width/2,px.height/2,radius);gradient.addColorStop(0,'rgba(255,255,255,'+amount+')');gradient.addColorStop(0.5,'rgba(255,255,255,0)');gradient.addColorStop(1,'rgba(0,0,0,0)');this._ctx.fillStyle=gradient;this._ctx.fillRect(0,0,px.width,px.height);return this._ctx.getImageData(0,0,px.width,px.height)},[{name:Zedity.t('Amount'),default:0.3,min:0.1,max:1,step:0.1}]);Zedity.core.imageFilters.add('noise',function(px,noise){noise=Zedity.utils.normalize(noise||20,1,100,1,500);var noise2=noise/2;var d=px.data;for(var i=0,len=d.length;i<len;i+=4){d[i]=d[i]-noise2+(Math.random()*noise);d[i+1]=d[i+1]-noise2+(Math.random()*noise);d[i+2]=d[i+2]-noise2+(Math.random()*noise)}return px},[{name:Zedity.t('Noise'),default:20,min:1,max:100,step:1}]);Zedity.core.imageFilters.add('pixelize',function(px,size){size=size||10;var d=px.data;for(var y=0,h=px.height;y<h;y+=size){for(var x=0,w=px.width;x<w;x+=size){var i=((y*px.width)+x)*4;this._ctx.fillStyle='rgba('+d[i]+','+d[i+1]+','+d[i+2]+', '+d[i+3]+')';this._ctx.fillRect(x,y,size,size)}}return this._ctx.getImageData(0,0,px.width,px.height)},[{name:Zedity.t('Block size'),default:10,min:2,max:50,step:1}]);Zedity.core.imageFilters.add('sharpen',function(px,type){type=type||1;switch(type){case 1:return this.filters['convolute'].call(this,px,[0,-1,0,-1,5,-1,0,-1,0]);case 2:return this.filters['convolute'].call(this,px,[0,0,-1,0,0,0,-1,-2,-1,0,-1,-2,17,-2,-1,0,-1,-2,-1,0,0,0,-1,0,0])}},[{name:Zedity.t('Type'),default:1,min:1,max:2,step:1}]);Zedity.core.imageFilters.add('blur',function(px,size){size=size||3;var size2=Math.pow(size,2);var kernel=[];for(var i=size2-1;i>=0;--i){kernel[i]=1/size2}return this.filters['convolute'].call(this,px,kernel)},[{name:Zedity.t('Strength'),default:3,min:3,max:20,step:1}]);Zedity.core.imageFilters.add('sobel',function(px){var g=this.filters['grayscale'].call(this,px);var vertical=this.filters['convolute'].call(this,g,[-1,-2,-1,0,0,0,1,2,1]);var horizontal=this.filters['convolute'].call(this,g,[-1,0,1,-2,0,2,-1,0,1]);var out=this._ctx.createImageData(vertical.width,vertical.height);var d=out.data;for(var i=0,len=d.length;i<len;i+=4){var v=Math.abs(vertical.data[i]);d[i]=v;var h=Math.abs(horizontal.data[i]);d[i+1]=h;d[i+2]=(v+h)/4;d[i+3]=255}return out});Zedity.core.imageFilters.add('emboss',function(px){return this.filters['convolute'].call(this,px,[-2,-1,0,-1,1,1,0,1,2])});Zedity.core.imageFilters.add('motionblur',function(px){return this.filters['convolute'].call(this,px,[1,-1/2,0,0,0,-1/2,1,-1/2,0,0,0,-1/2,1,-1/2,0,0,0,-1/2,1,-1/2,0,0,0,-1/2,1])});Zedity.core.imageFilters.add('paint',function(px,range){range=range||3;var d=px.data;var out=this._ctx.createImageData(px.width,px.height);var od=out.data;var rh=[],gh=[],bh=[];var rt=[],gt=[],bt=[];var levels=256;for(var y=0;y<px.height;++y){for(var x=0;x<px.width;++x){var pixel=(y*px.width+x)*4;for(var i=0;i<levels;++i){rh[i]=gh[i]=bh[i]=rt[i]=gt[i]=bt[i]=0}for(var row=-range;row<=range;++row){var iy=y+row;if(0<=iy&&iy<px.height){var idy=iy*px.width;for(var col=-range;col<=range;++col){var ix=x+col;if(0<=ix&&ix<px.width){var idx=(idy+ix)*4;var rix=d[idx];var gix=d[idx+1];var bix=d[idx+2];rt[rix]+=rix;gt[gix]+=gix;bt[bix]+=bix;rh[rix]++;gh[gix]++;bh[bix]++}}}}var r=0,g=0,b=0;for(var i=1;i<levels;i++){if(rh[i]>rh[r])r=i;if(gh[i]>gh[g])g=i;if(bh[i]>bh[b])b=i}od[pixel]=rt[r]/rh[r];od[pixel+1]=gt[g]/gh[g];od[pixel+2]=bt[b]/bh[b];od[pixel+3]=d[pixel+3]}}return out},[{name:Zedity.t('Brush size'),default:3,min:1,max:5,step:1}])})(jQuery);
(function($){if(!Zedity)throw new Error(Zedity.t('%s needs %s.','Zedity.Box.Text','Zedity'));if(!Zedity.Box)throw new Error(Zedity.t('%s needs %s.','Zedity.Box.Text','Zedity.Box'));Zedity.Box.Text=function(options){this.type='Text';this._defaults=Zedity.Box.Text._defaults;Zedity.Box.prototype.constructor.call(this,options);this._options.defaultFont=this._options.defaultFont%this._options.fonts.length;this._options.defaultFontSize=this._options.defaultFontSize%this._options.fontSizes.length;this._data.textlength=0;if(this.$this.find('.zedity-content').length==0){this.$this.append('<div class="zedity-content" style="width:100%;height:100%;color:black;line-height:'+this._options.lineHeights[this._options.defaultLineHeight]+'"/>'+'<div class="zedity-empty"><p>'+Zedity.t('Click %s to insert text.','<span class="zedity-button"><span class="zicon zicon-text zicon-size-s"></span></span>')+'</p></div>');this.$this.find('.zedity-content').css({'font-size':this._options.fontSizes[this._options.defaultFontSize]+'px','font-family':this._options.fonts[this._options.defaultFont]})}};Zedity.Box.Text.prototype=Object.create(Zedity.Box.prototype);Zedity.Box.Text.prototype.constructor=Zedity.Box.Text;$.extend(Zedity.Box.Text.prototype,{createPropBar:function(options){Zedity.Box.prototype.createPropBar.call(this);var self=this;var fonts=[];for(var i=0,len=this._options.fonts.length;i<len;++i){fonts.push({value:this._options.fonts[i],label:this._options.fonts[i].split(',')[0],attributes:{'data-font':'12px '+this._options.fonts[i]}})}this.editor.menu.add({tabs:{editbox:{groups:{textbox:{title:Zedity.t('Text'),order:-1000,class:'zedity-group-box',features:{insert:{type:'button',icon:'text',label:Zedity.t('Insert'),title:Zedity.t('Insert/edit text'),onclick:function(e,ed){var box=ed.boxes.selected();if(!box)return;box.insert()}},alignment:{type:'menu',label:Zedity.t('Align'),title:Zedity.t('Text alignment'),icon:'textalign-center',items:[{value:'left',icon:'textalign-left',label:Zedity.t('Left')},{value:'center',icon:'textalign-center',label:Zedity.t('Center')},{value:'right',icon:'textalign-right',label:Zedity.t('Right')},{value:'justify',icon:'textalign-justify',label:Zedity.t('Justify')},'--',{value:'top',icon:'align-top',label:Zedity.t('Top')},{value:'middle',icon:'align-middle',label:Zedity.t('Middle')},{value:'bottom',icon:'align-bottom',label:Zedity.t('Bottom')}],onclick:function(val,e,ed){var box=ed.boxes.selected();if(!box)return;box.textAlign(val)},enable:function(ed,box){return(box&&box.$this.children('.zedity-empty').length==0)}}},show:function(ed,box){return box&&box.type=='Text'}}}},textbox:{icon:'text',title:Zedity.t('Text'),order:2000,groups:{edit:{title:Zedity.t('Editing'),order:0,class:'zedity-group-box',features:{done:{type:'button',icon:'ok',label:Zedity.t('Done'),title:Zedity.t('Done editing'),onclick:function(e,ed){var box=ed.boxes.selected();if(!box)return;box.stop()}}}},font:{title:Zedity.t('Font'),order:100,features:{font:{type:'menu',title:'Select font',width:250,order:0,items:fonts,onclick:function(val,e,ed){Zedity.core.selection.restore();Zedity.core.selection.format({'font-family':val});Zedity.core.selection.save()},refresh:function(ed,box){if(!box)return;var $elem=$(Zedity.core.selection.getElement());var font=$elem.css('font-family')||box._options.fonts[box._options.defaultFont];font=font.replace(/(,\s*)/g,',').replace(/(\'|\")/g,'');this.$menu.val(font).selectmenu('refresh')}},buttons:{type:'smallpanel',class:'zedity-panel-font',order:10,build:function($panel){$panel.css('font-size','18px').append('<span class="zedity-button zedity-btnB"><a href="javascript:;"><b>B</b></a></span>'+'<span class="zedity-button zedity-btnI"><a href="javascript:;"><i>I</i></a></span>'+'<span class="zedity-button zedity-btnU"><a href="javascript:;"><u>U</u></a></span>'+'<span class="zedity-button zedity-btnS" style="text-shadow:2px 2px 2px #000"><a href="javascript:;">S</a></span>');$panel.find('.zedity-btnB').attr('title',Zedity.t('Bold')).on('click.zedity-ribbon',function(){Zedity.core.selection.restore();Zedity.core.selection.command('bold');Zedity.core.selection.save()});$panel.find('.zedity-btnI').attr('title',Zedity.t('Italic')).on('click.zedity-ribbon',function(){Zedity.core.selection.restore();Zedity.core.selection.command('italic');Zedity.core.selection.save()});$panel.find('.zedity-btnU').attr('title',Zedity.t('Underline')).on('click.zedity-ribbon',function(){Zedity.core.selection.restore();Zedity.core.selection.command('underline');Zedity.core.selection.save()});$panel.find('.zedity-btnS').attr('title',Zedity.t('Shadow')).on('click.zedity-ribbon',function(){if(!Zedity.core.selection.selected())return;Zedity.core.selection.restore();var styled=null;Zedity.core.selection.format({'text-shadow':''},function(elem){var $elem=$(elem);if(styled==null){var ts=$elem.css('text-shadow')||'none';styled=(ts!='none'&&ts.indexOf('px')>-1)}$elem.add($elem.find('span,'+Zedity.core.selection._elements)).css({'text-shadow':(!styled?'4px 4px 4px #666':'none')})});Zedity.core.selection.save()})}},size:{type:'menu',title:Zedity.t('Select font size'),width:70,order:20,items:this._options.fontSizes,onclick:function(val,e,ed){Zedity.core.selection.restore();Zedity.core.selection.format({'font-size':val+'px'});Zedity.core.selection.save()},refresh:function(ed,box){if(!box||box.type!='Text')return;var $elem=$(Zedity.core.selection.getElement());var size=parseInt($elem.css('font-size')||box._options.fontSizes[box._options.defaultFontSize],10);this.$menu.val(size).selectmenu('refresh')}},color:{type:'extpanel',size:'xs',label:Zedity.t('Color'),icon:'empty zicon-colorpicker',title:Zedity.t('Select font color'),class:'zedity-font-colorpicker-button',order:30,build:function($panel,ed){this.$button.find('.zicon').width(30);$panel.append('<div class="zedity-font-colorpicker"/>');var $cp=$panel.find('.zedity-font-colorpicker');$cp.colorPicker({colors:['#ffffff','#f2f2f2','#d8d8d8','#bdbdbd','#a4a4a4','#6e6e6e','#424242','#2e2e2e','#000000','#fbefef','#f8e0e0','#f5a9a9','#f78181','#fe2e2e','#df0101','#b40404','#8a0808','#3b0b0b','#fbf5ef','#f8ece0','#f5d0a9','#faac58','#ff8000','#df7401','#b45f04','#8a4b08','#3b240b','#fbfbef','#f5f6ce','#f2f5a9','#f4fa58','#ffff00','#d7df01','#aeb404','#868a08','#393b0b','#f5fbef','#e3f6ce','#d0f5a9','#acfa58','#80ff00','#74df00','#5fb404','#4b8a08','#38610b','#effbef','#cef6ce','#a9f5a9','#58fa58','#00ff00','#01df01','#04b404','#088a08','#0b3b0b','#effbfb','#cef6f5','#a9f5f2','#58faf4','#00ffff','#01dfd7','#04b4ae','#088a85','#0b3b39','#eff5fb','#cee3f6','#81bef7','#2e9afe','#0080ff','#045fb4','#084b8a','#08388a','#0b243b','#efeffb','#cecef6','#5858fa','#2e2efe','#0000ff','#0404b4','#08088a','#0b0b61','#0b0b3b','#f5effb','#e3cef6','#be81f7','#ac58fa','#9a2efe','#5f04b4','#4b088a','#380b61','#240b3b','#fbeffb','#f6cef5','#f781f3','#fe2ef7','#ff00ff','#df01d7','#b404ae','#610b5e','#3b0b39','#fbeff5','#f6cee3','#f5a9d0','#fa58ac','#ff0080','#df0174','#b4045f','#610b38','#3b0b24'],defaultcolor:'#000000',fills:false,alpha:false,buttons:true,maxcols:9,onchange:function(e,color){var box=ed.boxes.selected();if(!box)return false;Zedity.core.selection.restore();Zedity.core.selection.format({color:color});Zedity.core.selection.save();self.editor.menu.$this.find('.zedity-font-colorpicker-button .zicon').css('background',color)}})},refresh:function(ed,box){if(!box)return false;var $elem=$(Zedity.core.selection.getElement());var c=$elem.css('color')||'#000000';var $cp=this.$button.extpanel('instance').panel.find('.zedity-font-colorpicker');$cp.colorPicker('selectcolor',c);this.$button.find('.zicon').css('background',c);$cp.find('.zedity-colorbuttons').hide()}},size2:{type:'smallpanel',order:40,build:function($panel){$panel.css('font-size','18px').append('<span class="zedity-button zedity-font-increase" data-type="1"><a href="javascript:;">A+</a></span>'+'<span class="zedity-button zedity-font-decrease" data-type="-1"><a href="javascript:;">A-</a></span>');$panel.find('.zedity-font-increase').attr('title',Zedity.t('Increase font size'));$panel.find('.zedity-font-decrease').attr('title',Zedity.t('Decrease font size'));$panel.find('.zedity-button').on('click.zedity-ribbon',function(){var box=self.editor.boxes.selected();if(!box)return;var feat=self.editor.menu._feature('textbox','font','size');var idx=box._options.fontSizes.indexOf(feat.$menu.val());var inc=parseInt($(this).attr('data-type')||1,10);idx=(idx>=0?idx:box._options.fontSizes.indexOf(box._options.defaultFontSize));if(((inc>0)&&(idx>=box._options.fontSizes.length-1))||((inc<0)&&(idx<=0)))return;var size=box._options.fontSizes[idx+inc];feat.$menu.val(size).selectmenu('refresh');feat.onclick.call(self.editor.menu,size,null,self.editor,feat)})}}}},insert:{title:Zedity.t('Insert'),order:300,features:{link:{type:'button',label:'Link',icon:'link',title:'Insert link',onclick:function(e,ed){Zedity.core.selection.save();Zedity.core.dialog({question:Zedity.t('Insert link url:'),default:'http://',ok:function(url){if(url){Zedity.core.selection.restore();Zedity.core.selection.command('createlink',url);Zedity.core.selection.save()}}})}}}}},show:function(ed,box){return box&&box.type=='Text'&&box.$this.hasClass('zedity-editing')}}}},'textbox');return this},_checkScrollbar:function(){var $content=this.$this.find('.zedity-content');if(!$content)return;var oldy=$content[0].scrollTop;this.$this.addClass('zedity-calculate');this.$this.attr('style',(this.$this.attr('style')||'').replace(/display:.*?(;|$)/g,'').replace(/table-layout:.*?(;|$)/g,''));$content.attr('style',($content.attr('style')||'').replace(/display:.*?(;|$)/g,'').replace(/overflow:.*?(;|$)/g,''));if($content.height()<this.$this.height()){this.$this.attr('style',this.$this.attr('style')+';display:table;table-layout:fixed;');$content.attr('style',$content.attr('style')+';display:table-cell;overflow:hidden;')}else{$content.attr('style',$content.attr('style')+';overflow:auto;')}this.$this.removeClass('zedity-calculate');$content[0].scrollTop=oldy},_calcLength:function(onlythis){if(onlythis){this._data.textlength=this.$this.find('.zedity-content').html().length}else{var boxes=this.editor.boxes.get(this.type);var total=0;for(var i=boxes.length-1;i>0;--i){var $content=boxes[i].$this.find('.zedity-content');if($content.length>0){var len=$content.html().length;total+=len;boxes[i]._data.textlength=len}}}return true},_checkLength:function(){if(this._data.textlength>this._options.maxTextLength)return false;var boxes=this.editor.boxes.get(this.type);var total=0;for(var i=boxes.length-1;i>0;--i){total+=boxes[i]._data.textlength}if(total>this._options.maxTotalTextLength)return false;return true},_refreshFontProperties:function(){clearTimeout(this._data.fontRefreshTimer);this._data.fontRefreshTimer=setTimeout($.proxy(function(){this.editor.menu.refresh('textbox','font');this.editor.menu.refresh('textbox','paragraph')},this),200);return this},_save:function(callback){var css=(this.$this.find('.zedity-content').attr('style')||'');css=css.replace(/\s+/g,' ').replace(/(;|,|:) /g,'$1').replace(/;{2,}/g,';').replace(/(^;|;$)/,'');this.$this.find('.zedity-content').attr('style',css);Zedity.Box.prototype._save.call(this);if(typeof(callback)=='function')callback.call(this);return this},select:function(){if(this.$this.hasClass('zedity-editing')||this.$this.hasClass('zedity-playing'))return this;Zedity.Box.prototype.select.call(this);if(this.$this.is(':data(ui-resizable)')){this.$this.resizable('option',{resize:$.proxy(function(){this._checkScrollbar()},this)})}return this},start:function(){Zedity.Box.prototype.start.call(this);this.editor.boxes._select(null);this.editor.boxes._select(this);var $this=this.$this;var $content=this.$this.find('.zedity-content');this.revert=$this.html();if($this.data('ui-draggable'))$this.draggable('option','disabled',true);if($this.data('ui-resizable'))$this.resizable('option','disabled',true);if($this.data('ui-rotatable'))$this.rotatable('option','disabled',true);$this.find('.zedity-empty').remove();$this.addClass('zedity-editing zedity-edited').removeClass('zedity-selected ui-state-disabled');$content.attr('contenteditable','true').focus();this._normalizeContent();Zedity.core.selection.setCursorPosition($content[0],0);this._calcLength(true);this.reposition(true);$content.focus();var tabs=[];for(var i=this.editor.menu._tabs.length-1;i>=0;--i){if(this.editor.menu._tabs[i].name!='textbox'){tabs.push(this.editor.menu._tabIdx(this.editor.menu._tabs[i].name))}}this.editor.menu.$this.tabs('option','disabled',tabs);this.editor.menu.openTab('textbox',true);return this},stop:function(){if(this._data.stopping||!this.$this.hasClass('zedity-editing'))return this;this._data.stopping=true;Zedity.Box.prototype.stop.call(this);var $this=this.$this;var $content=this.$this.find('.zedity-content');this._normalizeContent();if($this.hasClass('zedity-editing')){Zedity.core.selection.unselect();Zedity.core.selection._savedRange=null;$this.removeClass('zedity-editing');$content.removeAttr('contenteditable').blur();$content[0].normalize();if($this.data('ui-draggable'))$this.draggable('option','disabled',false);if($this.data('ui-resizable'))$this.resizable('option','disabled',false);if($this.data('ui-rotatable'))$this.rotatable('option','disabled',false);this.select();this._checkScrollbar();this.editor._changed();this.editor.menu.$this.tabs('option','disabled',[]);this.editor.menu.openTab('editbox')}this._calcLength();if(!this._checkLength()){this.editor._error({message:Zedity.t('Text length exceeds the maximum limit.')})}this._data.stopping=false;return this},insert:function(){Zedity.Box.prototype.insert.call(this);this.start();return this},_normalizeContent:function(){var $content=this.$this.find('.zedity-content');$content.contents().filter(function(){return((this.nodeType==3)&&($.trim(this.nodeValue)!=''))||($(this).is('span,a,b,strong,i,em,u'))}).each($.proxy(function(idx,elem){var $elem=$(elem);var $new=$('<p/>',{html:elem.outerHTML||$elem.text(),css:{margin:0,color:'black','font-size':this._options.fontSizes[this._options.defaultFontSize]+'px','font-family':this._options.fonts[this._options.defaultFont]}});$elem.replaceWith($new)},this));$content.find('span').each(function(idx,elem){var $elem=$(elem);if(elem.hasChildNodes()&&elem.childNodes.length==1&&elem.firstChild.tagName=='SPAN'){var child=elem.firstChild;for(var j=elem.style.length-1;j>=0;--j){var prop=elem.style[j];var cprop=child.style.getPropertyValue(prop);if(cprop==='')child.style.setProperty(prop,elem.style.getPropertyValue(prop),'')}$elem.replaceWith(child)}});$content.find('a:empty').remove();$content.find('p,h1,h2,h3,h4,h5,h6').filter(':empty').append('<br/>');if($.trim($content.text())==''){$content.html('<p style="margin:0;color:black">&nbsp;</p>');$content.find('p').css({'font-size':this._options.fontSizes[this._options.defaultFontSize]+'px','font-family':this._options.fonts[this._options.defaultFont]});Zedity.core.selection.setCursorPosition($content[0],0);$content.focus()}return this},content:function(content){if(content==null){content=this.$this.find('.zedity-content').html()}else{this.$this.find('.zedity-content').html(content);this.$this.find('.zedity-empty').remove();this.$this.addClass('zedity-editing');this.stop();this.editor._changed()}return content},textAlign:function(type,alignment){alignment=alignment||type;var $content=this.$this.find('.zedity-content');if(['left','center','right','justify'].indexOf(alignment)>-1){$content.css('text-align',alignment);$content.find('*').css('text-align','').removeAttr('align')}if(['top','middle','bottom'].indexOf(alignment)>-1){$content.css('vertical-align',alignment)}var oldflip=this.flip();Zedity.core._call(this,'flip','none');Zedity.core._call(this,'flip',oldflip);this._checkScrollbar();this.editor._changed();return this},init:function(){Zedity.Box.prototype.init.call(this);var self=this;this.$this.off('click.zedity').on('click.zedity',function(){if(!self.$this.hasClass('zedity-editing')){Zedity.core.selection._savedRange=undefined}}).off('dblclick.zedity dbltap.zedity').on('dblclick.zedity dbltap.zedity',function(){if($(this).hasClass('zedity-editing')){if(window.getSelection().toString().slice(-1)==' '){window.getSelection().modify('extend','backward','character')}Zedity.core.selection.save()}else{self.select().insert()}}).off('dblclick.zedity','a').on('dblclick.zedity','a',function(){if(!$(this).closest('.zedity-box-Text').hasClass('zedity-editing'))return;Zedity.core.selection.selectElement(this);Zedity.core.selection.save();$('.zedity-dialog-text-link').data('box',self).dialog('open');return false}).off('blur.zedity').on('blur.zedity',function(){if(Zedity.utils.opera())Zedity.core.selection.save();Zedity.core.selection.restore()}).off('mousedown.zedity').on('mousedown.zedity',function(e){if(e.button==0){Zedity.core.selection.unselect()}}).off('mouseup.zedityed').on('mouseup.zedityed',function(e){if(e.button==0){Zedity.core.selection.save();self._refreshFontProperties();if(Zedity.core.selection.selected()){var $elem=$(Zedity.core.selection.getElement());if($elem.is('a')){Zedity.core.selection.expand();Zedity.core.selection.save();$('.zedity-dialog-text-link').data('box',self).dialog('open')}}}}).off('keydown.zedity').on('keydown.zedity',$.proxy(function(e){if(e.keyCode==13){this._checkScrollbar()}else if(e.keyCode==32||(e.keyCode>=48&&e.keyCode<=90)){this._data.textlength++}else if(e.keyCode==8||e.keyCode==46){this._data.textlength--;this._normalizeContent();if($.trim(this.$this.find('.zedity-content').text())==''){return false}}if(!this._checkLength()){this.editor._error({message:Zedity.t('Text length exceeds the maximum limit.')});this._calcLength(true);return false}},this)).off('keyup.zedity').on('keyup.zedity',$.proxy(function(e){if(e.keyCode==13){var $el=$(Zedity.core.selection.getElement());if($el.closest('ol,ul').length)return;$el=$(Zedity.core.selection.getParagraph());var $prev=$el.prev();if($el.prop('tagName')!=$prev.prop('tagName')||$el.attr('style')==null){$el.css({margin:0,color:'black','font-weight':'','font-style':'','font-size':this._options.fontSizes[this._options.defaultFontSize]+'px','font-family':this._options.fonts[this._options.defaultFont]});var el=Zedity.core.selection.setParagraph('p');$el=$(el);if($.trim($el.text())==''){$el.html('&nbsp;');Zedity.core.selection.selectText(el)}}}this._refreshFontProperties();Zedity.core.selection.save()},this)).off('click.zedity','a').on('click.zedity','a',function(e){return false});$('html,body').off('mouseup.zedity').on('mouseup.zedity',function(){var eb=self.editor.$this.find('.zedity-box.zedity-editing');var ae=$(document.activeElement).closest('.zedity-box');if(eb.length>0&&eb.get(0)===ae.get(0)){Zedity.core.selection.save();return false}});if(Zedity.core.supports.touch()){document.onselectionchange=function(){var e=Zedity.core.selection.getElement();if(!e)return;e=$(e).closest('.zedity-content[contenteditable]');if(!e.length)return;Zedity.core.selection.save();self._refreshFontProperties();if(Zedity.core.selection.selected()){var $elem=$(Zedity.core.selection.getElement());if($elem.is('a')){Zedity.core.selection.expand();Zedity.core.selection.save();$('.zedity-dialog-text-link').data('box',self).dialog('open')}}}}this.$this.off('paste.zedity').on('paste.zedity',$.proxy(function(e){Zedity.core.selection.save();var $content=this.$this.find('.zedity-content');var old=$content.html();$content.blur();var $ta=$('<div contentEditable="true" style="width:1px;height:1px;position:absolute;overflow:hidden"></div>').appendTo('body');$ta.css({top:document.body.scrollTop+100,left:document.body.scrollLeft+10});$ta.focus();setTimeout($.proxy(function(){function pasteText(plain){if(plain){var text=$ta.text();$content.focus();Zedity.core.selection.restore();Zedity.core.selection.insertTextAtCursor(text)}else{var text=$ta.html();$content.focus();Zedity.core.selection.restore();Zedity.core.selection.insertHtmlAtCursor(text)}$ta.remove();this._calcLength(true);if(!this._checkLength()){this.editor._error({message:Zedity.t('Text length exceeds the maximum limit.')});$content.html(old);old=null;this._calcLength(true);Zedity.core.selection.restore();return false}this._normalizeContent();this._checkScrollbar()};if(!this._options.forcePastePlainText&&$ta.find('*').length>0){var zthis=this;$('<div style="padding:20px">'+'<span style="line-height:30px"><input type="radio" id="zedity-rbPasteText1" name="zedity-rbPasteText" value="1" checked="checked"><label for="zedity-rbPasteText1"> '+Zedity.t('Plain text.')+'</label></span><br/>'+'<span><input type="radio" id="zedity-rbPasteText0" name="zedity-rbPasteText" value="0"><label for="zedity-rbPasteText0"> '+Zedity.t('Formatted text.')+'</label></span>'+'</div>').dialog({dialogClass:'zedity-dialog',title:Zedity.t('Paste text'),modal:true,buttons:[{text:Zedity.t('OK'),click:function(){var $this=$(this);pasteText.call(zthis,!!parseInt($this.find('input[name=zedity-rbPasteText]:checked').val()));$this.dialog('close').dialog('destroy').remove()}}]})}else{pasteText.call(this,true)}},this),200)},this));return this}});Zedity.Box.Text.type='Text';Zedity.Box.Text.sizeLimits={minWidth:16,minHeight:16,maxWidth:null,maxHeight:null};Zedity.Box.Text._defaults={width:200,height:100,maxTextLength:300000,maxTotalTextLength:1000000,forcePastePlainText:false,fonts:['Arial,Helvetica,sans-serif','Arial Black,Gadget,sans-serif','Arial Narrow,sans-serif','Century Gothic,sans-serif','Comic Sans MS,cursive','Copperplate Gothic Light,sans-serif','Courier New,Courier,monospace','Georgia,serif','Gill Sans,sans-serif','Helvetica,sans-serif','Impact,Charcoal,sans-serif','Lucida Console,Monaco,monospace','Lucida Sans Unicode,Lucida Grande,sans-serif','Palatino Linotype,Book Antiqua,Palatino,serif','Tahoma,Geneva,sans-serif','Times New Roman,Times,serif','Trebuchet MS,Helvetica,sans-serif','Verdana,Geneva,sans-serif'],defaultFont:0,fontSizes:['11','12','14','16','19','21','24','27','29','32','37','48','53','64'],defaultFontSize:2,lineHeights:[1,1.1,1.2,1.3,1.5,1.7,2,2.5,3,4,5],defaultLineHeight:2};Zedity.Box.register({type:Zedity.Box.Text.type,requires:['selection'],section:'basic',order:0})})(jQuery);(function(){Zedity.utils=Zedity.utils||{};Zedity.utils.opera=function(){return/opera/i.test(navigator.userAgent)}})();(function($){var old=Zedity.Box.Text.prototype.createPropBar;Zedity.Box.Text.prototype.createPropBar=function(options){old.call(this);var self=this;this.editor.menu.add({tabs:{textbox:{icon:'text',title:Zedity.t('Text'),order:2000,groups:{paragraph:{title:Zedity.t('Paragraph'),order:200,features:{paragraph:{type:'menu',title:Zedity.t('Select paragraph'),width:150,order:0,items:[{value:'p',label:Zedity.t('Paragraph')+' (&lt;p&gt;)',},{value:'h1',label:Zedity.t('Heading')+' (&lt;h1&gt;)',},{value:'h2',label:Zedity.t('Heading')+' (&lt;h2&gt;)',},{value:'h3',label:Zedity.t('Heading')+' (&lt;h3&gt;)',},{value:'h4',label:Zedity.t('Heading')+' (&lt;h4&gt;)',},{value:'h5',label:Zedity.t('Heading')+' (&lt;h5&gt;)',},{value:'h6',label:Zedity.t('Heading')+' (&lt;h6&gt;)',}],onclick:function(val,e,ed){var box=ed.boxes.selected();if(!box)return false;var def={'font-size':'14px','font-style':'','font-weight':'bold'};Zedity.core.selection.restore();var elem=Zedity.core.selection.setParagraph(val);if(elem){switch(val){case'p':$(elem).css($.extend({},def,{'font-weight':''}));break;case'h1':$(elem).css($.extend({},def,{'font-size':'24px'}));break;case'h2':$(elem).css($.extend({},def,{'font-size':'20px'}));break;case'h3':$(elem).css($.extend({},def,{'font-size':'18px'}));break;case'h4':$(elem).css($.extend({},def,{'font-size':'16px'}));break;case'h5':$(elem).css(def);break;case'h6':$(elem).css($.extend({},def,{'font-style':'italic','font-weight':''}));break}Zedity.core.selection.selectText(elem);Zedity.core.selection.save();box.$this.find('.zedity-content').focus()}},refresh:function(ed,box){if(!box)return;var elem=Zedity.core.selection.getParagraph();if(elem){var val=elem.nodeName.toLowerCase();if(this.$menu.find('option[value="'+val+'"]').length==0)val='p';this.$menu.val(val)}this.$menu.selectmenu('refresh')}},alignment:{type:'smallpanel',class:'zedity-panel-align',order:10,build:function($panel){$panel.css('font-size','18px').append('<span class="zedity-button zedity-btnAlignPar zedity-btnLeft" data-cmd="justifyLeft"><a href="javascript:;"><span class="zicon zicon-size-xs zicon-textalign-left"></span></a></span>'+'<span class="zedity-button zedity-btnAlignPar zedity-btnCenter" data-cmd="justifyCenter"><a href="javascript:;"><span class="zicon zicon-size-xs zicon-textalign-center"></span></a></span>'+'<span class="zedity-button zedity-btnAlignPar zedity-btnRight" data-cmd="justifyRight"><a href="javascript:;"><span class="zicon zicon-size-xs zicon-textalign-right"></span></a></span>'+'<span class="zedity-button zedity-btnAlignPar zedity-btnJust" data-cmd="justifyFull"><a href="javascript:;"><span class="zicon zicon-size-xs zicon-textalign-justify"></span></a></span>');$panel.find('.zedity-btnLeft').attr('title',Zedity.t('Align left'));$panel.find('.zedity-btnCenter').attr('title',Zedity.t('Align center'));$panel.find('.zedity-btnRight').attr('title',Zedity.t('Align right'));$panel.find('.zedity-btnJust').attr('title',Zedity.t('Justify'));$panel.find('.zedity-btnAlignPar').on('click.zedity-ribbon',function(){Zedity.core.selection.restore();var elem=Zedity.core.selection.getParagraphs();var cmd=$(this).attr('data-cmd');$(elem).css('text-align','').removeAttr('align');Zedity.core.selection.restore();Zedity.core.selection.command(cmd);Zedity.core.selection.save()})},refresh:function(ed,box){if(!box)return}},lineheight:{type:'menu',title:Zedity.t('Select line height'),width:70,order:20,items:this._options.lineHeights,onclick:function(val,e,ed){var box=ed.boxes.selected();if(!box)return;box.$this.find('.zedity-content').focus();Zedity.core.selection.restore();var elem=Zedity.core.selection.getParagraphs();$(elem).css('line-height',val);Zedity.core.selection.save()},refresh:function(ed,box){if(!box)return;var elem=Zedity.core.selection.getParagraph();if(elem){var lh=$(elem).css('line-height')||'1.2';if(lh.indexOf('px')>-1){lh=Math.round(parseFloat(lh)/parseFloat($(elem).css('font-size')||14)*10)/10}else{lh=parseFloat(lh)}if(this.$menu.find('option[value="'+lh+'"]').length==0)lh='1.2';this.$menu.val(lh)}this.$menu.selectmenu('refresh')}},lists:{type:'smallpanel',class:'zedity-panel-lists',order:30,build:function($panel){$panel.css('font-size','18px').append('<span class="zedity-button zedity-btnOL" data-command="insertorderedlist" data-element="ol"><a href="javascript:;"><span class="zicon zicon-size-xs zicon-orderedlist"></span></a></span>'+'<span class="zedity-button zedity-btnUL" data-command="insertunorderedlist" data-element="ul"><a href="javascript:;"><span class="zicon zicon-size-xs zicon-unorderedlist"></span></a></span>');$panel.find('.zedity-btnOL').attr('title',Zedity.t('Ordered list'));$panel.find('.zedity-btnUL').attr('title',Zedity.t('Unordered list'));$panel.find('.zedity-button').on('click.zedity-ribbon',function(){var $this=$(this);Zedity.core.selection.restore();window.getSelection().collapseToEnd();Zedity.core.selection.command($this.attr('data-command'),false);var elem=Zedity.core.selection.getElement();$(elem).parentsUntil('.zedity-editor',$this.attr('data-element')).css('margin','0');Zedity.core.selection.save();self.editor.boxes.selected().$this.find('.zedity-content').focus()})},refresh:function(ed,box){if(!box)return}},paragraphspacing:{type:'menu',title:Zedity.t('Select paragraph spacing'),width:70,order:40,items:['0px','2px','5px','10px','15px','20px','25px','30px','40px','50px'],onclick:function(val,e,ed){var box=ed.boxes.selected();if(!box)return;box.$this.find('.zedity-content').focus();Zedity.core.selection.restore();var elem=Zedity.core.selection.getParagraphs();$(elem).css('margin-bottom',val);Zedity.core.selection.save()},refresh:function(ed,box){if(!box)return;var elem=Zedity.core.selection.getParagraph();if(elem)this.$menu.val($(elem).css('margin-bottom')||'0px');this.$menu.selectmenu('refresh')}},indent:{type:'smallpanel',class:'zedity-panel-indent',order:50,build:function($panel){$panel.css('font-size','18px').append('<span class="zedity-button zedity-btnIndent" data-command="indent" data-element="ol"><a href="javascript:;"><span class="zicon zicon-size-xs zicon-indent"></span></a></span>'+'<span class="zedity-button zedity-btnOutdent" data-command="outdent" data-element="ul"><a href="javascript:;"><span class="zicon zicon-size-xs zicon-outdent"></span></a></span>');$panel.find('.zedity-btnIndent').attr('title',Zedity.t('Indent'));$panel.find('.zedity-btnOutdent').attr('title',Zedity.t('Outdent'));$panel.find('.zedity-button').on('click.zedity-ribbon',function(){Zedity.core.selection.restore();window.getSelection().collapseToEnd();Zedity.core.selection.command($(this).attr('data-command'),false);var elem=Zedity.core.selection.getElement();$(elem).parentsUntil('.zedity-editor','blockquote').css('margin','0 0 0 40px');Zedity.core.selection.save();self.editor.boxes.selected().$this.find('.zedity-content').focus()})}}}}}}},build:function(ed){var $panel=this.editor.menu._feature('textbox','font','buttons').$panel;$panel.append('<span style="display:inline-block;width:20px"></span>'+'<span class="zedity-button zedity-btnSubSup zedity-btnSub" data-command="subscript"><a href="javascript:;"><span>X</span><sub style="font-size:0.7em">2</sub></a></span>'+'<span class="zedity-button zedity-btnSubSup zedity-btnSup" data-command="superscript"><a href="javascript:;"><span>X</span><sup style="vertical-align:top;font-size:0.7em;position:relative;top:-5px;line-height:inherit;">2</sup></a></span>');$panel.find('.zedity-btnSub').attr('title',Zedity.t('Subscript'));$panel.find('.zedity-btnSup').attr('title',Zedity.t('Superscript'));$panel.find('.zedity-btnSubSup').on('click.zedity-ribbon',function(){Zedity.core.selection.restore();Zedity.core.selection.command($(this).attr('data-command'));Zedity.core.selection.save()});this.editor.menu._feature('textbox','insert','link').onclick=function(e,ed){var box=ed.boxes.selected();if(!box)return;Zedity.core.selection.save();$('.zedity-dialog-text-link').data('box',box).dialog('open')};Zedity.core.patch(ed.menu._feature('textbox','font','color'),'refresh',this._data.enableCpButtons)}},'textboxcomm');if($('.zedity-dialog-text-link').length==0){var $dialog=$('<div class="zedity-dialog-text-link">'+Zedity.t('Insert link url:')+'<input id="zedity-txtTextLink" type="text" value=""><br/><br/>'+'<input id="zedity-rdTextLinkTarget-0" name="zedity-rdTextLinkTarget" type="radio" value="_self"/><label for="zedity-rdTextLinkTarget-0">'+Zedity.t('Open link in the same frame.')+'</label><br/>'+'<input id="zedity-rdTextLinkTarget-1" name="zedity-rdTextLinkTarget" type="radio" value="_top"/><label for="zedity-rdTextLinkTarget-1">'+Zedity.t('Open link in the same tab.')+'</label><br/>'+'<input id="zedity-rdTextLinkTarget-2" name="zedity-rdTextLinkTarget" type="radio" value="_blank" checked="checked"/><label for="zedity-rdTextLinkTarget-2">'+Zedity.t('Open link in a new tab.')+'</label><br/>'+'<div class="zedity-link-preview"><a href="javascript:;">'+Zedity.t('Link style preview')+'</a></div>'+'<div class="zedity-link-options">'+'<h4>'+Zedity.t('Link style')+'</h4>'+'<div class="zedity-link-style" style="max-height:180px;padding:5px">'+'<div class="zedity-fs1-wrapper"></div>'+'</div>'+'<h4>'+Zedity.t('Link style on mouse over')+'</h4>'+'<div class="zedity-link-stylemouseover" style="max-height:180px;padding:5px">'+'<div class="zedity-fs2-wrapper"></div>'+'</div>'+'</div>'+'</div>');var $fs1=$dialog.find('.zedity-fs1-wrapper');var $fs2=$dialog.find('.zedity-fs2-wrapper');this.editor.$container.append($dialog);$dialog.dialog({title:Zedity.t('Insert link'),dialogClass:'zedity-dialog',autoOpen:false,modal:true,resizable:false,position:{my:'center',at:'center',of:window.top},create:$.proxy(function(){$dialog.find('.zedity-link-options').accordion({active:false,collapsible:true,heightStyle:'content'});$fs1.add($fs2).fontSelector({order:'font,size,style,color',fonts:this._options.fonts,sizes:this._options.fontSizes,colorButtons:true,onchange:function(){if($(this).is($fs1.find('.zedity-fontselector'))){$dialog.data('stylelink',true);var style=$fs1.fontSelector('getfontstyle');$dialog.find('.zedity-link-preview a').css({color:$fs1.fontSelector('getcolor'),'font-family':$fs1.fontSelector('getfont'),'font-size':$fs1.fontSelector('getfontsize')+'px','font-weight':(style.bold?'bold':'normal'),'font-style':(style.italic?'italic':'normal'),'text-decoration':(style.underline?'underline':'none')})}else{$dialog.data('stylehover',true);style=$fs2.fontSelector('getfontstyle');$dialog.find('style').remove();$dialog.prepend('<style scoped="scoped">.zedity-link-preview a:hover{'+'color:'+$fs2.fontSelector('getcolor')+' !important;'+'font-family:'+$fs2.fontSelector('getfont')+' !important;'+'font-size:'+$fs2.fontSelector('getfontsize')+'px !important;'+'font-weight:'+(style.bold?'bold':'normal')+' !important;'+'font-style:'+(style.italic?'italic':'normal')+' !important;'+'text-decoration:'+(style.underline?'underline':'none')+' !important;'+'}</style>')}}});$fs1.add($fs2).find('.zedity-fontsizeselector2').hide();$fs1.add($fs2).find('.zedity-btnS').hide();setTimeout($.proxy(function(){$fs1.fontSelector('selectcolor','#0000FF');$fs1.fontSelector('selectfont',this._options.fonts[this._options.defaultFont]);$fs1.fontSelector('selectfontsize',this._options.fontSizes[this._options.defaultFontSize]);$fs1.fontSelector('selectfontstyle',{bold:false,italic:false,underline:true})},this),100);$fs2.fontSelector('selectcolor','#FF0000');$fs2.fontSelector('selectfont',this._options.fonts[this._options.defaultFont]);$fs2.fontSelector('selectfontsize',this._options.fontSizes[this._options.defaultFontSize]);$fs2.fontSelector('selectfontstyle',{bold:false,italic:false,underline:true});setTimeout(function(){$fs1.fontSelector('change');$fs2.fontSelector('change')},100)},this),open:function(){var box=$dialog.data('box');if(!box)return false;Zedity.core.selection.restore();var $elem=$(Zedity.core.selection.findElements('a'));if(!$elem.is('a'))$elem=$(Zedity.core.selection.getElement()).closest('a,.zedity-content');var href=$elem.attr('href');var id=$elem.attr('id');if(href)Zedity.core.selection.expand(true);Zedity.core.selection.save();$('#zedity-txtTextLink').val(href||'http://').select().focus();$('input[name=zedity-rdTextLinkTarget][value='+($elem.attr('target')||'_top')+']').prop('checked',true);if(!$elem.is('a'))return false;$dialog.data('stylelink',false);setTimeout(function(){$fs1.fontSelector('selectcolor',$elem.css('color')||'#0000FF');$fs1.fontSelector('selectfont',$elem.css('font-family')||box._options.fonts[box._options.defaultFont]);$fs1.fontSelector('selectfontsize',$elem.css('font-size')||box._options.fontSizes[box._options.defaultFontSize]);$fs1.fontSelector('selectfontstyle',{bold:$elem.css('font-weight')=='bold'||parseInt($elem.css('font-weight')||'400')>400,italic:$elem.css('font-style')=='italic',underline:(!$elem.css('text-decoration')||$elem.css('text-decoration').indexOf('none')==-1)})},100);var $stylel=$('#s'+id);$dialog.data('stylehover',$stylel.length);$fs2.fontSelector('selectcolor',$stylel.css('color')||'#FF0000');$fs2.fontSelector('selectfont',$stylel.css('font-family')||box._options.fonts[box._options.defaultFont]);$fs2.fontSelector('selectfontsize',$stylel.css('font-size')||box._options.fontSizes[box._options.defaultFontSize]);$fs2.fontSelector('selectfontstyle',{bold:$stylel.css('font-weight')=='bold'||parseInt($elem.css('font-weight')||'400')>400,italic:$stylel.css('font-style')=='italic',underline:(!$stylel.css('text-decoration')||$stylel.css('text-decoration').indexOf('none')==-1)});setTimeout(function(){$fs1.fontSelector('change');$fs2.fontSelector('change')},100)},close:function(){$dialog.find('.zedity-link-options').accordion('option','active',false)},buttons:[{text:Zedity.t('OK'),class:'zedity-button-ok',click:function(){var box=$dialog.data('box');var url=$('#zedity-txtTextLink').val();var target=$('input[name=zedity-rdTextLinkTarget]:checked').val();$dialog.dialog('close');Zedity.core.selection.restore();if(box&&url){var $elem=$(Zedity.core.selection.findElements('a')).eq(0);if($elem.length)box.$this.find('#s'+$elem.attr('id')).remove();var style=$elem.attr('style');$elem.removeAttr('style');if($elem.length){$elem.attr('href',url)}else{Zedity.core.selection.command('createlink',url);$elem=$(Zedity.core.selection.findElements('a')).eq(0)}if($dialog.data('stylelink')){style=$fs1.fontSelector('getfontstyle');$elem.css({color:$fs1.fontSelector('getcolor'),'font-family':$fs1.fontSelector('getfont'),'font-size':$fs1.fontSelector('getfontsize')+'px','font-weight':(style.bold?'bold':'normal'),'font-style':(style.italic?'italic':'normal'),'text-decoration':(style.underline?'underline':'none')})}else{$elem.attr('style',style)}if($dialog.data('stylehover')){var id=Zedity.core.genId('zl');$elem.attr({id:id,target:target});box.$this.find('#s'+id).remove();style=$fs2.fontSelector('getfontstyle');box.$this.prepend('<style id="s'+id+'" class="zedity-link-style" scoped="scoped">#s'+id+',#'+id+':hover{'+'color:'+$fs2.fontSelector('getcolor')+' !important;'+'font-family:'+$fs2.fontSelector('getfont')+' !important;'+'font-size:'+$fs2.fontSelector('getfontsize')+'px !important;'+'font-weight:'+(style.bold?'bold':'normal')+' !important;'+'font-style:'+(style.italic?'italic':'normal')+' !important;'+'text-decoration:'+(style.underline?'underline':'none')+' !important;'+'}</style>')}Zedity.core.selection.save()}}},{text:Zedity.t('Remove'),class:'zedity-button-remove',click:function(){var box=$dialog.data('box');$dialog.dialog('close');Zedity.core.selection.restore();if(box){var $elem=$(Zedity.core.selection.findElements('a')).eq(0);var id=$elem.attr('id');if(id)box.$this.find('#s'+id).remove();$elem.removeAttr('style');Zedity.core.selection.command('unlink');Zedity.core.selection.save()}}},{text:Zedity.t('Cancel'),class:'zedity-button-cancel',click:function(){$dialog.dialog('close');Zedity.core.selection.restore()}}]})}};Zedity.core.patch(Zedity.Box.Text.prototype,'stop',{after:function(){this.$this.find('style[scoped]').each(function(idx,elem){var $elem=$(elem);var id=($elem.attr('id')||'z').substring(1);if(id&&!$('#'+id).length){$elem.remove()}})}});$(document).on('dialogopen','.zedity-dialog-link',function(event,ui){var $this=$(this);if($this.find('.zedity-textbox-help').length==0){$this.append('<span style="clear:both"></span>'+'<span style="float:right"><span class="zedity-tooltip zedity-textbox-help" style="display:none">?</span></span>');$this.find('.zedity-textbox-help').attr('title',Zedity.t('The box link may override any link in the text.')).tooltip()}var obj=$this.data('obj');$this.find('.zedity-textbox-help').toggle(!!obj&&obj.type=='Text')})})(jQuery);
(function($){if(!Zedity)throw new Error(Zedity.t('%s needs %s.','Zedity.Box.Video','Zedity'));if(!Zedity.Box)throw new Error(Zedity.t('%s needs %s.','Zedity.Box.Video','Zedity.Box'));Zedity.Box.Video=function(options){this.type='Video';this._defaults=Zedity.Box.Video._defaults;Zedity.Box.prototype.constructor.call(this,options);this._can.remove('background','rotation','flip','corners');if(this.$this.find('object,iframe,video').length==0){if(this.$this.find('.zedity-empty').length==0){this.$this.append('<div class="zedity-empty"><p>'+Zedity.t('Click %s to insert video.','<span class="zedity-button"><span class="zicon zicon-video zicon-size-s"></span></span>')+'</p></div>')}}else if(this.$this.find('.zedity-boxoverlay').length==0){this.$this.append('<div class="zedity-boxoverlay"/>');var embed=Zedity.core.embed.parse(this.content(),'video');this._data.content=this.getSrc(embed.iframe||embed.flash).join('\n')}};Zedity.Box.Video.prototype=Object.create(Zedity.Box.prototype);Zedity.Box.Video.prototype.constructor=Zedity.Box.Video;$.extend(Zedity.Box.Video.prototype,{createPropBar:function(options){Zedity.Box.prototype.createPropBar.call(this);this.editor.menu.add({tabs:{editbox:{groups:{videobox:{title:Zedity.t('Video'),order:-1000,class:'zedity-group-box',features:{insert:{type:'button',order:0,icon:'video',label:Zedity.t('Insert'),title:Zedity.t('Insert video'),onclick:function(e,ed){var box=ed.boxes.selected();if(!box)return;box.insert()}},options:{type:'extpanel',order:10,icon:'config',label:Zedity.t('Options'),title:Zedity.t('Video embed options'),enable:function(ed,box){if(!box||box.type!='Video')return false;var service=box.getService();return!!service&&!$.isEmptyObject(service.options)},refresh:function(ed,box){if(!box||box.type!='Video')return;var service=box.getService();if(!service||$.isEmptyObject(service.options))return;var options=box.videoOptions()||[];var html='';for(var op in service.options){if(!service.options.hasOwnProperty(op))continue;html+='<label>'+'<input type="checkbox" value="'+op+'" '+(options.indexOf(op)>-1?'checked':'')+'/>'+' <span> '+service.options[op].title+'</span>'+'</label><br/>'}this.$extpanel.html(html);var self=this;this.$extpanel.find('input').on('change',function(){var options=self.$extpanel.find('input:checked').map(function(){return this.value}).get();box.videoOptions(options)})}},play:{type:'toggle',order:20,state:[{label:Zedity.t('Play'),icon:'play',title:Zedity.t('Play video')},{label:Zedity.t('Pause'),icon:'pause',title:Zedity.t('Pause video')}],onclick:function(e,ed,before){var box=ed.boxes.selected();if(!box)return false;switch(before){case 0:box.start();break;case 1:box.stop();break}},enable:function(ed,box){if(!box||box.type!='Video')return false;var service=box.getService();return service&&service.canplay},show:function(ed,box){if(!box||box.type!='Video')return false;var service=box.getService();return!service||(service&&service.canplay)},refresh:function(ed,box){if(!box)return;this.$button.trigger('toggle',box.$this.hasClass('zedity-playing')?1:0)}},view:{type:'toggle',order:20,state:[{label:Zedity.t('Show'),icon:'view',title:Zedity.t('Show video')},{label:Zedity.t('Close'),icon:'view',title:Zedity.t('Close video')}],onclick:function(e,ed,before){var box=ed.boxes.selected();if(!box)return false;switch(before){case 0:box.start();break;case 1:box.stop();break}},show:function(ed,box){if(!box||box.type!='Video')return false;var service=box.getService();return!!service&&!service.canplay},refresh:function(ed,box){if(!box)return;this.$button.trigger('toggle',box.$this.hasClass('zedity-playing')?1:0)}}},show:function(ed,box){return box&&box.type=='Video'}}}}}},'videobox');return this},_sizeLimits:function(){var sl=Zedity.Box.prototype._sizeLimits.call(this);var service=this.getService();if(!service)return sl;return{minWidth:service.sizeLimits.minWidth||sl.minWidth,maxWidth:service.sizeLimits.maxWidth||sl.maxWidth,minHeight:service.sizeLimits.minHeight||sl.minHeight,maxHeight:service.sizeLimits.maxHeight||sl.maxHeight}},_save:function(callback){Zedity.Box.prototype._save.call(this);this.$this.find('.zedity-boxoverlay').remove();if(typeof(callback)=='function')callback.call(this);return this},content:function(content){function checkFiles(content){var filetypes=Object.keys(this._options.filetypes);for(var i=filetypes.length-1;i>=0;--i){var rx=new RegExp('\\.'+filetypes[i]+'(?:$|\\?)','gm');if(rx.test(content))return true}return false};if(content!=null){if(typeof content=='string'||content instanceof String){var embed=Zedity.core.embed.parse(content,'video');if(!embed.code){if(checkFiles.call(this,content)){return Zedity.core._call(this,'content',content.split('\n'))}else{this.editor._error({message:Zedity.t('Please provide a valid link/embed code for any of the supported video services.')});return this.content()}}else if(embed.html5){return Zedity.core._call(this,'content',embed.html5)}else{content=(embed.iframe||embed.flash)+'<div class="zedity-boxoverlay"/>';this.$this.attr('data-service',embed.service)}}else if($.isArray(content)){var thumbnail='';for(var i=0,len=content.length;i<len;++i){if(['jpeg','jpg','jpe','png'].indexOf(content[i].split('.').pop())>-1){thumbnail=' poster="'+content[i]+'"';break}}var html='<video controls="controls" style="width:100%;height:100%" preload="none"'+thumbnail+'>';for(var i=0,len=content.length;i<len;++i){var ext=content[i].split('.').pop();if(this._options.filetypes[ext]){html+='<source src="'+content[i]+'" type="'+this._options.filetypes[ext]+'"/>'}}html+='<p>Your browser does not support HTML5 videos.</p></video><div class="zedity-boxoverlay"/>';content=html;this.$this.attr('data-service','html5')}else{this.editor._error({message:Zedity.t('Could not interpret the content as video.')})}this.videoOptions(this._data.videoOptions)}content=Zedity.Box.prototype.content.call(this,content);this._data.content=content=this.getSrc(content).join('\n');this._resize();this.editor.boxes.refreshSelected();return content},getSrc:function(content){content=content||this.content();var src=[];$('<div/>').html(content).find('object,iframe,video,video source').each(function(){var ts=$(this).attr('src')||$(this).attr('data')||$(this).attr('poster');if(ts)src.push(ts)});return src},videoOptions:function(options){var service=this.getService();if($.isArray(options)){var params='';for(var i=options.length-1;i>=0;--i){params+='&'+service.options[options[i]].urlparam}var self=this;this.$this.find('object,iframe,video,video source').each(function(){var $this=$(this);if($this.attr('src'))$this.attr('src',self._data.content+params);if($this.attr('data'))$this.attr('data',self._data.content+params)})}else{options=[];var content;this.$this.find('object,iframe,video,video source').each(function(){content=$(this).attr('src')||$(this).attr('data');return false});if(content){for(var op in service.options){if(!service.options.hasOwnProperty(op))continue;if(content.indexOf(service.options[op].urlparam)>=1)options.push(op)}}}this._data.videoOptions=options;return options},select:function(){if(this.$this.hasClass('zedity-editing')||this.$this.hasClass('zedity-playing'))return this;Zedity.Box.prototype.select.call(this);return this},rotation:function(setting){if(setting!=null){this.editor._error({message:Zedity.t('%s can\'t be rotated.','Video box')})}return 0},background:function(setting){if(setting!=null){this.editor._error({message:Zedity.t('%s doesn\'t support background property.','Video box')})}return{type:'solid',alpha:1,colors:['transparent']}},corners:function(setting){if(setting!=null){this.editor._error({message:Zedity.t('%s doesn\'t support rounded corners.','Video box')})}return{'border-top-left-radius':0,'border-top-right-radius':0,'border-bottom-left-radius':0,'border-bottom-right-radius':0}},flip:function(setting){if(setting!=null){this.editor._error({message:Zedity.t('%s doesn\'t support flipping.','Video box')})}return'none'},start:function(){Zedity.Box.prototype.start.call(this);var $obj=this.$this.find('object,iframe,video');if($obj.lenght==0)return this;var service=this.getService();if(!service)return this;if(this.$this.data('ui-draggable'))this.$this.draggable('option','disabled',true);if(this.$this.data('ui-resizable'))this.$this.resizable('option','disabled',true);this.$this.removeClass('ui-state-disabled');Zedity.core.embed.player($obj,service.service,'play');this.$this.addClass('zedity-playing').find('.zedity-boxoverlay').hide();return this},stop:function(){Zedity.Box.prototype.stop.call(this);var $obj=this.$this.find('object,iframe,video');if($obj.lenght==0)return this;var service=this.getService();if(!service)return this;if(this.$this.data('ui-draggable'))this.$this.draggable('option','disabled',false);if(this.$this.data('ui-resizable'))this.$this.resizable('option','disabled',false);if(this.$this.hasClass('zedity-playing')){Zedity.core.embed.player($obj,service.service,'pause')}this.$this.removeClass('zedity-playing').find('.zedity-boxoverlay').show();return this},insert:function(){Zedity.Box.prototype.insert.call(this);$('.zedity-dialog-video').data('box',this).dialog('open');return this},getService:function(){var service=this.$this.attr('data-service')||this.$this.find('object,iframe,video').attr('data-service');var data;if(service=='html5'){data={service:'html5',type:'video',canplay:true,sizeLimits:{minWidth:230,maxWidth:null,minHeight:100,maxHeight:null}}}else{data=Zedity.core.embed.services[service];if(data)data.canplay=!!(data.player.flash.play||data.player.iframe.play)}return data},duplicate:function(){var newbox=Zedity.Box.prototype.duplicate.call(this);var $obj=newbox.$this.find('object,iframe,video');var service=newbox.getService();if(service){$obj.attr('id',Zedity.core.genId(service.service))}return newbox},init:function(){Zedity.Box.prototype.init.call(this);if($('.zedity-dialog-video').length==0){var $dialog=$('<div class="zedity-dialog-video">'+'<div class="tabs">'+'<ul>'+'<li><a href="#tab-video-embed">'+Zedity.t('Embed')+'</a></li>'+'<li><a href="#tab-video-files">'+Zedity.t('Files')+'</a></li>'+'</ul>'+'<div id="tab-video-embed">'+Zedity.t('Insert video embed code or url:')+'<br/>'+'<textarea id="zedity-txtVideoEmbed" rows="4"></textarea>'+'<p>'+Zedity.t('Supported services:')+'<br/><span id="zedity-lblVideoServices"></span></p>'+'</div>'+'<div id="tab-video-files">'+Zedity.t('Select video from the list of available videos:')+'<br/>'+'<div id="zedity-ddVideoFiles" class="zedity-button zedity-ddmenu zedity-menu" data-ddmenu="#zedity-videosel-menu" style="width:260px"><span><a href="javascript:;">--</a></span></div>'+'<ul id="zedity-videosel-menu" class="zedity-propbar-menu"></ul>'+'<img id="zedity-video-preview" src=""/>'+'</div>'+'</div>'+'</div>');$dialog.find('.tabs').tabs({activate:function(event,ui){$(this).find('.ui-tabs-panel:visible').find('input[type=text],textarea,select').filter(':visible').filter(':first').focus()}});this.editor.$container.append($dialog);$dialog.dialog({title:Zedity.t('Insert video'),dialogClass:'zedity-dialog',autoOpen:false,modal:true,resizable:false,position:{my:'center',at:'center',of:window.top},open:function(){var $this=$(this);var $tabs=$this.find('.tabs');var box=$this.data('box');var disabled=[];$('#zedity-video-preview').attr('src','').hide();$('#zedity-ddVideoFiles a').html('--');if($('#zedity-videosel-menu').data('ui-menu'))$('#zedity-videosel-menu').menu('destroy').html('');if(box._options.files){var files='<li data-value="-1"><a href="javascript:;">--</a></li>';for(var i=0,len=box._options.files.length;i<len;++i){var tn=box._options.files[i].thumbnail?'<img class="zedity-pic-preview" src="'+box._options.files[i].thumbnail+'"/>':'';files+='<li data-value="'+i+'"><a href="javascript:;">'+tn+box._options.files[i].title+'</a></li>'}$('#zedity-videosel-menu').html(files);$('#zedity-ddVideoFiles').ddmenu({onchange:function(){$('#zedity-video-preview').attr('src','').hide();var val=$(this).ddmenu('value');if(val==-1)return;if(box._options.files[val].thumbnail){$('#zedity-video-preview').attr('src',box._options.files[val].thumbnail).show()}}})}else{disabled.push($tabs.tabs('getidx','tab-video-files'))}var services=Zedity.core.embed.getServices('video',true);$('#zedity-lblVideoServices').html(services.join(', '));$this.find('input[type=text],textarea').val('');$tabs.tabs('option',{active:0,disabled:disabled});$('#zedity-txtVideoEmbed').val(box.content()).focus()},close:function(){$(this).data('box',null)},buttons:[{text:Zedity.t('OK'),class:'zedity-button-ok',click:function(){var box=$(this).data('box');$(this).dialog('close');if(!box)return;var content='';switch($(this).find('.tabs').tabs('selected')){case'tab-video-embed':content=$('#zedity-txtVideoEmbed').val();var embed=Zedity.core.embed.parse(content,'video');if(!embed.code){box.editor._error({message:Zedity.t('Please provide a valid link/embed code for any of the supported video services.')});return}break;case'tab-video-files':var val=parseInt($('#zedity-ddVideoFiles').ddmenu('value'));if(val>-1){content=box._options.files[val].src;if(box._options.files[val].thumbnail){content.unshift(box._options.files[val].thumbnail)}}break}box.content(content)}},{text:Zedity.t('Cancel'),class:'zedity-button-cancel',click:function(){$(this).dialog('close')}}]})}return this}});Zedity.Box.Video.type='Video';Zedity.Box.Video.sizeLimits={minWidth:220,minHeight:200,maxWidth:null,maxHeight:null};Zedity.Box.Video._defaults={width:300,height:200,filetypes:{mp4:'video/mp4',mov:'video/mp4',ogg:'video/ogg',ogv:'video/ogg',webm:'video/webm'}};Zedity.Box.register({type:Zedity.Box.Video.type,section:'media-embed',order:0});Zedity.core.embed.add('youtube',{url:'http://www.youtube.com',type:'video',regex:[new RegExp('youtube\\.com/watch\\?.*v=(.+?)(&|"|\'|$)'),new RegExp('youtu\\.be/(.+?)(\\?|&|$)'),new RegExp('youtube(?:-nocookie|)\\.com/(?:v|embed)/(.+?)(\\?|&|"|\'|$)')],parser:function(code){return{code:code[1],flash:'//www.youtube.com/v/'+code[1]+'?rel=0&amp;showsearch=0&amp;showinfo=0&amp;enablejsapi=1',iframe:'//www.youtube.com/embed/'+code[1]+'?wmode=opaque&amp;rel=0&amp;modestbranding=1&amp;showinfo=0&amp;enablejsapi=1'}},player:{flash:{play:'playVideo',pause:'pauseVideo'},iframe:{play:'playVideo',pause:'pauseVideo',command:function(frame_id,func,args){$('#'+frame_id)[0].contentWindow.postMessage(JSON.stringify({event:'command',func:func,args:args||[],id:frame_id}),'*')}}}});Zedity.core.embed.add('vimeo',{url:'http://vimeo.com',type:'video',regex:[new RegExp('vimeo\\.com/.*?clip_id=(.*?)("|\'|&|$)'),new RegExp('vimeo\\.com/.*?([^/]+?)("|\'|\\?|&|$)')],parser:function(code){return{code:code[1],flash:'//vimeo.com/moogaloop.swf?clip_id='+code[1]+'&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=00adef&amp;fullscreen=0&amp;loop=0&amp;api=1',iframe:'//player.vimeo.com/video/'+code[1]+'?title=0&amp;byline=0&amp;portrait=0&amp;api=1'}},player:{flash:{play:'api_play',pause:'api_pause'},iframe:{play:'play',pause:'pause',command:function(frame_id,func,value){$('#'+frame_id)[0].contentWindow.postMessage(JSON.stringify({method:func,value:value}),'*')}}}})})(jQuery);(function($){var old=Zedity.Box.Video.prototype.createPropBar;Zedity.Box.Video.prototype.createPropBar=function(options){old.call(this)};var old_init=Zedity.Box.Video.prototype.init;Zedity.Box.Video.prototype.init=function(options){old_init.apply(this,arguments);var $dialog=$('.zedity-dialog-video');$dialog.parent().find('.zedity-button-ok').off('click').on('click',$.proxy(function(){var box=$(this).data('box');$(this).dialog('close');if(!box)return;var content='';switch($(this).find('.tabs').tabs('selected')){case'tab-video-embed':content=$('#zedity-txtVideoEmbed').val();break;case'tab-video-files':var val=parseInt($('#zedity-ddVideoFiles').ddmenu('value'));if(val>-1){content=box._options.files[val].src;if(box._options.files[val].thumbnail){content.unshift(box._options.files[val].thumbnail)}}break}box.content(content)},$dialog[0]))};if(Zedity.core.embed.services.youtube){Zedity.core.embed.services.youtube.regex=[new RegExp('youtube\\.com/watch\\?.*v=(.+?)(?:[&"\'\\s]|$)[^"\'\\s]*'),new RegExp('youtu\\.be/(.+?)(?:[?&"\'\\s]|$)[^"\'\\s]*'),new RegExp('youtube(?:-nocookie|)\\.com/(?:v|embed)/(.+?)(?:[?&"\'\\s]|$)[^"\'\\s]*')];Zedity.core.embed.services.youtube.parser=function(code){var listcode=decodeURIComponent((new RegExp('[?|&]list=([^&;]+?)(&|#|;|$)').exec(code[0])||[,""])[1].replace(/\+/g,'%20'))||'';if(listcode)listcode='&list='+listcode;return{code:code[1],flash:'//www.youtube.com/v/'+code[1]+'?rel=0&amp;loop=0&amp;autoplay=0&amp;showsearch=0&amp;showinfo=0&amp;enablejsapi=1'+(listcode?listcode:''),iframe:'//www.youtube.com/embed/'+code[1]+'?wmode=opaque&amp;rel=0&amp;modestbranding=1&amp;showinfo=0&amp;enablejsapi=1'+(listcode?listcode:'')}};Zedity.core.embed.services.youtube.options={autoplay:{title:Zedity.t('Autoplay'),urlparam:'autoplay=1'}}}if(Zedity.core.embed.services.vimeo){Zedity.core.embed.services.vimeo.options={autoplay:{title:Zedity.t('Autoplay'),urlparam:'autoplay=1'}}}Zedity.core.embed.add('facebook',{url:'https://facebook.com/',type:'video',regex:[new RegExp('facebook\\.com/(?:.*?)/videos/(.*?)(&|/|\\?|"|\'|$)'),new RegExp('facebook\\.com/(?:photo|video)\\.php\\?v=(.*?)(&|/|\\?|"|\'|$)'),new RegExp('facebook\\.com/video/embed\\?video_id=(.*?)(&|/|\\?|"|\'|$)'),new RegExp('facebook\\.com/v.*?/plugins/video\\.php\\?.*?href=.*?%3Fv%3D(.*?)(%|&|/|\\?|"|\'|$)'),new RegExp('facebook\\.com/(?:v.*?/)*plugins/video\\.php\\?.*?href=.*videos%2F(.*?)(%|&|/|\\?|"|\'|$)')],parser:function(code){return{code:code[1],iframe:'//www.facebook.com/plugins/video.php?href='+encodeURIComponent('https://www.facebook.com/facebook/videos/'+code[1])}}});Zedity.core.embed.add('instagram',{url:'http://instagram.com/',type:'video',regex:[new RegExp('instagram\\.com/p/(.*?)(/|\\?|"|\'|$)')],parser:function(code,embed){return{code:code[1],iframe:'//www.instagram.com/p/'+code[1]+'/embed/'}},sizeLimits:{minWidth:240}});Zedity.core.embed.add('dailymotion',{url:'http://www.dailymotion.com',type:'video',regex:[new RegExp('dailymotion\\..*?/(?:video|swf/video|swf)/(.+?)(_|\\?|&|"|\'|$)')],parser:function(code){return{code:code[1],flash:'//www.dailymotion.com/swf/'+code[1]+'?enableApi=1',iframe:'//www.dailymotion.com/embed/video/'+code[1]+'&amp;api=postMessage&amp;logo=0&amp;related=0'}}});Zedity.core.embed.add('metacafe',{url:'http://www.metacafe.com',type:'video',regex:[new RegExp('metacafe\\.com/(?:watch|embed|fplayer|w)/(.*?)(/|$)')],parser:function(code){return{code:code[1],flash:'//www.metacafe.com/fplayer/'+code[1]+'/.swf',iframe:'//www.metacafe.com/embed/'+code[1]+'/'}}});Zedity.core.embed.add('ustream',{url:'http://www.ustream.tv',type:'video',regex:[new RegExp('ustream\\.tv/(?:embed|channel)/(.*?)(\\?|$)')],parser:function(code){return{code:code[1],iframe:'//www.ustream.tv/embed/'+code[1]+'?v=3&amp;wmode=opaque'}},player:{iframe:{play:'play',pause:'pause',command:function(frame_id,func,value){$('#'+frame_id)[0].contentWindow.postMessage(JSON.stringify({cmd:func,args:value}),'*')}}}});Zedity.core.embed.add('myspace_video',{url:'https://myspace.com/discover/videos',type:'video',regex:[new RegExp('myspace\\.com/.*?/video/(.*?)($|"|\')')],parser:function(code){code[1]=code[1].replace('/','');return{code:code[1],iframe:'//myspace.com/play/video/'+code[1]}}});Zedity.core.embed.add('veoh',{url:'http://www.veoh.com',type:'video',regex:[new RegExp('veoh\\.com/.*?(?:watch/|permalinkId=)(.*?)(&|$|"|\'|\\?)')],parser:function(code){return{code:code[1],flash:'//www.veoh.com/swf/webplayer/WebPlayer.swf?version=AFrontend.5.7.0.1404&amp;permalinkId='+code[1]+'&amp;player=videodetailsembedded&amp;videoAutoPlay=0&amp;id=anonymous'}}});Zedity.core.embed.add('metatube',{url:'http://www.metatube.com',type:'video',regex:[new RegExp('metatube\\.com/.*?/videos/(.*?)/(.*?)/')],parser:function(code){return{code:code[1],iframe:'//www.metatube.com/en/videos/'+code[1]+'/'+code[2]+'/embed/'}}});Zedity.core.embed.add('vine',{url:'http://vine.co',type:'video',regex:[new RegExp('vine\\.co/v/(.+?)(/|$)')],parser:function(code){return{code:code[1],iframe:'//vine.co/v/'+code[1]+'/embed/simple'}}});Zedity.core.embed.add('snotr',{url:'http://www.snotr.com',type:'video',regex:[new RegExp('snotr\\.com/(?:video|embed)/(.*?)("|/|\'|$|\\?)')],parser:function(code){return{code:code[1],iframe:'//www.snotr.com/embed/'+code[1]}}});Zedity.core.embed.add('bliptv',{url:'http://blip.tv',type:'video',regex:[new RegExp('blip\\.tv/(?:play/|api.swf#)(.*?)[\.\'\?"$]')],parser:function(code){return{code:code[1],flash:'//a.blip.tv/api.swf#'+code[1],iframe:'//blip.tv/play/'+code[1]+'.x?p=1'}},sizeLimits:{minWidth:250,minHeight:250}});Zedity.core.embed.add('5min',{url:'http://www.5minmedia.com/VideoLibrary/',type:'video',regex:[new RegExp('5min\\.com/.*?playList=(.*?)[\'">&$]'),new RegExp('aol\\.com/.*-(.*?)[\\?$]')],parser:function(code){return{code:code[1],flash:'//cfiles.5min.com/FlexPlayers/SmartPlayer_221.swf?sid=281&amp;skey=0&amp;isEmbed=True&amp;isAutoStart=False&amp;videoID='+code[1]}}});Zedity.core.embed.add('tunepk',{url:'http://tune.pk/',type:'video',regex:[new RegExp('tune\\.pk/(?:video|play)/(.*?)(&|/|\\?|"|\'|$)'),new RegExp('tune\\.pk/player/embed_player.php\\?.*?vid=(.*?)(&|/|\\?|"|\'|$)')],parser:function(code){return{code:code[1],iframe:'//embed.tune.pk/play/'+code[1]+'?autoplay=no'}}});Zedity.core.embed.add('coub',{url:'http://coub.com/',type:'video',regex:[new RegExp('coub\\.com/(?:view|embed)/(.*?)(&|/|\\?|"|\'|$)')],parser:function(code){return{code:code[1],iframe:'//coub.com/embed/'+code[1]+'?muted=false&amp;autostart=false&amp;originalSize=false&amp;hideTopBar=true&amp;noSiteButtons=true'}}})})(jQuery);
(function($){if(!Zedity)throw new Error(Zedity.t('%s needs %s.','Zedity.Responsive','Zedity'));Zedity.Responsive=function(options){this._options=$.extend(true,{layouts:{1:{title:Zedity.t('Extra small layout')+' (XS)',short:'XS',icon:'smartphone',width:300},6:{title:Zedity.t('Small layout')+' (S)',short:'S',icon:'tablet',width:400},11:{title:Zedity.t('Medium layout')+' (M)',short:'M',icon:'laptop',width:500},16:{title:Zedity.t('Large layout')+' (L)',short:'L',icon:'desktop',width:600}},customsizes:{21:'XL',26:'XXL',31:'3XL',36:'4XL',41:'5XL'},onsave:function(html){this._options.onsave.call(this,html)},revertmessage:Zedity.t('If you perform this action you will revert to a non-responsive design. Are you sure?')},options);this.editor=this._options.editor;this.saved=[];this._data={originaloptions:$.extend(true,{},this._options)};var buttons='';for(var i=1;i<=16;++i){if(this._options.layouts[i]){buttons+='<button class="zedity-responsive" data-layout="'+i+'">'+'<span class="zedity-responsive-icon zedity-responsive-icon-'+this._options.layouts[i].icon+'"></span><br/>'+this._options.layouts[i].title+'<span class="zedity-delete" title="'+Zedity.t('Delete layout')+'">&times;</span>'+'</button>'}}var custombuttons='';for(var i in this._options.customsizes){if(this._options.customsizes.hasOwnProperty(i)){custombuttons+='<button class="zedity-responsive zedity-small" data-layout="'+i+'" style="display:none">'+this._options.customsizes[i]+'<span class="zedity-delete" title="'+Zedity.t('Delete layout')+'">&times;</span>'+'</button>'}}var $dialog=$('<div class="zedity-dialog-responsive">'+'<div class="zedity-responsive-main">'+'<ul>'+'<li>'+Zedity.t('You can start your design from any layout.')+'</li>'+'<li>'+Zedity.t('Boxes can be added in any layout and can be modified only in the layout they were added to.')+'</li>'+'<li>'+Zedity.t('Boxes added in a layout can be hidden in other layouts.')+'</li>'+'</ul>'+'</div>'+'<div class="zedity-responsive-others">'+buttons+'</div>'+'<div class="zedity-responsive-custom">'+'<span style="margin-right:10px">'+Zedity.t('Custom layouts:')+'</span>'+'<span class="zedity-tooltip help-custom">?</span>'+'<div class="zedity-responsive-custom-buttons-wrapper">'+'<div class="zedity-responsive-custom-buttons">'+custombuttons+'</div>'+'<button id="btnAddCustom" title="'+Zedity.t('Add custom layout')+'"></button>'+'</div>'+'</div>'+'<div class="zedity-responsive-message"><p></p></div>'+'</div>');this.editor.$container.append($dialog);var editor=this.editor;var self=this;$dialog.dialog({title:Zedity.t('Multiple layout responsive design'),dialogClass:'zedity-dialog zedity-dialog-responsive-outer',autoOpen:false,modal:true,closeOnEscape:false,resizable:false,position:{my:'center',at:'center',of:window.top},width:650,create:function(){$dialog.find('.zedity-tooltip.help-custom').attr('title',Zedity.t('The width of custom layouts can be adjusted to fit larger designs.')).tooltip();$dialog.find('button.zedity-responsive .zedity-delete').on('click.zedity',function(e){var $this=$(this);var $parent=$this.closest('button.zedity-responsive');if($parent.hasClass('zedity-disabled'))return;var thislayout=parseInt($parent.attr('data-layout'),10);Zedity.core.dialog({title:Zedity.t('Delete layout'),message:Zedity.t('Are you sure you want to delete this layout?')+'<br/>'+Zedity.t('The layout will be cleared and all boxes owned by layout "%s" will be deleted (even in other layouts).',editor.responsive._options.layouts[thislayout].short),cancel:true,ok:function(){editor.$this.removeAttr('data-layout-'+thislayout);$.each(editor.boxes.get(),function(idx,box){if(box._data.ownerlayout==thislayout){box.remove()}else{box.deleteLayoutData(thislayout)}});delete self._options.layouts[thislayout].done;if(self._data.main==thislayout){self._data.main=null;for(var i in self._options.layouts){if(self._options.layouts[i].done){self._data.main=i;break}}}self.refresh();editor.page._saveUndo();editor.page._clearUndo()}});return false});$dialog.find('button.zedity-responsive').on('click.zedity',function(){var $this=$(this);if($this.hasClass('zedity-disabled'))return;var thislayout=parseInt($this.attr('data-layout'),10);var isnew=true;for(var i in editor.responsive._options.layouts){if(editor.responsive._options.layouts[i].done){isnew=false;break}}if(isnew)editor.responsive._data.main=thislayout;$.each(editor.boxes.get(),function(idx,box){box._data.ownerlayout=box._data.ownerlayout||box.$this.attr('data-ol')||editor.responsive._data.main||1});editor.responsive.startLayout(thislayout)});$dialog.parent().find('button.zedity-button-ok').button('disable');$dialog.find('#btnAddCustom').button({icons:{primary:'ui-icon-plusthick'},text:false}).button('disable').on('click.zedity',function(){var newlayout=editor.responsive.addLayout();$dialog.trigger('refresh.zedity')})},open:function(){if(!editor.responsive.current){$dialog.find('button.zedity-responsive').removeClass('zedity-ok zedity-warn');$dialog.find('.zedity-responsive-message p').text(Zedity.t('Click on a layout button to start creating content for that layout.'));$dialog.parent().find('button.zedity-button-ok').removeClass('zedity-ok zedity-warn').find('.ui-button-text').text(Zedity.t('Save'))}},beforeClose:function(event,ui){if(event.originalEvent&&$(event.originalEvent.currentTarget).is('.ui-dialog-titlebar-close')){$dialog.data('cancel',true)}},close:function(event,ui){if($dialog.data('cancel')){var isnew=true;for(var i in editor.responsive._options.layouts){if(editor.responsive._options.layouts[i].done){isnew=false;break}}if(isnew)editor.responsive.revert(true)}$dialog.removeData('cancel')},buttons:[{text:Zedity.t('Save'),class:'zedity-button-ok',click:function(){editor.responsive.save()}},{text:Zedity.t('Abort'),class:'zedity-button-abort',click:function(){if(editor.responsive.revert())$dialog.dialog('close')}},{text:Zedity.t('Cancel'),class:'zedity-button-cancel',click:function(){$dialog.data('cancel',true).dialog('close')}}]}).on('refresh.zedity',function(){var $allbuttons=$dialog.find('button.zedity-responsive');$allbuttons.removeClass('zedity-ok zedity-warn').hide().removeClass('zedity-visible');for(var i in editor.responsive._options.layouts){if(editor.responsive._options.layouts.hasOwnProperty(i)){var $cur=$dialog.find('button.zedity-responsive[data-layout='+i+']').show().addClass('zedity-visible');if(editor.responsive._options.layouts[i].done===true){$cur.addClass('zedity-ok')}else if(editor.responsive._options.layouts[i].done===false){$cur.addClass('zedity-warn')}}}var $custombuttons=$dialog.find('.zedity-responsive-custom-buttons button.zedity-responsive');var lastl=editor.responsive.lastLayout();var lastc=parseInt(Object.keys(editor.responsive._options.customsizes).pop());$('#btnAddCustom').button(((editor.responsive._options.layouts['1'].done||editor.responsive._options.layouts['6'].done||editor.responsive._options.layouts['11'].done||editor.responsive._options.layouts['16'].done)&&!$custombuttons.filter(':visible:not(.zedity-ok):not(.zedity-warn)').length&&lastl<lastc)?'enable':'disable');var $message=$dialog.find('.zedity-responsive-message p');var $button=$dialog.parent().find('button.zedity-button-ok').button('enable');editor.contentChanged=false;if($dialog.find('button.zedity-responsive.zedity-warn').length){$message.text(Zedity.t('You may want to review the design for layouts in yellow.'));$button.removeClass('zedity-ok').addClass('zedity-warn').find('.ui-button-text').text(Zedity.t('Save without reviewing'));editor.contentChanged=true}else if($dialog.find('button.zedity-responsive.zedity-visible:not(.zedity-ok)').length){$message.text(Zedity.t('Please click on the layouts in gray to provide the design for all layouts.'));$button.removeClass('zedity-warn zedity-ok').find('.ui-button-text').text(Zedity.t('Save anyway (not recommended)'))}else{$message.text(Zedity.t('Your responsive content is ready to be saved!'));$button.removeClass('zedity-warn').addClass('zedity-ok').find('.ui-button-text').text(Zedity.t('Save'))}});this.editor.$container.on('mouseenter.zedity','.zedity-bar',function(event){var $this=$(this);var box=$this.editor().boxes.selected();if(!box||box.editor.$container.find('.ui-draggable-dragging').length)return false;if(box.editor.responsive.current&&box._data.ownerlayout!=box.editor.responsive.current){$this.tooltip({items:this,show:{delay:500,duration:100},hide:false,content:Zedity.t('This box was created in another layout.')+'<br/>'+Zedity.t('To modify its content edit the layout "%s".',box.editor.responsive._options.layouts[box._data.ownerlayout].short),position:{my:'center bottom',at:'center top'}});$this.tooltip('open')}});this.editor.$container.on('mousemove.zedity','.zedity-bar .zedity-button',function(event){var $this=$(this).parents('.zedity-bar');if($this.data('ui-tooltip')){$this.tooltip('close')}return false});this.editor.$container.on('mouseenter.zedity','.zedity-box',function(){function keepTooltipOpen(event){var $target=$(event.target);if(!$target.hasClass('zedity-box'))$target=$target.parents('.zedity-box');if($target.length==0)return;event.stopImmediatePropagation();var fixed=setTimeout(function(){if($target.data('ui-tooltip')){$target.tooltip('close')}},200);$('.ui-tooltip').hover(function(){clearTimeout(fixed)},function(){$target.tooltip('close')});return false};var $this=$(this);var box=$this.box();if(!box||box.editor.$container.find('.ui-draggable-dragging').length)return false;if($this.data('ui-tooltip'))$this.tooltip('destroy');if(box.asBackground())return;if($this.hasClass('zedity-mlrd-hidden')){$this.tooltip({items:this,show:{delay:500,duration:100},hide:false,content:Zedity.t('The box is hidden in this layout.')+'<br/>'+'<a class="zedity-showbox" href="javascript:;">'+Zedity.t('Show box')+'</a>',open:function(event,ui){$(ui.tooltip[0]).data('box',box)},position:{my:'center bottom',at:'center top'}});$this.on('mouseleave.zedity-tooltip',keepTooltipOpen);$this.tooltip('open')}else{if($this.data('ui-tooltip'))$this.tooltip('remove');$this.off('mouseleave.zedity-tooltip')}});this.editor.$container.on('mousemove.zedity','.zedity-box',function(){var $this=$(this);if($this.data('ui-tooltip')){$this.tooltip('open')}});this.editor.$container.on('mouseleave.zedity','.zedity-box',function(){var $this=$(this);if($this.data('ui-tooltip')){$this.tooltip('close');$this.tooltip('destroy')}});this.editor.$container.on('tooltipopen.zedity','.zedity-box',function(){var $this=$(this);if($this.box().editor.$container.find('.ui-draggable-dragging').length){$this.tooltip('close');return false}});this.editor.$container.on('dragstart.zedity','.zedity-box',function(){var $this=$(this);if($this.data('ui-tooltip'))$this.tooltip('close')});$(document).on('click.zedity','.ui-tooltip .zedity-showbox',function(){var box=$(this).parents('.ui-tooltip').data('box');box.select();box.editor.menu.activateFeature('editbox','layout','showhideresponsive');box.$this.tooltip('close')});var disableAll=function(ed,box,tab){var en=(!ed.responsive.current||ed.responsive.current==box._data.ownerlayout);if(en)return true;for(var i=tab.groups.length-1;i>=0;--i){for(var j=tab.groups[i].features.length-1;j>=0;--j){ed.menu._featureElement(tab.groups[i].features[j]).addClass('zedity-disabled')}}};this.editor.menu.add({tabs:{content:{groups:{responsive:{title:Zedity.t('Responsive'),order:300,features:{responsive:{icon:'responsive',label:Zedity.t('Start %s','MLRD'),title:'Multiple Layout Responsive Design',order:0,onclick:function(e,ed){if(!ed.responsive.current){ed.responsive.load()}else{ed.responsive.saveLayout()}},refresh:function(ed){this.$button.find('.zedity-ribbon-button-label').html(ed.responsive&&ed.responsive.current?Zedity.t('Save "%s"',ed.responsive._options.layouts[ed.responsive.current].short):Zedity.t('Start %s','MLRD'))}},options:{type:'extpanel',icon:'config',label:Zedity.t('Options'),title:Zedity.t('%s options','MLRD'),order:10,build:function($panel,ed){$panel.append(Zedity.t('Hidden boxes')+' &nbsp; '+'<select class="zedity-mlrd-hiddenboxes">'+'<option value="0">'+Zedity.t('Hide')+'</option>'+'<option value="1">'+Zedity.t('Show as icons')+'</option>'+'</select>');$panel.find('.zedity-mlrd-hiddenboxes').selectmenu({width:130,appendTo:$panel,change:function(e,ui){if(!ed.responsive)return;ed.$this.toggleClass('zedity-mlrd-hideboxes',parseInt(ui.item.value,10)==0)}})},refresh:function(ed){if(!ed.responsive)return;this.$extpanel.find('.zedity-mlrd-hiddenboxes').val(ed.$this.hasClass('zedity-mlrd-hideboxes')?0:1).selectmenu('refresh')}}}}}},editbox:{icon:'editbox',title:Zedity.t('Edit box'),order:1000,groups:{layout:{title:Zedity.t('Layout'),order:0,features:{showhideresponsive:{type:'toggle',order:-1000,state:[{icon:'view',label:Zedity.t('Show'),title:Zedity.t('Show box in this layout')},{icon:'view',label:Zedity.t('Hide'),title:Zedity.t('Hide box in this layout')}],onclick:function(e,ed,before){var box=ed.boxes.selected();if(!box)return;box.$this.toggleClass('zedity-mlrd-hidden',before==1);if(box.$this.hasClass('zedity-mlrd-hidden')){Zedity.core._call(box,'asBackground',false);ed.boxes._select()}ed.responsive._arrangeIcons();ed._changed()},show:function(ed){return!ed.responsive||!!ed.responsive.current},refresh:function(ed,box){if(!box)return;this.$button.trigger('toggle',box.$this.hasClass('zedity-mlrd-hidden')?0:1)}}}}},show:function(ed,box){return!!box},refresh:function(ed,box){if(!box)return;if(disableAll(ed,box,this))return;ed.menu._featureElement(ed.menu._feature('editbox','imagebox','insert')).removeClass('zedity-disabled');ed.menu._featureElement(ed.menu._feature('editbox','imagebox','config')).removeClass('zedity-disabled');ed.menu._featureElement(ed.menu._feature('editbox','videobox','play')).removeClass('zedity-disabled');ed.menu._featureElement(ed.menu._feature('editbox','videobox','show')).removeClass('zedity-disabled');ed.menu._featureElement(ed.menu._feature('editbox','audiobox','play')).removeClass('zedity-disabled');ed.menu._featureElement(ed.menu._feature('editbox','audiobox','show')).removeClass('zedity-disabled');ed.menu._featureElement(ed.menu._feature('editbox','layout','showhideresponsive')).removeClass('zedity-disabled');ed.menu._featureElement(ed.menu._feature('editbox','layout','background')).removeClass('zedity-disabled');ed.menu._featureElement(ed.menu._feature('editbox','layout','arrange')).removeClass('zedity-disabled');ed.menu._featureElement(ed.menu._feature('editbox','layout','align')).removeClass('zedity-disabled');ed.menu._featureElement(ed.menu._feature('editbox','edit','duplicate')).removeClass('zedity-disabled');ed.menu._featureElement(ed.menu._feature('editbox','positioning','position')).removeClass('zedity-disabled');ed.menu._featureElement(ed.menu._feature('editbox','positioning','size')).removeClass('zedity-disabled')}},boxstyle:{icon:'style',title:Zedity.t('Box style'),order:1100,show:function(ed,box){return!!box},refresh:function(ed,box){if(!box)return;if(disableAll(ed,box,this))return}}},onadd:function(ed){Zedity.core.patch(ed.menu._tab('content'),'refresh',{after:function(){if(ed.responsive.current){ed.menu.tabBadge('content','responsive',ed.responsive._options.layouts[ed.responsive.current].short)}else{ed.menu.tabBadge('content','responsive',null)}}})}})};$.extend(Zedity.Responsive.prototype,{lastLayout:function(){return parseInt(Object.keys(this._options.layouts).pop())},prevLayout:function(layout){layout=layout||this.current;for(var i=layout-1;i>=1;--i){if(this._options.layouts.hasOwnProperty(i)){return i}}return null},nextLayout:function(layout){layout=layout||this.current;var last=this.lastLayout();for(var i=layout+1;i<=last;++i){if(this._options.layouts.hasOwnProperty(i)){return i}}return null},start:function(){var editor=this.editor;this.editor.$this.addClass('zedity-responsive-layout');this.editor._changed();var $dialog=$('.zedity-dialog-responsive');$dialog.trigger('refresh.zedity').data('editor',this.editor).dialog('open');this._data.startmlrd=true},load:function(){if(this.editor.$this.hasClass('zedity-responsive-layout')){this._options=$.extend(true,{},this._data.originaloptions);this._data.main=this.editor.$this.attr('data-mainl');var data=JSON.parse(this.editor.$this.attr('data-layouts')||'[]');for(var i=0,len=data.length-1;i<=len;++i){if(!this._options.layouts[data[i].i]){this.addLayout()}if(this._options.layouts[data[i].i]){if(!this._data.main)this._data.main=data[i].i;this._options.layouts[data[i].i].done=true;$('.zedity-dialog-responsive button.zedity-responsive[data-layout='+data[i].i+']').addClass('zedity-ok')}}this.current=1;this.loadLayout(1)}this.start()},addLayout:function(){var last=this.lastLayout();var next=last+5;this._options.layouts[next]={custom:true,title:this._options.customsizes[next],short:this._options.customsizes[next],width:this._options.layouts[last].width+100};return next},startLayout:function(layout){if(!this._options.layouts[layout])return;this.current=layout;$('.zedity-dialog-responsive').dialog('close');this.editor.page.size({width:this._options.layouts[layout].width});this.loadLayout(layout);this.refresh();this.editor.page._saveUndo();this.editor.page._clearUndo();this.editor.$this.children('.zedity-box').each($.proxy(function(idx,el){var box=$(el).box();box.$this.toggleClass('zedity-mlrd-ownerlayout',this.current==box._data.ownerlayout)},this));setTimeout($.proxy(function(){this.editor.contentChanged=false},this),500)},loadLayout:function(layout){var data=this.editor.$this.attr('data-layout-'+layout);if(data){data=JSON.parse(data);this.editor.page.size({width:parseInt(data.w),height:parseInt(data.h)})}var isnew=true;for(var i in this._options.layouts){if(this._options.layouts[i].done){isnew=false;break}}if(isnew){var boxes=this.editor.boxes.get();for(var i=boxes.length-1;i>=0;--i){if(boxes[i].$this.width()>this._options.layouts[layout].width){boxes[i].fitToPage('width',true)}}}else if(this._options.layouts[layout].done==null&&layout!=this._data.main){var w=this._options.layouts[layout].width;var data=JSON.parse(this.editor.$this.attr('data-layout-'+this._data.main));this.editor.page.size({width:w,height:Math.round(parseInt(data.h)*w/parseInt(data.w))})}var boxes=this.editor.boxes.get();for(var i=boxes.length-1;i>=0;--i){boxes[i].loadLayoutData(layout)}Zedity.core._call(this.editor.page,'_setPage',this.editor.page._getPage());setTimeout($.proxy(function(){this.editor.contentChanged=false},this),500)},saveLayout:function(layout){layout=layout||this.current;if(!layout)return;this._options.layouts[layout].done=true;if(this.editor.contentChanged){for(var i in this._options.layouts){if(i<=layout||!this._options.layouts[i].hasOwnProperty('done'))continue;this._options.layouts[i].done=false}}var boxes=this.editor.boxes.get();for(var i=boxes.length-1;i>=0;--i){boxes[i].saveLayoutData(layout)}var data=this.editor.$this.getCss('width height');if(layout>16)this._options.layouts[layout].width=parseInt(data.width,10);this.editor.$this.attr('data-layout-'+this.current,JSON.stringify({w:data.width,h:data.height}));this.refresh();this.start()},save:function(options){$('.zedity-dialog-responsive').dialog('close');var layouts=[];for(var layout in this._options.layouts){if(this._options.layouts.hasOwnProperty(layout)&&this._options.layouts[layout].done!=null){layouts.push({i:layout,w:this._options.layouts[layout].width})}}layouts.sort(function(a,b){return a.i-b.i});this.editor.$this.attr('data-layouts',JSON.stringify(layouts));if(this._data.main)this.editor.$this.attr('data-mainl',this._data.main);this.current=null;this.refresh();this.editor.save(function(html){this.responsive._options.onsave.call(this,html)},options)},revert:function(force){var ret=force||confirm(this._options.revertmessage);if(!ret)return false;this.current=null;this.refresh();var a='data-layouts';var last=this.lastLayout();for(var i=1;i<=last;++i){a+=' data-layout-'+i;if(this._options.layouts[i])delete this._options.layouts[i].done}this.editor.$this.removeClass('zedity-responsive-layout');this.editor.$container.find('.zedity-editor,.zedity-box').removeAttr(a).removeClass('zedity-mlrd-hidden');Zedity.core._call(this.editor.page,'_setPage',this.editor.page._getPage());this.editor._changed();this._options=$.extend(true,{},this._data.originaloptions);return true},refresh:function(){$('.zedity-dialog-responsive').trigger('refresh.zedity');this.editor.menu.refresh().refresh('content');this.editor.contextMenu.refresh();this._arrangeIcons()},_arrangeIcons:function(){this.editor.$this.find('.zedity-mlrd-hidden').each(function(idx,elem){var box=$(elem).box();if(box.type=='Image'&&!box.$this.hasClass('zedity-selected')){box.$this.addClass('zedity-selected');setTimeout(function(){Zedity.core._call(box,'layout',box.layout());box.$this.removeClass('zedity-selected')},0)}})}})})(jQuery);(function($){var old_constructor=Zedity;var old_prototype=Zedity.prototype;var old_map=[];for(var i in Zedity){if(Zedity.hasOwnProperty(i))old_map[i]=Zedity[i]}Zedity=function(options){old_constructor.call(this,$.extend({onsave:function(){}},options));if(!Zedity.Responsive)throw new Error(Zedity.t('%s needs %s.','Zedity','Zedity.Responsive'));this.responsive=new Zedity.Responsive({editor:this})};Zedity.prototype=old_prototype;for(var i in old_map){if(old_map.hasOwnProperty(i))Zedity[i]=old_map[i]}var old_changed=Zedity.prototype._changed;Zedity.prototype._changed=function(){old_changed.apply(this,arguments);if(!this._data.internal){this.contentChanged=true}return this};var old_save=Zedity.prototype.save;Zedity.prototype.save=function(callback,options){if(this._data.saving)return;this._data.saving=true;if(this.$this.hasClass('zedity-responsive-layout')){this.responsive.saveLayout();this.responsive.save(options)}old_save.apply(this,arguments);this._data.saveq.queue('save',$.proxy(function(next){this._data.saving=false;next()},this))}})(jQuery);(function($){var old_content=Zedity.Page.prototype.content;Zedity.Page.prototype.content=function(content){var ret=old_content.apply(this,arguments);if(this.editor.$this.hasClass('zedity-responsive-layout')&&content){setTimeout($.proxy(function(){this.editor.responsive.load()},this),100)}return ret};var old_sizeConstraints=Zedity.Page.prototype.sizeConstraints;Zedity.Page.prototype.sizeConstraints=function(){var sc=old_sizeConstraints.apply(this,arguments);if(this.editor.responsive&&this.editor.responsive.current){if(this.editor.responsive.current<=16){sc.minWidth=sc.maxWidth=this.editor.responsive._options.layouts[this.editor.responsive.current].width}else{var prev=this.editor.responsive.prevLayout();if(prev){sc.minWidth=Math.max(sc.minWidth,this.editor.responsive._options.layouts[prev].width+100)}var next=this.editor.responsive.nextLayout();if(next){sc.maxWidth=Math.min(sc.maxWidth,this.editor.responsive._options.layouts[next].width-100)}}}return sc}})(jQuery);(function($){var old_refresh=Zedity.ContextMenu.prototype.refresh;Zedity.ContextMenu.prototype.refresh=function(){old_refresh.call(this);if(!this.editor.responsive||!this.editor.responsive.current)return;var box=this.editor.boxes.selected();var canmodify=box&&this.editor.responsive.current==box._data.ownerlayout;this.$this.find('.zedity-menu-SelFlipMain').toggleClass('zedity-responsive-disabled',!canmodify);this.$this.find('.zedity-menu-SelDelete').toggleClass('zedity-responsive-disabled',!canmodify)}})(jQuery);(function($){var old_constructor=Zedity.Box;var old_prototype=Zedity.Box.prototype;var old_map=[];for(var i in Zedity.Box){if(Zedity.Box.hasOwnProperty(i))old_map[i]=Zedity.Box[i]}Zedity.Box=function(options){old_constructor.call(this,$.extend({onsave:function(){}},options));Zedity.core._later(this,function(){this._data.ownerlayout=this.$this.attr('data-ol')||this.editor.responsive.current||this._data.main||1;this.$this.attr('data-ol',this._data.ownerlayout);if(this.editor.responsive.current){this.$this.toggleClass('zedity-mlrd-ownerlayout',this.editor.responsive.current==this._data.ownerlayout)}},10)};Zedity.Box.prototype=old_prototype;Zedity.Box.prototype.constructor=Zedity.Box;for(var i in old_map){if(old_map.hasOwnProperty(i))Zedity.Box[i]=old_map[i]}var allowinsert=['Image'];$.each(Zedity.Box.types,function(idx,elem){if(allowinsert.indexOf(elem)>-1)return;var old_insert=Zedity.Box[elem].prototype.insert;Zedity.Box[elem].prototype.insert=function(){if(this.editor&&this.editor.responsive.current&&this.editor.responsive.current!=this._data.ownerlayout)return this;return old_insert.apply(this,arguments)}});var old_duplicate=Zedity.Box.prototype.duplicate;Zedity.Box.prototype.duplicate=function(){var box=old_duplicate.apply(this,arguments);box._data.ownerlayout=this.editor.responsive.current;box.$this.attr('data-ol',box._data.ownerlayout);box.$this.removeClass('zedity-mlrd-hidden');for(var i=this.editor.responsive.current-1;i>=1;--i){if(this.editor.responsive._options.layouts.hasOwnProperty(i)){box.$this.removeAttr('data-layout-'+i)}}this.editor.boxes.refreshSelected();return box};var old_save=Zedity.Box.prototype._save;Zedity.Box.prototype._save=function(){this.$this.attr('data-ol',this._data.ownerlayout);this.$this.removeClass('zedity-mlrd-ownerlayout');return old_save.apply(this,arguments)};var old_createPropBar=Zedity.Box.prototype.createPropBar;Zedity.Box.prototype.createPropBar=function(options){old_createPropBar.call(this)};$.extend(Zedity.Box.prototype,{saveLayoutData:function(layout,data){var ishidden=this.$this.hasClass('zedity-mlrd-hidden');this.$this.removeClass('zedity-mlrd-hidden');var css=this.$this.getCss('width height top left z-index',true);var pd=this.editor.page.size();data=$.extend({v:!ishidden,w:+(parseInt(css.width)*100/pd.width).toFixed(3)+'%',h:+(parseInt(css.height)*100/pd.height).toFixed(3)+'%',l:+(parseInt(css.left)*100/pd.width).toFixed(3)+'%',t:+(parseInt(css.top)*100/pd.height).toFixed(3)+'%',z:css['z-index']},data);this.$this.attr('data-layout-'+layout,JSON.stringify(data));if(ishidden)this.$this.addClass('zedity-mlrd-hidden');return data},loadLayoutData:function(layout){var data=JSON.parse(this.$this.attr('data-layout-'+layout)||'{}');if(Object.keys(data).length==0){if(this.editor.responsive._options.layouts[this._data.ownerlayout].done){data=this.loadLayoutData(this._data.ownerlayout);var datap=layout>1?this.loadLayoutData(this.editor.responsive.prevLayout(layout)):false}else{datap={v:true}}data.v=datap?datap.v:layout>=this._data.ownerlayout}if(Object.keys(data).length!==0&&!this.$this.hasClass('zedity-background')){var pd=this.editor.page.size();this.$this.css({width:Math.round(parseFloat(data.w)*pd.width/100),height:Math.round(parseFloat(data.h)*pd.height/100),left:Math.round(parseFloat(data.l)*pd.width/100),top:Math.round(parseFloat(data.t)*pd.height/100),'z-index':data.z}).removeClass('zedity-mlrd-hidden');this._resize();this.$this.toggleClass('zedity-mlrd-hidden',data.v===false)}return data},deleteLayoutData:function(layout){this.$this.removeAttr('data-layout-'+layout)}});$.extend(Zedity.Box.Image.prototype,{saveLayoutData:function(layout,data){data=Zedity.Box.prototype.saveLayoutData.apply(this,arguments);var css=this.$this.find('img').getCss('width height top left',true);var pd=this.$this.getCss('width height',true);data.i={w:+(parseInt(css.width)*100/parseInt(pd.width)).toFixed(3)+'%',h:+(parseInt(css.height)*100/parseInt(pd.height)).toFixed(3)+'%',l:+(parseInt(css.left)*100/parseInt(pd.width)).toFixed(3)+'%',t:+(parseInt(css.top)*100/parseInt(pd.height)).toFixed(3)+'%',a:this.description()||'',u:this.content()};this.$this.attr('data-layout-'+layout,JSON.stringify(data));return data},loadLayoutData:function(layout){var data=Zedity.Box.prototype.loadLayoutData.call(this,layout);if(data.i){this.content(data.i.u,null,true);this.description(data.i.a)}return data}});$.extend(Zedity.Box.Text.prototype,{saveLayoutData:function(layout,data){data=Zedity.Box.prototype.saveLayoutData.apply(this,arguments);if(this.$this.css('display')=='table')data.dt=1;this.$this.attr('data-layout-'+layout,JSON.stringify(data));return data}});$.extend(Zedity.Box.Audio.prototype,{saveLayoutData:function(layout,data){data=Zedity.Box.prototype.saveLayoutData.apply(this,arguments);data.h=this.$this.css('height');this.$this.attr('data-layout-'+layout,JSON.stringify(data));return data},loadLayoutData:function(layout){var data=Zedity.Box.prototype.loadLayoutData.call(this,layout);if(data.h)this.$this.css('height',data.h);return data}})})(jQuery);
(function($){if(!Zedity)throw new Error(Zedity.t('%s needs %s.','Zedity.Grid','Zedity'));Zedity.Grid=function(options){this._options=$.extend(true,{show:false,snap:false,width:100,height:100,color:'#888'},options);this.editor=options.editor;this.editor.$this.before('<div class="zedity-grid"/>');this.$this=this.editor.$container.find('div.zedity-grid');this.$this.on('click',function(event){var $this=$(this);$this.hide();var el=document.elementFromPoint(event.clientX,event.clientY);$this.show();$(el).trigger('click')});this.draw()};$.extend(Zedity.Grid.prototype,{draw:function(){if(this._options.show){this.$this.html('<svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">'+'<defs>'+'<pattern id="grid" width="'+this._options.width+'" height="'+this._options.height+'" patternUnits="userSpaceOnUse">'+'<path d="M '+this._options.width+' 0 H 0 V '+this._options.height+'" fill="none" stroke="'+this._options.color+'" stroke-width="0.5"/>'+'</pattern>'+'</defs>'+'<rect width="100%" height="100%" fill="url(#grid)" />'+'</svg>').css(this.editor.page.size())}else{this.$this.html('')}return true},show:function(show){if(show!=null)this._options.show=show;this.draw();return this._options.show},snap:function(snap){if(snap!=null)this._options.snap=snap;return this._options.snap},size:function(size){size=size||{};this._options.width=size.width||this._options.width||100;this._options.height=size.height||this._options.height||100;this.draw();return{width:this._options.width,height:this._options.height}}})})(jQuery);(function($){var old_constructor=Zedity;var old_prototype=Zedity.prototype;var old_map=[];for(var i in Zedity){if(Zedity.hasOwnProperty(i))old_map[i]=Zedity[i]}Zedity=function(options){old_constructor.call(this,options);if(!Zedity.Grid)throw new Error(Zedity.t('%s needs %s.','Zedity','Zedity.Grid'));this.grid=new Zedity.Grid($.extend({editor:this},this._options.grid||{},{show:this._options.snapGrid}))};Zedity.prototype=old_prototype;for(var i in old_map){if(old_map.hasOwnProperty(i))Zedity[i]=old_map[i]}})(jQuery);(function($){var old_size=Zedity.Page.prototype.size;Zedity.Page.prototype.size=function(size){var rsize=old_size.apply(this,arguments);if(size&&this.editor.grid)this.editor.grid.draw();return rsize}})(jQuery);(function($){$.ui.plugin.add('draggable','snapToGrid',{drag:function(e,ui){var $this=$(this);var o=$this.editor().grid._options;if(!o.snap||!o.show)return;var inst=$this.data('ui-draggable');var st=inst.options.snapTolerance;var $el=$(ui.helper.context);var op,sp,s;s=$el.outerHeight();op=ui.position.top+s;sp=Math.round(op/o.height)*o.height;if(Math.abs(sp-op)<st){ui.position.top=sp-s}s=$el.outerWidth();op=ui.position.left+s;sp=Math.round(op/o.width)*o.width;if(Math.abs(sp-op)<st){ui.position.left=sp-s}sp=Math.round(ui.position.top/o.height)*o.height;if(Math.abs(sp-ui.position.top)<st){ui.position.top=sp}sp=Math.round(ui.position.left/o.width)*o.width;if(Math.abs(sp-ui.position.left)<st){ui.position.left=sp}}});$.ui.plugin.add('resizable','snapToGrid',{resize:function(e,ui){var $this=$(this);var o=$this.editor().grid._options;if(!o.snap||!o.show)return;var inst=$this.data('ui-resizable');var st=inst.options.snapTolerance;var op,sp,d;var axes=inst.axis.split('');for(var j=axes.length-1;j>=0;--j){switch(axes[j]){case'n':sp=Math.round(ui.position.top/o.height)*o.height;d=sp-ui.position.top;if(Math.abs(d)<st){ui.position.top+=d;ui.size.height-=d}if(inst._aspectRatio)ui.size.width=ui.size.height*inst.aspectRatio;break;case's':op=ui.position.top+(ui.size.height+inst.sizeDiff.height);sp=Math.round(op/o.height)*o.height;d=sp-op;if(Math.abs(d)<st){ui.size.height+=d}if(inst._aspectRatio)ui.size.width=ui.size.height*inst.aspectRatio;break;case'w':sp=Math.round(ui.position.left/o.width)*o.width;d=sp-ui.position.left;if(Math.abs(d)<st){ui.position.left+=d;ui.size.width-=d}if(inst._aspectRatio)ui.size.height=ui.size.width/inst.aspectRatio;break;case'e':op=ui.position.left+(ui.size.width+inst.sizeDiff.width);sp=Math.round(op/o.width)*o.width;d=sp-op;if(Math.abs(d)<st){ui.size.width+=d}if(inst._aspectRatio)ui.size.height=ui.size.width/inst.aspectRatio;break}}}})})(jQuery);
(function($){if(!Zedity)throw new Error(Zedity.t('%s needs %s.','Zedity.Templates','Zedity'));Zedity.Templates=function(options){this._options=$.extend(true,{prefix:'zedity-template-'},options);this.editor=this._options.editor;this.current=null;var self=this;this.editor.menu.add({tabs:{content:{groups:{templates:{title:Zedity.t('Templates'),order:200,features:{templates:{icon:'template',onclick:function(){self.editor.templates.open()}}}}}}}});function addentry(num,title,classname){return('<tr class="template '+(classname||'')+'">'+'<td><input type="radio" name="template" id="rbTemplate'+num+'" value="'+(num==-1?-1:title)+'"></td>'+'<td><label for="rbTemplate'+num+'">'+title+'</label></td>'+'</tr>')};var $dialog=$('<div class="zedity-dialog-templates">'+'<table class="templates above" cellspacing="0">'+addentry(-1,Zedity.t('New Template'),'new')+'</table>'+'<div class="scrollpanel">'+'<table class="templates main" cellspacing="0">'+'</table>'+'</div>'+'<div>'+'<button class="zedity-templates-btnSave" title="'+Zedity.t('Save current content as Template')+'">'+Zedity.t('Save')+'</button>'+'<button class="zedity-templates-btnLoad" title="'+Zedity.t('Load selected Template into editor')+'">'+Zedity.t('Load')+'</button>'+'<button class="zedity-templates-btnDelete title="'+Zedity.t('Delete selected Template')+'"">'+Zedity.t('Delete')+'</button>'+'</div>'+'</div>');this.editor.$container.append($dialog);var editor=this.editor;$dialog.dialog({title:Zedity.t('Templates'),dialogClass:'zedity-dialog',autoOpen:false,modal:true,closeOnEscape:false,resizable:false,position:{my:'center',at:'center',of:window.top},width:500,create:function(){$dialog.find('button').button().button('disable');$dialog.on('click.zedity','tr.template',function(){$dialog.find('tr.template').removeClass('selected');var $this=$(this);var $radio=$this.find('input[type=radio]');$radio.prop('checked',true);$this.addClass('selected');$dialog.find('button').button('disable');if($radio.val()==-1){$dialog.find('.zedity-templates-btnSave').button('enable')}else if($radio.val()!=null){$dialog.find('button').button('enable')}});$dialog.find('.zedity-templates-btnSave').on('click.zedity',function(){function save(title,content){var ret=editor.templates.save(title,content);if(!ret){alert(Zedity.t('An error occurred while saving the Template. Please try again.'));return}$dialog.trigger('refresh.zedity');setTimeout(function(){Zedity.core.dialog({message:Zedity.t('Template "%s" saved.',title)})},100)};var $radio=$dialog.find('input[type=radio]:checked');var content=editor.page.content();if($radio.val()!=-1){Zedity.core.dialog({message:Zedity.t('The current content will overwrite the selected Template. Are you sure?'),ok:function(){save($radio.val(),content)},cancel:true})}else{Zedity.core.dialog({question:Zedity.t('Give a title to your Template:'),acceptedChars:'a-zA-Z0-9 \\-_',ok:function(answer){if(editor.templates.load(answer)){alert(Zedity.t('A Template with that title already exists, please change the title.'));return false}save(answer,content)}})}});$dialog.find('.zedity-templates-btnLoad').on('click.zedity',function(){Zedity.core.dialog({message:Zedity.t('The Template will overwrite the current editor content. Are you sure?'),ok:function(){var $radio=$dialog.find('input[type=radio]:checked');var title=$radio.val();var content=editor.templates.load(title);if(!content){alert(Zedity.t('An error occurred while loading the Template. Please try again.'));return}editor.page.content(content);setTimeout(function(){Zedity.core.dialog({message:Zedity.t('Template "%s" loaded.',title)})},100)},cancel:true})});$dialog.find('.zedity-templates-btnDelete').on('click.zedity',function(){Zedity.core.dialog({message:Zedity.t('Are you sure you want to delete the selected Template?'),ok:function(){var $radio=$dialog.find('input[type=radio]:checked');var ret=editor.templates.del($radio.val());if(!ret){alert(Zedity.t('An error occurred while deleting the Template. Please try again.'));return}$dialog.trigger('refresh.zedity')},cancel:true})})},open:function(){$dialog.trigger('refresh.zedity')},close:function(){},buttons:[{text:Zedity.t('Close'),class:'zedity-button-close',click:function(){$dialog.dialog('close')}}]}).on('refresh.zedity',function(){var list=editor.templates.list();var entries='';for(var i=0,len=list.length;i<len;++i){entries+=addentry(i,list[i])}$dialog.find('tr.template').removeClass('selected');$dialog.find('input[type=radio]').prop('checked',false);$dialog.find('button').button('disable');$dialog.find('table.templates.main').html(entries)})};$.extend(Zedity.Templates.prototype,{open:function(){var $dialog=$('.zedity-dialog-templates');$dialog.dialog('open')},list:function(){var templates=Zedity.core.store.getprefix(this._options.prefix,localStorage);for(var i=templates.length-1;i>=0;--i){templates[i]=templates[i].replace(this._options.prefix,'')}return templates.sort()},load:function(title){var content=Zedity.core.store.get(this._options.prefix+title,localStorage);return content||false},save:function(title,content){if(!title||!content)return false;Zedity.core.store.set(this._options.prefix+title,content,localStorage);return this.load(title)},del:function(title){if(!title)return false;Zedity.core.store.del(this._options.prefix+title,localStorage);return true}})})(jQuery);(function($){Zedity.core.patch(window,'Zedity',{restorePrototype:true,after:function(){if(!Zedity.Templates)throw new Error(Zedity.t('%s needs %s.','Zedity','Zedity.Templates'));this.templates=new Zedity.Templates({editor:this})}})})(jQuery);
