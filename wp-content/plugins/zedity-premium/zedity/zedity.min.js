        ...
        createPropBar: function(options) {
            ...
            if ($('.zedity-dialog-image').length == 0) {
                ...
                jQuery(posts).each(function(){
                    ...
                    optionsElems += '<option value="'+this.title+'" class="'+catsClass+'">'+this.title+'</option>';
                ...
                jQuery("#catsId").on("change", function(){
                    var cat = jQuery('#catsId option:selected').text().replace(/ /g,'');
                    console.log(cat);
                    jQuery('#selectId option:not('+cat+')').hide();
                });
