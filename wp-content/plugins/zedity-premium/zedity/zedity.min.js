        ...
        createPropBar: function(options) {
            ...
            if ($('.zedity-dialog-image').length == 0) {
                ...
                var $dialog = $(
                    ...
                    '<textarea id="zedity-txtImageLink" rows="4" style="display: none"></textarea>' +
                    '</div>' +
                    '<div id="tab-article-link">' + '<br/>' +
                    '</div>' +
                    '</div>' + '<p class="zedity-image-description" style="display: none">' + Zedity.t('Image description:') + '<br/>' +
                    '<input id="zedity-txtImageDescription" type="text" value="" style="display: none"><br/><br/>' + '</p>' +
                    '</div>');
