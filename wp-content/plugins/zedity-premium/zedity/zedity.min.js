        ...
        createPropBar: function(options) {
            ...
            if ($('.zedity-dialog-image').length == 0) {
                ...
                var $dialog = $(
                    ...
                    '<textarea id="zedity-txtImageLink" rows="4" style="display: hidden"></textarea>' +
                    '</div>' +
                    '<div id="tab-article-link">' + '<br/>' +
                    '</div>' +
                    '</div>' + '<p class="zedity-image-description"style="display: hidden">' + Zedity.t('Image description:') + '<br/>' +
